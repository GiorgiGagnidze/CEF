...
class EmbeddedWorkerSetup_Internal {
    ...
    public static final org.chromium.mojo.bindings.Interface.Manager<EmbeddedWorkerSetup, EmbeddedWorkerSetup.Proxy> MANAGER =
        ...
        public String getName() {
            return "content::EmbeddedWorkerSetup";
        }
...
int threadId, org.chromium.mojo.bindings.InterfaceRequest<org.chromium.mojom.mojo.ServiceProvider> services, org.chromium.mojom.mojo.ServiceProvider exposedServices) {

            EmbeddedWorkerSetupExchangeServiceProvidersParams _message = new EmbeddedWorkerSetupExchangeServiceProvidersParams();
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case EXCHANGE_SERVICE_PROVIDERS_ORDINAL: {
                        ...
                        EmbeddedWorkerSetupExchangeServiceProvidersParams data =
                                EmbeddedWorkerSetupExchangeServiceProvidersParams.deserialize(messageWithHeader.getPayload());
            
                        getImpl().exchangeServiceProviders(data.threadId, data.services, data.exposedServices);
                        return true;
                    }
    ...
    static final class EmbeddedWorkerSetupExchangeServiceProvidersParams extends org.chromium.mojo.bindings.Struct {
        ...
        private EmbeddedWorkerSetupExchangeServiceProvidersParams(int version) {
        ...
        public EmbeddedWorkerSetupExchangeServiceProvidersParams() {
            this(0);
        }
    
        public static EmbeddedWorkerSetupExchangeServiceProvidersParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
    
        @SuppressWarnings("unchecked")
        public static EmbeddedWorkerSetupExchangeServiceProvidersParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            EmbeddedWorkerSetupExchangeServiceProvidersParams result = new EmbeddedWorkerSetupExchangeServiceProvidersParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            EmbeddedWorkerSetupExchangeServiceProvidersParams other = (EmbeddedWorkerSetupExchangeServiceProvidersParams) object;
