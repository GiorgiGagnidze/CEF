...
String mediaSource, String sinkId, String originalPresentationId, String origin, int tabId, 
...
String mediaSource, String presentationId, String origin, int tabId, 
...
String mediaSource, String routeId, String presentationId, String origin, int tabId, 
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CONNECT_ROUTE_BY_ROUTE_ID_ORDINAL: {
                        ...
                        getImpl().connectRouteByRouteId(data.mediaSource, data.routeId, data.presentationId, data.origin, data.tabId, new MediaRouteProviderConnectRouteByRouteIdResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
