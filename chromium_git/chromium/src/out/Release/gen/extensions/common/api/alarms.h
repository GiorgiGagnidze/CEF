...
struct Alarm {
  ...
  static scoped_ptr<Alarm> FromValue(const base::Value& value);
  ...
  scoped_ptr<double> period_in_minutes;
...
struct AlarmCreateInfo {
  ...
  static scoped_ptr<AlarmCreateInfo> FromValue(const base::Value& value);
...
scoped_ptr<base::ListValue> Create(const std::vector<linked_ptr<Alarm> >& alarms);
}  // namespace Results
...
scoped_ptr<base::ListValue> Create(bool was_cleared);
}  // namespace Results
