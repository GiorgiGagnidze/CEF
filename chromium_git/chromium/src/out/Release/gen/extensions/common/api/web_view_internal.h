...
struct DataTypeSet {
  ...
  static scoped_ptr<DataTypeSet> FromValue(const base::Value& value);
  ...
  // Websites' appcaches.
  scoped_ptr<bool> appcache;

  // The browser's cookies.
  scoped_ptr<bool> cookies;

  // Websites' file systems.
  scoped_ptr<bool> file_systems;

  // Websites' IndexedDB data.
  scoped_ptr<bool> indexed_db;

  // Websites' local storage data.
  scoped_ptr<bool> local_storage;

  // Websites' WebSQL data.
  scoped_ptr<bool> web_sql;
...
struct RemovalOptions {
  ...
  static scoped_ptr<RemovalOptions> FromValue(const base::Value& value);
...
std::string ToString(ZoomMode as_enum);
...
std::string ToString(StopFindingAction as_enum);
...
std::string ToString(SetPermissionAction as_enum);
...
struct InjectionItems {
  ...
  static scoped_ptr<InjectionItems> FromValue(const base::Value& value);
  ...
  scoped_ptr<std::vector<std::string> > files;
...
struct ContentScriptDetails {
  ...
  // failure.
  static scoped_ptr<ContentScriptDetails> FromValue(const base::Value& value);
  ...
  scoped_ptr<std::vector<std::string> > exclude_matches;
...
scoped_ptr<base::ListValue> Create(const std::vector<linked_ptr<base::Value> >& result);
}  // namespace Results
...
struct Params {
  ...
  scoped_ptr<std::vector<std::string> > script_name_list;
...
scoped_ptr<base::ListValue> Create(double zoom_factor);
}  // namespace Results
...
scoped_ptr<base::ListValue> Create(const ZoomMode& zoom_mode);
}  // namespace Results
...
struct Params {
  ...
  struct Options {
    ...
    scoped_ptr<bool> backward;

    // Flag to match |searchText| with case-sensitivity.
    scoped_ptr<bool> match_case;
...
scoped_ptr<base::ListValue> Create(const Results& results);
}  // namespace Results
...
struct Params {
  ...
  scoped_ptr<std::string> virtual_url;
...
struct Params {
  ...
  scoped_ptr<std::string> user_input;
...
scoped_ptr<base::ListValue> Create(bool allowed);
}  // namespace Results
...
struct Params {
  ...
  scoped_ptr<extensions::api::extension_types::ImageDetails> options;
...
scoped_ptr<base::ListValue> Create(const std::string& data_url);
}  // namespace Results
