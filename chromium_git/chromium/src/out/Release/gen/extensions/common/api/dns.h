...
struct ResolveCallbackResolveInfo {
  ...
  // failure.
  static scoped_ptr<ResolveCallbackResolveInfo> FromValue(const base::Value& value);
...
scoped_ptr<base::ListValue> Create(const ResolveCallbackResolveInfo& resolve_info);
}  // namespace Results
