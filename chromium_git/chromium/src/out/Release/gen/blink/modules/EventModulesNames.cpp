...
// Generated from:
// - ../../../../../out/Release/gen/blink/modules/EventModulesInterfaces.in
...
const AtomicString& GeofencingEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[8];
const AtomicString& IDBVersionChangeEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[9];
const AtomicString& BlobEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[10];
...
const AtomicString& ServicePortConnectEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[16];
const AtomicString& NotificationEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[17];
...
const AtomicString& ExtendableEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[20];
const AtomicString& ExtendableMessageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[21];
const AtomicString& FetchEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[22];
const AtomicString& InstallEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[23];
const AtomicString& ServiceWorkerMessageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[24];
const AtomicString& SpeechRecognitionError = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[25];
const AtomicString& SpeechRecognitionEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[26];
const AtomicString& SpeechSynthesisEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[27];
const AtomicString& StorageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[28];
const AtomicString& AudioProcessingEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[29];
const AtomicString& OfflineAudioCompletionEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[30];
const AtomicString& WebGLContextEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[31];
const AtomicString& MIDIConnectionEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[32];
const AtomicString& MIDIMessageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[33];
const AtomicString& CloseEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[34];
