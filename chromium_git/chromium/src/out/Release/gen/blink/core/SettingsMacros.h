...
#define SETTINGS_GETTERS_AND_SETTERS \
    ...
    bool fetchDeferLateScripts() const { return m_fetchDeferLateScripts; } \
    void setFEtchDeferLateScripts(bool fetchDeferLateScripts); \
    bool fetchIncreaseAsyncScriptPriority() const { return m_fetchIncreaseAsyncScriptPriority; } \
    void setFEtchIncreaseAsyncScriptPriority(bool fetchIncreaseAsyncScriptPriority); \
    bool fetchIncreaseFontPriority() const { return m_fetchIncreaseFontPriority; } \
    void setFEtchIncreaseFontPriority(bool fetchIncreaseFontPriority); \
    bool fetchIncreasePriorities() const { return m_fetchIncreasePriorities; } \
    void setFEtchIncreasePriorities(bool fetchIncreasePriorities); \
    ...
    bool mainResourceOnlyProgress() const { return m_mainResourceOnlyProgress; } \
    void setMainResourceOnlyProgress(bool mainResourceOnlyProgress); \
    ...
    bool scrollAnchoringEnabled() const { return m_scrollAnchoringEnabled; } \
    void setScrollAnchoringEnabled(bool scrollAnchoringEnabled); \
...
#define SETTINGS_MEMBER_VARIABLES \
    ...
    bool m_fetchDeferLateScripts : 1; \
    bool m_fetchIncreaseAsyncScriptPriority : 1; \
    bool m_fetchIncreaseFontPriority : 1; \
    bool m_fetchIncreasePriorities : 1; \
    ...
    bool m_mainResourceOnlyProgress : 1; \
    ...
    bool m_scrollAnchoringEnabled : 1; \
...
#define SETTINGS_INITIALIZER_LIST \
    ...
    , m_fetchDeferLateScripts(false) \
    , m_fetchIncreaseAsyncScriptPriority(false) \
    , m_fetchIncreaseFontPriority(false) \
    , m_fetchIncreasePriorities(false) \
    ...
    , m_mainResourceOnlyProgress(false) \
    ...
    , m_scrollAnchoringEnabled(false) \
...
void Settings::setFEtchDeferLateScripts(bool fetchDeferLateScripts) \
{ \
    if (m_fetchDeferLateScripts == fetchDeferLateScripts) \
        return; \
    m_fetchDeferLateScripts = fetchDeferLateScripts; \
} \
void Settings::setFEtchIncreaseAsyncScriptPriority(bool fetchIncreaseAsyncScriptPriority) \
{ \
    if (m_fetchIncreaseAsyncScriptPriority == fetchIncreaseAsyncScriptPriority) \
        return; \
    m_fetchIncreaseAsyncScriptPriority = fetchIncreaseAsyncScriptPriority; \
} \
void Settings::setFEtchIncreaseFontPriority(bool fetchIncreaseFontPriority) \
{ \
    if (m_fetchIncreaseFontPriority == fetchIncreaseFontPriority) \
        return; \
    m_fetchIncreaseFontPriority = fetchIncreaseFontPriority; \
} \
void Settings::setFEtchIncreasePriorities(bool fetchIncreasePriorities) \
{ \
    if (m_fetchIncreasePriorities == fetchIncreasePriorities) \
        return; \
    m_fetchIncreasePriorities = fetchIncreasePriorities; \
} \
...
void Settings::setMainResourceOnlyProgress(bool mainResourceOnlyProgress) \
{ \
    if (m_mainResourceOnlyProgress == mainResourceOnlyProgress) \
        return; \
    m_mainResourceOnlyProgress = mainResourceOnlyProgress; \
} \
...
void Settings::setScrollAnchoringEnabled(bool scrollAnchoringEnabled) \
{ \
    if (m_scrollAnchoringEnabled == scrollAnchoringEnabled) \
        return; \
    m_scrollAnchoringEnabled = scrollAnchoringEnabled; \
} \
...
{ \
    ...
    if (equalIgnoringCase(name, "fetchDeferLateScripts")) { \
        setFEtchDeferLateScripts( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
    if (equalIgnoringCase(name, "fetchIncreaseAsyncScriptPriority")) { \
        setFEtchIncreaseAsyncScriptPriority( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
    if (equalIgnoringCase(name, "fetchIncreaseFontPriority")) { \
        setFEtchIncreaseFontPriority( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
    if (equalIgnoringCase(name, "fetchIncreasePriorities")) { \
        setFEtchIncreasePriorities( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
    ...
    if (equalIgnoringCase(name, "mainResourceOnlyProgress")) { \
        setMainResourceOnlyProgress( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
    ...
    if (equalIgnoringCase(name, "scrollAnchoringEnabled")) { \
        setScrollAnchoringEnabled( \
            value.isEmpty() || equalIgnoringCase(value, "true") \
        ); \
        return; \
    } \
