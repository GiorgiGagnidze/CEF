...
InternalSettingsGenerated::InternalSettingsGenerated(Page* page)
    ...
    , m_fetchDeferLateScripts(page->settings().fetchDeferLateScripts())
    , m_fetchIncreaseAsyncScriptPriority(page->settings().fetchIncreaseAsyncScriptPriority())
    , m_fetchIncreaseFontPriority(page->settings().fetchIncreaseFontPriority())
    , m_fetchIncreasePriorities(page->settings().fetchIncreasePriorities())
    ...
    , m_mainResourceOnlyProgress(page->settings().mainResourceOnlyProgress())
    ...
    , m_scrollAnchoringEnabled(page->settings().scrollAnchoringEnabled())
...
void InternalSettingsGenerated::resetToConsistentState()
{
    ...
    m_page->settings().setFEtchDeferLateScripts(m_fetchDeferLateScripts);
    m_page->settings().setFEtchIncreaseAsyncScriptPriority(m_fetchIncreaseAsyncScriptPriority);
    m_page->settings().setFEtchIncreaseFontPriority(m_fetchIncreaseFontPriority);
    m_page->settings().setFEtchIncreasePriorities(m_fetchIncreasePriorities);
    ...
    m_page->settings().setMainResourceOnlyProgress(m_mainResourceOnlyProgress);
    ...
    m_page->settings().setScrollAnchoringEnabled(m_scrollAnchoringEnabled);
...
void InternalSettingsGenerated::setFEtchDeferLateScripts(bool fetchDeferLateScripts)
{
    m_page->settings().setFEtchDeferLateScripts(fetchDeferLateScripts);
}

void InternalSettingsGenerated::setFEtchIncreaseAsyncScriptPriority(bool fetchIncreaseAsyncScriptPriority)
{
    m_page->settings().setFEtchIncreaseAsyncScriptPriority(fetchIncreaseAsyncScriptPriority);
}

void InternalSettingsGenerated::setFEtchIncreaseFontPriority(bool fetchIncreaseFontPriority)
{
    m_page->settings().setFEtchIncreaseFontPriority(fetchIncreaseFontPriority);
}

void InternalSettingsGenerated::setFEtchIncreasePriorities(bool fetchIncreasePriorities)
{
    m_page->settings().setFEtchIncreasePriorities(fetchIncreasePriorities);
}
...
void InternalSettingsGenerated::setMainResourceOnlyProgress(bool mainResourceOnlyProgress)
{
    m_page->settings().setMainResourceOnlyProgress(mainResourceOnlyProgress);
}
...
void InternalSettingsGenerated::setScrollAnchoringEnabled(bool scrollAnchoringEnabled)
{
    m_page->settings().setScrollAnchoringEnabled(scrollAnchoringEnabled);
}
