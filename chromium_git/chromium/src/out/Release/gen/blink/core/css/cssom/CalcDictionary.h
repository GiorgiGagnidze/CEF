...
#ifndef CalcDictionary_h
#define CalcDictionary_h
...
class CORE_EXPORT CalcDictionary {
    DISALLOW_NEW_EXCEPT_PLACEMENT_NEW();
public:
    CalcDictionary();
    virtual ~CalcDictionary();
...
private:
    ...
    friend class V8CalcDictionary;
};

} // namespace blink

#endif // CalcDictionary_h
