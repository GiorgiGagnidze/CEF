...
public:
    ...
    MediaKeyError* errorCode() const { return m_errorCode; }
    void setErrorCode(MediaKeyError* value) { m_errorCode = value; }
    void setErrorCodeToNull() { m_errorCode = Member<MediaKeyError>(); }
