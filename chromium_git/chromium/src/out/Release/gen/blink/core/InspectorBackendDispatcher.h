...
public:
    ...
    public:
        ...
        public:
            GetResourceContentCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        class SearchInResourceCallback : public CallbackBase {
        public:
            SearchInResourceCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess(PassRefPtr<TypeBuilder::Array<TypeBuilder::Debugger::SearchMatch> > result);
        };
        virtual void searchInResource(ErrorString*, const String& in_frameId, const String& in_url, const String& in_query, const bool* in_caseSensitive, const bool* in_isRegex, PassRefPtrWillBeRawPtr<SearchInResourceCallback> callback) = 0;
        virtual void setDocumentContent(ErrorString*, const String& in_frameId, const String& in_html) = 0;
        virtual void startScreencast(ErrorString*, const String* in_format, const int* in_quality, const int* in_maxWidth, const int* in_maxHeight, const int* in_everyNthFrame) = 0;
    ...
    public:
        ...
        virtual void getProperties(ErrorString*, const String& in_objectId, const bool* in_ownProperties, const bool* in_accessorPropertiesOnly, const bool* in_generatePreview, RefPtr<TypeBuilder::Array<TypeBuilder::Runtime::PropertyDescriptor> >& out_result, RefPtr<TypeBuilder::Array<TypeBuilder::Runtime::InternalPropertyDescriptor> >& opt_out_internalProperties, RefPtr<TypeBuilder::Runtime::ExceptionDetails>& opt_out_exceptionDetails) = 0;
    ...
    public:
        ...
        public:
            GetResponseBodyCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        virtual void addBlockedURL(ErrorString*, const String& in_url) = 0;
        virtual void removeBlockedURL(ErrorString*, const String& in_url) = 0;
    ...
    public:
        ...
        public:
            ExecuteSQLCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
    ...
    public:
        ...
        public:
            RequestDatabaseNamesCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestDatabaseCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestDataCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            ClearObjectStoreCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
    ...
    public:
        ...
        public:
            RequestCacheNamesCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestEntriesCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            DeleteCacheCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess();
        };
        ...
        public:
            DeleteEntryCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess();
        };
    ...
    public:
        ...
        public:
            RequestFileSystemRootCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestDirectoryContentCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestMetadataCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
        ...
        public:
            RequestFileContentCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
    ...
    public:
        ...
        virtual void setInspectMode(ErrorString*, const String& in_mode, const RefPtr<JSONObject>* in_highlightConfig) = 0;
    ...
    public:
        ...
        public:
            EnableCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess();
        };
        virtual void enable(ErrorString*, PassRefPtrWillBeRawPtr<EnableCallback> callback) = 0;
        virtual void disable(ErrorString*) = 0;
        virtual void getMatchedStylesForNode(ErrorString*, int in_nodeId, RefPtr<TypeBuilder::CSS::CSSStyle>& opt_out_inlineStyle, RefPtr<TypeBuilder::CSS::CSSStyle>& opt_out_attributesStyle, RefPtr<TypeBuilder::Array<TypeBuilder::CSS::RuleMatch> >& opt_out_matchedCSSRules, RefPtr<TypeBuilder::Array<TypeBuilder::CSS::PseudoElementMatches> >& opt_out_pseudoElements, RefPtr<TypeBuilder::Array<TypeBuilder::CSS::InheritedStyleEntry> >& opt_out_inherited, RefPtr<TypeBuilder::Array<TypeBuilder::CSS::CSSKeyframesRule> >& opt_out_cssKeyframesRules) = 0;
        ...
        virtual void setStyleSheetText(ErrorString*, const String& in_styleSheetId, const String& in_text, TypeBuilder::OptOutput<String>* opt_out_sourceMapURL) = 0;
        virtual void setRuleSelector(ErrorString*, const String& in_styleSheetId, const RefPtr<JSONObject>& in_range, const String& in_selector, RefPtr<TypeBuilder::CSS::SelectorList>& out_selectorList) = 0;
        virtual void setKeyframeKey(ErrorString*, const String& in_styleSheetId, const RefPtr<JSONObject>& in_range, const String& in_keyText, RefPtr<TypeBuilder::CSS::Value>& out_keyText) = 0;
        ...
        virtual void getBackgroundColors(ErrorString*, int in_nodeId, RefPtr<TypeBuilder::Array<String> >& opt_out_backgroundColors) = 0;

    protected:
        virtual ~CSSCommandHandler() { }
    };

    class CORE_EXPORT IOCommandHandler {
    public:

    protected:
        virtual ~IOCommandHandler() { }
    };
    ...
    public:
        ...
        public:
            StartCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess();
        };
        virtual void start(ErrorString*, const String* in_categories, const String* in_options, const double* in_bufferUsageReportingInterval, const String* in_transferMode, PassRefPtrWillBeRawPtr<StartCallback> callback) = 0;
        class EndCallback : public CallbackBase {
        public:
            EndCallback(PassRefPtrWillBeRawPtr<InspectorBackendDispatcherImpl>, int sessionId, int id);
            CORE_EXPORT void sendSuccess();
        };
    ...
    public:
        ...
        virtual void getCurrentTime(ErrorString*, const String& in_id, double* out_currentTime) = 0;
        virtual void setPaused(ErrorString*, const RefPtr<JSONArray>& in_animations, bool in_paused) = 0;
        virtual void setTiming(ErrorString*, const String& in_animationId, double in_duration, double in_delay) = 0;
        virtual void seekAnimations(ErrorString*, const RefPtr<JSONArray>& in_animations, double in_currentTime) = 0;
        virtual void releaseAnimations(ErrorString*, const RefPtr<JSONArray>& in_animations) = 0;
        virtual void resolveAnimation(ErrorString*, const String& in_animationId, RefPtr<TypeBuilder::Runtime::RemoteObject>& out_remoteObject) = 0;
    ...
    virtual void registerAgent(IOCommandHandler* ioAgent) = 0;
    ...
    enum MethodNames {
        ...
        kPage_setAutoAttachToCreatedPagesCmd,
        kPage_reloadCmd,
        kPage_navigateCmd,
        ...
        kEmulation_resetPageScaleFactorCmd,
        ...
        kEmulation_setCPUThrottlingRateCmd,
        ...
        kRuntime_compileScriptCmd,
        kRuntime_runScriptCmd,
        kConsole_enableCmd,
        kConsole_disableCmd,
        ...
        kNetwork_addBlockedURLCmd,
        kNetwork_removeBlockedURLCmd,
        ...
        kDebugger_setBlackboxedRangesCmd,
        ...
        kAnimation_getCurrentTimeCmd,
        kAnimation_setPausedCmd,
        kAnimation_setTimingCmd,
        kAnimation_seekAnimationsCmd,
        kAnimation_releaseAnimationsCmd,
        kAnimation_resolveAnimationCmd,
