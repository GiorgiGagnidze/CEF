...
public:
    ...
    public:
        ...
        void loadingFailed(const TypeBuilder::Network::RequestId& requestId, double timestamp, TypeBuilder::Page::ResourceType::Enum type, const String& errorText, const bool* const canceled, TypeBuilder::Network::BlockedReason::Enum* blockedReason);
    ...
    public:
        ...
        void layoutEditorChange(const TypeBuilder::CSS::StyleSheetId& styleSheetId, PassRefPtr<TypeBuilder::CSS::SourceRange> changeRange);
    ...
    public:
        static IO* from(InspectorFrontend* frontend) { return &(frontend->m_io) ;}
        IO(InspectorFrontendChannel* inspectorFrontendChannel) : m_inspectorFrontendChannel(inspectorFrontendChannel) { }
    ...
    public:
        ...
        void scriptParsed(const TypeBuilder::Runtime::ScriptId& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId, const bool* const isContentScript, const bool* const isInternalScript, const bool* const isLiveEdit, const String* const sourceMapURL, const bool* const hasSourceURL);
        void scriptFailedToParse(const TypeBuilder::Runtime::ScriptId& scriptId, const String& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId, const bool* const isContentScript, const bool* const isInternalScript, const String* const sourceMapURL, const bool* const hasSourceURL);
    ...
    public:
        ...
        void animationStarted(PassRefPtr<TypeBuilder::Animation::Animation> animation);
