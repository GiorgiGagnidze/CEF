...
const QualifiedName& ideographicAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[77];
const QualifiedName& image_renderingAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[78];
const QualifiedName& inAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[79];
const QualifiedName& in2Attr = reinterpret_cast<QualifiedName*>(&AttrStorage)[80];
const QualifiedName& interceptAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[81];
const QualifiedName& kAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[82];
const QualifiedName& k1Attr = reinterpret_cast<QualifiedName*>(&AttrStorage)[83];
const QualifiedName& k2Attr = reinterpret_cast<QualifiedName*>(&AttrStorage)[84];
const QualifiedName& k3Attr = reinterpret_cast<QualifiedName*>(&AttrStorage)[85];
const QualifiedName& k4Attr = reinterpret_cast<QualifiedName*>(&AttrStorage)[86];
const QualifiedName& kernelMatrixAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[87];
const QualifiedName& kernelUnitLengthAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[88];
const QualifiedName& keyPointsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[89];
const QualifiedName& keySplinesAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[90];
const QualifiedName& keyTimesAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[91];
const QualifiedName& langAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[92];
const QualifiedName& lengthAdjustAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[93];
const QualifiedName& letter_spacingAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[94];
const QualifiedName& lighting_colorAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[95];
const QualifiedName& limitingConeAngleAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[96];
const QualifiedName& localAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[97];
const QualifiedName& marker_endAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[98];
const QualifiedName& marker_midAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[99];
const QualifiedName& marker_startAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[100];
const QualifiedName& markerHeightAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[101];
const QualifiedName& markerUnitsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[102];
const QualifiedName& markerWidthAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[103];
const QualifiedName& maskAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[104];
const QualifiedName& mask_typeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[105];
const QualifiedName& maskContentUnitsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[106];
const QualifiedName& maskUnitsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[107];
const QualifiedName& mathematicalAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[108];
const QualifiedName& maxAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[109];
const QualifiedName& mediaAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[110];
const QualifiedName& methodAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[111];
const QualifiedName& minAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[112];
const QualifiedName& modeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[113];
const QualifiedName& nameAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[114];
const QualifiedName& numOctavesAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[115];
const QualifiedName& offsetAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[116];
const QualifiedName& onactivateAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[117];
const QualifiedName& onbeginAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[118];
const QualifiedName& onendAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[119];
const QualifiedName& onfocusinAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[120];
const QualifiedName& onfocusoutAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[121];
const QualifiedName& onrepeatAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[122];
const QualifiedName& onzoomAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[123];
