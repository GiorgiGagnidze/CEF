...
const AtomicString& InputMethodContext = reinterpret_cast<AtomicString*>(&NamesStorage)[7];
const AtomicString& AudioTrackList = reinterpret_cast<AtomicString*>(&NamesStorage)[8];
const AtomicString& TextTrack = reinterpret_cast<AtomicString*>(&NamesStorage)[9];
const AtomicString& TextTrackCue = reinterpret_cast<AtomicString*>(&NamesStorage)[10];
const AtomicString& TextTrackList = reinterpret_cast<AtomicString*>(&NamesStorage)[11];
const AtomicString& VideoTrackList = reinterpret_cast<AtomicString*>(&NamesStorage)[12];
const AtomicString& ApplicationCache = reinterpret_cast<AtomicString*>(&NamesStorage)[13];
const AtomicString& EventSource = reinterpret_cast<AtomicString*>(&NamesStorage)[14];
const AtomicString& Performance = reinterpret_cast<AtomicString*>(&NamesStorage)[15];
const AtomicString& DedicatedWorkerGlobalScope = reinterpret_cast<AtomicString*>(&NamesStorage)[16];
const AtomicString& SharedWorker = reinterpret_cast<AtomicString*>(&NamesStorage)[17];
const AtomicString& SharedWorkerGlobalScope = reinterpret_cast<AtomicString*>(&NamesStorage)[18];
const AtomicString& Worker = reinterpret_cast<AtomicString*>(&NamesStorage)[19];
const AtomicString& XMLHttpRequest = reinterpret_cast<AtomicString*>(&NamesStorage)[20];
const AtomicString& XMLHttpRequestUpload = reinterpret_cast<AtomicString*>(&NamesStorage)[21];
