...
// Generated from:
// - ../../../../out/Release/gen/blink/core/EventInterfaces.in
...
const AtomicString& Event = reinterpret_cast<AtomicString*>(&NamesStorage)[12];
const AtomicString& FocusEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[13];
const AtomicString& HashChangeEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[14];
...
const AtomicString& MediaKeyEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[32];
const AtomicString& TrackEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[33];
const AtomicString& SVGZoomEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[34];
const AtomicString& XMLHttpRequestProgressEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[35];
