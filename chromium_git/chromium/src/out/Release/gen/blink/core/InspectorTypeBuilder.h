...
public:
    ...
    public:
        ...
        Builder<STATE | FrameSet>& setFrame(PassRefPtr<TypeBuilder::Page::Frame> value)
        {
            ...
            m_result->setValue("frame", static_pointer_cast<JSONValue>(value));
...
public:
    ...
    {
        this->setValue("preview", static_pointer_cast<JSONValue>(value));
    }

    void setCustomPreview(PassRefPtr<TypeBuilder::Runtime::CustomPreview> value)
    {
        this->setValue("customPreview", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    {
        this->setValue("valuePreview", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    public:
        ...
        Builder<STATE | ValueSet>& setValue(PassRefPtr<TypeBuilder::Runtime::ObjectPreview> value)
        {
            ...
            m_result->setValue("value", static_pointer_cast<JSONValue>(value));
    ...
    {
        this->setValue("key", static_pointer_cast<JSONValue>(value));
    }
#if ENABLE(ASSERT)
    static void assertCorrectValue(JSONValue* value);
#endif  // ENABLE(ASSERT)
...
public:
    ...
    {
        this->setValue("value", static_pointer_cast<JSONValue>(value));
    }
    using JSONObjectBase::setValue;
    ...
    {
        this->setValue("get", static_pointer_cast<JSONValue>(value));
    }

    void setSet(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
    {
        this->setValue("set", static_pointer_cast<JSONValue>(value));
    }
    ...
    {
        this->setValue("symbol", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    {
        this->setValue("asyncStackTrace", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    {
        this->setNumber("certificateId", value);
    }
};

/* Information about mixed content on the page. */
class MixedContentStatus : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        RanInsecureContentSet = 1 << 0,
        DisplayedInsecureContentSet = 1 << 1,
        RanInsecureContentStyleSet = 1 << 2,
        DisplayedInsecureContentStyleSet = 1 << 3,
        AllFieldsSet = (RanInsecureContentSet | DisplayedInsecureContentSet | RanInsecureContentStyleSet | DisplayedInsecureContentStyleSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*MixedContentStatus*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | RanInsecureContentSet>& setRanInsecureContent(bool value)
        {
            static_assert(!(STATE & RanInsecureContentSet), "property ranInsecureContent should not be set yet");
            m_result->setBoolean("ranInsecureContent", value);
            return castState<RanInsecureContentSet>();
        }

        Builder<STATE | DisplayedInsecureContentSet>& setDisplayedInsecureContent(bool value)
        {
            static_assert(!(STATE & DisplayedInsecureContentSet), "property displayedInsecureContent should not be set yet");
            m_result->setBoolean("displayedInsecureContent", value);
            return castState<DisplayedInsecureContentSet>();
        }

        Builder<STATE | RanInsecureContentStyleSet>& setRanInsecureContentStyle(TypeBuilder::Security::SecurityState::Enum value)
        {
            static_assert(!(STATE & RanInsecureContentStyleSet), "property ranInsecureContentStyle should not be set yet");
            m_result->setString("ranInsecureContentStyle", TypeBuilder::getEnumConstantValue(value));
            return castState<RanInsecureContentStyleSet>();
        }

        Builder<STATE | DisplayedInsecureContentStyleSet>& setDisplayedInsecureContentStyle(TypeBuilder::Security::SecurityState::Enum value)
        {
            static_assert(!(STATE & DisplayedInsecureContentStyleSet), "property displayedInsecureContentStyle should not be set yet");
            m_result->setString("displayedInsecureContentStyle", TypeBuilder::getEnumConstantValue(value));
            return castState<DisplayedInsecureContentStyleSet>();
        }

        operator RefPtr<MixedContentStatus>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(MixedContentStatus) == sizeof(JSONObject), "MixedContentStatus should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<MixedContentStatus>*>(&m_result);
        }

        PassRefPtr<MixedContentStatus> release()
        {
            return RefPtr<MixedContentStatus>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<MixedContentStatus> result = MixedContentStatus::create()
     *     .setRanInsecureContent(...)
     *     .setDisplayedInsecureContent(...)
    ...
    void ranInsecureContent(bool* value)
    {
        JSONObjectBase::getBoolean("ranInsecureContent", value);
    }

    void displayedInsecureContent(bool* value)
    {
        JSONObjectBase::getBoolean("displayedInsecureContent", value);
    }
};
...
public:
    // Named after property name 'mixedContentType' while generating Request.
    struct MixedContentType {
        enum Enum {
            Blockable = 72,
            Optionally_blockable = 73,
            None = 74,
        };
    }; // struct MixedContentType
    ...
    enum {
        ...
        MethodSet = 1 << 1,
        HeadersSet = 1 << 2,
        InitialPrioritySet = 1 << 3,
        AllFieldsSet = (UrlSet | MethodSet | HeadersSet | InitialPrioritySet)
    };
    ...
    public:
        ...
        Builder<STATE | InitialPrioritySet>& setInitialPriority(TypeBuilder::Network::ResourcePriority::Enum value)
        {
            static_assert(!(STATE & InitialPrioritySet), "property initialPriority should not be set yet");
            m_result->setString("initialPriority", TypeBuilder::getEnumConstantValue(value));
    ...
    void setMixedContentType(MixedContentType::Enum value)
    {
        this->setString("mixedContentType", TypeBuilder::getEnumConstantValue(value));
    }
};

/* Subject of a certificate. */
class CertificateSubject : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        NameSet = 1 << 0,
        SanDnsNamesSet = 1 << 1,
        SanIpAddressesSet = 1 << 2,
        AllFieldsSet = (NameSet | SanDnsNamesSet | SanIpAddressesSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*CertificateSubject*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | SanDnsNamesSet>& setSanDnsNames(PassRefPtr<TypeBuilder::Array<String> > value)
        {
            static_assert(!(STATE & SanDnsNamesSet), "property sanDnsNames should not be set yet");
            m_result->setValue("sanDnsNames", value);
            return castState<SanDnsNamesSet>();
        }

        Builder<STATE | SanIpAddressesSet>& setSanIpAddresses(PassRefPtr<TypeBuilder::Array<String> > value)
        {
            static_assert(!(STATE & SanIpAddressesSet), "property sanIpAddresses should not be set yet");
            m_result->setValue("sanIpAddresses", value);
            return castState<SanIpAddressesSet>();
        }

        operator RefPtr<CertificateSubject>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(CertificateSubject) == sizeof(JSONObject), "CertificateSubject should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<CertificateSubject>*>(&m_result);
        }

        PassRefPtr<CertificateSubject> release()
        {
            return RefPtr<CertificateSubject>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<CertificateSubject> result = CertificateSubject::create()
     *     .setName(...)
     *     .setSanDnsNames(...)
     *     .setSanIpAddresses(...);
     */
...
class CertificateDetails : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        SubjectSet = 1 << 0,
        ...
        ValidFromSet = 1 << 2,
        ValidToSet = 1 << 3,
        AllFieldsSet = (SubjectSet | IssuerSet | ValidFromSet | ValidToSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*CertificateDetails*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | SubjectSet>& setSubject(PassRefPtr<TypeBuilder::Network::CertificateSubject> value)
        {
            static_assert(!(STATE & SubjectSet), "property subject should not be set yet");
            m_result->setValue("subject", static_pointer_cast<JSONValue>(value));
            return castState<SubjectSet>();
        }

        Builder<STATE | IssuerSet>& setIssuer(const String& value)
        {
            static_assert(!(STATE & IssuerSet), "property issuer should not be set yet");
            m_result->setString("issuer", value);
            return castState<IssuerSet>();
        }

        Builder<STATE | ValidFromSet>& setValidFrom(double value)
        {
            static_assert(!(STATE & ValidFromSet), "property validFrom should not be set yet");
            m_result->setNumber("validFrom", value);
            return castState<ValidFromSet>();
        }

        Builder<STATE | ValidToSet>& setValidTo(double value)
        {
            static_assert(!(STATE & ValidToSet), "property validTo should not be set yet");
            m_result->setNumber("validTo", value);
            return castState<ValidToSet>();
        }

        operator RefPtr<CertificateDetails>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(CertificateDetails) == sizeof(JSONObject), "CertificateDetails should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<CertificateDetails>*>(&m_result);
        }

        PassRefPtr<CertificateDetails> release()
        {
            return RefPtr<CertificateDetails>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<CertificateDetails> result = CertificateDetails::create()
     *     .setSubject(...)
     *     .setIssuer(...)
     *     .setValidFrom(...)
     *     .setValidTo(...);
    ...
    void issuer(String* value)
    {
        JSONObjectBase::getString("issuer", value);
    }

    void validFrom(double* value)
    {
        JSONObjectBase::getNumber("validFrom", value);
    }

    void validTo(double* value)
    {
        JSONObjectBase::getNumber("validTo", value);
    }
};

/* Details about the validation status of a request's certificate. */
class CertificateValidationDetails : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        NumUnknownSctsSet = 1 << 0,
        NumInvalidSctsSet = 1 << 1,
        NumValidSctsSet = 1 << 2,
        AllFieldsSet = (NumUnknownSctsSet | NumInvalidSctsSet | NumValidSctsSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*CertificateValidationDetails*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
        friend class CertificateValidationDetails;
    public:

        Builder<STATE | NumUnknownSctsSet>& setNumUnknownScts(int value)
        {
            static_assert(!(STATE & NumUnknownSctsSet), "property numUnknownScts should not be set yet");
            m_result->setNumber("numUnknownScts", value);
            return castState<NumUnknownSctsSet>();
        }

        Builder<STATE | NumInvalidSctsSet>& setNumInvalidScts(int value)
        {
            static_assert(!(STATE & NumInvalidSctsSet), "property numInvalidScts should not be set yet");
            m_result->setNumber("numInvalidScts", value);
            return castState<NumInvalidSctsSet>();
        }

        Builder<STATE | NumValidSctsSet>& setNumValidScts(int value)
        {
            static_assert(!(STATE & NumValidSctsSet), "property numValidScts should not be set yet");
            m_result->setNumber("numValidScts", value);
            return castState<NumValidSctsSet>();
        }

        operator RefPtr<CertificateValidationDetails>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(CertificateValidationDetails) == sizeof(JSONObject), "CertificateValidationDetails should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<CertificateValidationDetails>*>(&m_result);
        }

        PassRefPtr<CertificateValidationDetails> release()
        {
            return RefPtr<CertificateValidationDetails>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<CertificateValidationDetails> result = CertificateValidationDetails::create()
     *     .setNumUnknownScts(...)
     *     .setNumInvalidScts(...)
     *     .setNumValidScts(...);
     */
    ...
    void numUnknownScts(int* value)
    {
        JSONObjectBase::getNumber("numUnknownScts", value);
    }

    void numInvalidScts(int* value)
    {
        JSONObjectBase::getNumber("numInvalidScts", value);
    }

    void numValidScts(int* value)
    {
        JSONObjectBase::getNumber("numValidScts", value);
    }
};

/* Security details about a request. */
class SecurityDetails : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        ProtocolSet = 1 << 0,
        KeyExchangeSet = 1 << 1,
        CipherSet = 1 << 2,
        CertificateIdSet = 1 << 3,
        AllFieldsSet = (ProtocolSet | KeyExchangeSet | CipherSet | CertificateIdSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*SecurityDetails*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | ProtocolSet>& setProtocol(const String& value)
        {
            static_assert(!(STATE & ProtocolSet), "property protocol should not be set yet");
            m_result->setString("protocol", value);
            return castState<ProtocolSet>();
        }

        Builder<STATE | KeyExchangeSet>& setKeyExchange(const String& value)
        {
            static_assert(!(STATE & KeyExchangeSet), "property keyExchange should not be set yet");
            m_result->setString("keyExchange", value);
            return castState<KeyExchangeSet>();
        }

        Builder<STATE | CipherSet>& setCipher(const String& value)
        {
            static_assert(!(STATE & CipherSet), "property cipher should not be set yet");
            m_result->setString("cipher", value);
            return castState<CipherSet>();
        }

        Builder<STATE | CertificateIdSet>& setCertificateId(int value)
        {
            static_assert(!(STATE & CertificateIdSet), "property certificateId should not be set yet");
            m_result->setNumber("certificateId", value);
            return castState<CertificateIdSet>();
        }

        operator RefPtr<SecurityDetails>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(SecurityDetails) == sizeof(JSONObject), "SecurityDetails should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<SecurityDetails>*>(&m_result);
        }

        PassRefPtr<SecurityDetails> release()
        {
            return RefPtr<SecurityDetails>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<SecurityDetails> result = SecurityDetails::create()
     *     .setProtocol(...)
     *     .setKeyExchange(...)
     *     .setCipher(...)
     *     .setCertificateId(...);
    ...
    {
        JSONObjectBase::getString("protocol", value);
    }

    void keyExchange(String* value)
    {
        JSONObjectBase::getString("keyExchange", value);
    }

    void cipher(String* value)
    {
        JSONObjectBase::getString("cipher", value);
    }

    void certificateId(int* value)
    {
        JSONObjectBase::getNumber("certificateId", value);
    }

    void setMac(const String& value)
    {
        this->setString("mac", value);
    }

    void setCertificateValidationDetails(PassRefPtr<TypeBuilder::Network::CertificateValidationDetails> value)
    {
        this->setValue("certificateValidationDetails", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    enum {
        ...
        SecurityStateSet = 1 << 8,
        AllFieldsSet = (UrlSet | StatusSet | StatusTextSet | HeadersSet | MimeTypeSet | ConnectionReusedSet | ConnectionIdSet | EncodedDataLengthSet | SecurityStateSet)
    };
    ...
    {
        this->setValue("timing", static_pointer_cast<JSONValue>(value));
    }
    ...
    void setSecurityDetails(PassRefPtr<TypeBuilder::Network::SecurityDetails> value)
    {
        this->setValue("securityDetails", static_pointer_cast<JSONValue>(value));
    }
    ...
    static const char SecurityState[];
    ...
    static const char SecurityDetails[];
};
...
public:
    ...
    {
        this->setValue("response", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    public:
        ...
        Builder<STATE | KeyPathSet>& setKeyPath(PassRefPtr<TypeBuilder::IndexedDB::KeyPath> value)
        {
            ...
            m_result->setValue("keyPath", static_pointer_cast<JSONValue>(value));
...
public:
    ...
    {
        this->setValue("lower", static_pointer_cast<JSONValue>(value));
    }

    void setUpper(PassRefPtr<TypeBuilder::IndexedDB::Key> value)
    {
        this->setValue("upper", static_pointer_cast<JSONValue>(value));
    }
};
...
struct PseudoType {
    enum Enum {
        ...
        Backdrop = 85,
        Selection = 86,
        First_line_inherited = 87,
        Scrollbar = 88,
        Scrollbar_thumb = 89,
        Scrollbar_button = 90,
        Scrollbar_track = 91,
        Scrollbar_track_piece = 92,
        Scrollbar_corner = 93,
        Resizer = 94,
        Input_list_button = 95,
    };
}; // struct PseudoType
...
public:
    ...
    {
        this->setValue("contentDocument", static_pointer_cast<JSONValue>(value));
    }
    ...
    {
        this->setValue("templateContent", static_pointer_cast<JSONValue>(value));
    }
    ...
    {
        this->setValue("importedDocument", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    {
        this->setValue("shapeOutside", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    {
        this->setBoolean("displayAsMaterial", value);
    }

    void setContentColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("contentColor", static_pointer_cast<JSONValue>(value));
    }

    void setPaddingColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("paddingColor", static_pointer_cast<JSONValue>(value));
    }

    void setBorderColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("borderColor", static_pointer_cast<JSONValue>(value));
    }

    void setMarginColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("marginColor", static_pointer_cast<JSONValue>(value));
    }

    void setEventTargetColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("eventTargetColor", static_pointer_cast<JSONValue>(value));
    }

    void setShapeColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("shapeColor", static_pointer_cast<JSONValue>(value));
    }

    void setShapeMarginColor(PassRefPtr<TypeBuilder::DOM::Rgba> value)
    {
        this->setValue("shapeMarginColor", static_pointer_cast<JSONValue>(value));
    }

    void setSelectorList(const String& value)
    {
        this->setString("selectorList", value);
    }
};
...
struct InspectMode {
    enum Enum {
        SearchForNode = 99,
        SearchForUAShadowDOM = 100,
        ShowLayoutEditor = 101,
        None = 74,
    };
}; // struct InspectMode
...
class PseudoElementMatches : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        PseudoTypeSet = 1 << 0,
        MatchesSet = 1 << 1,
        AllFieldsSet = (PseudoTypeSet | MatchesSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*PseudoElementMatches*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | PseudoTypeSet>& setPseudoType(TypeBuilder::DOM::PseudoType::Enum value)
        {
            static_assert(!(STATE & PseudoTypeSet), "property pseudoType should not be set yet");
            m_result->setString("pseudoType", TypeBuilder::getEnumConstantValue(value));
        ...
        operator RefPtr<PseudoElementMatches>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(PseudoElementMatches) == sizeof(JSONObject), "PseudoElementMatches should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<PseudoElementMatches>*>(&m_result);
        }

        PassRefPtr<PseudoElementMatches> release()
        {
            return RefPtr<PseudoElementMatches>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<PseudoElementMatches> result = PseudoElementMatches::create()
     *     .setPseudoType(...)
     *     .setMatches(...);
     */
    static Builder<NoFieldsSet> create()
...
public:
    ...
    {
        this->setValue("inlineStyle", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    public:
        ...
        Builder<STATE | RuleSet>& setRule(PassRefPtr<TypeBuilder::CSS::CSSRule> value)
        {
            ...
            m_result->setValue("rule", static_pointer_cast<JSONValue>(value));
...
class Value : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        TextSet = 1 << 0,
    ...
    private:
        ...
        Builder(PassRefPtr</*Value*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        operator RefPtr<Value>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(Value) == sizeof(JSONObject), "Value should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<Value>*>(&m_result);
        }

        PassRefPtr<Value> release()
        {
            return RefPtr<Value>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<Value> result = Value::create()
     *     .setText(...);
     */
    static Builder<NoFieldsSet> create()
    {
    ...
    {
        this->setValue("range", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    public:
        ...
        Builder<STATE | SelectorsSet>& setSelectors(PassRefPtr<TypeBuilder::Array<TypeBuilder::CSS::Value> > value)
        {
...
public:
    ...
    public:
        ...
        Builder<STATE | SelectorListSet>& setSelectorList(PassRefPtr<TypeBuilder::CSS::SelectorList> value)
        {
            ...
            m_result->setValue("selectorList", static_pointer_cast<JSONValue>(value));
        ...
        Builder<STATE | StyleSet>& setStyle(PassRefPtr<TypeBuilder::CSS::CSSStyle> value)
        {
            ...
            m_result->setValue("style", static_pointer_cast<JSONValue>(value));
...
public:
    ...
    {
        this->setValue("valueRange", static_pointer_cast<JSONValue>(value));
    }
...
class CSSKeyframesRule : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        AnimationNameSet = 1 << 0,
        KeyframesSet = 1 << 1,
        AllFieldsSet = (AnimationNameSet | KeyframesSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*CSSKeyframesRule*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | AnimationNameSet>& setAnimationName(PassRefPtr<TypeBuilder::CSS::Value> value)
        {
            static_assert(!(STATE & AnimationNameSet), "property animationName should not be set yet");
            m_result->setValue("animationName", static_pointer_cast<JSONValue>(value));
            return castState<AnimationNameSet>();
        }

        Builder<STATE | KeyframesSet>& setKeyframes(PassRefPtr<TypeBuilder::Array<TypeBuilder::CSS::CSSKeyframeRule> > value)
        {
        ...
        operator RefPtr<CSSKeyframesRule>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(CSSKeyframesRule) == sizeof(JSONObject), "CSSKeyframesRule should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<CSSKeyframesRule>*>(&m_result);
        }

        PassRefPtr<CSSKeyframesRule> release()
        {
            return RefPtr<CSSKeyframesRule>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<CSSKeyframesRule> result = CSSKeyframesRule::create()
     *     .setAnimationName(...)
     *     .setKeyframes(...);
     */
    static Builder<NoFieldsSet> create()
...
class CSSKeyframeRule : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        OriginSet = 1 << 0,
        KeyTextSet = 1 << 1,
        StyleSet = 1 << 2,
        AllFieldsSet = (OriginSet | KeyTextSet | StyleSet)
    };
    ...
    private:
        ...
        Builder(PassRefPtr</*CSSKeyframeRule*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | KeyTextSet>& setKeyText(PassRefPtr<TypeBuilder::CSS::Value> value)
        {
            static_assert(!(STATE & KeyTextSet), "property keyText should not be set yet");
            m_result->setValue("keyText", static_pointer_cast<JSONValue>(value));
        ...
        operator RefPtr<CSSKeyframeRule>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(CSSKeyframeRule) == sizeof(JSONObject), "CSSKeyframeRule should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<CSSKeyframeRule>*>(&m_result);
        }

        PassRefPtr<CSSKeyframeRule> release()
        {
            return RefPtr<CSSKeyframeRule>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<CSSKeyframeRule> result = CSSKeyframeRule::create()
     *     .setOrigin(...)
     *     .setKeyText(...)
     *     .setStyle(...);
     */
...
public:
    ...
    public:
        ...
        Builder<STATE | ScriptIdSet>& setScriptId(const TypeBuilder::Runtime::ScriptId& value)
        {
            static_assert(!(STATE & ScriptIdSet), "property scriptId should not be set yet");
            m_result->setString("scriptId", value);
            return castState<ScriptIdSet>();
    ...
    void scriptId(TypeBuilder::Runtime::ScriptId* value)
    {
        JSONObjectBase::getString("scriptId", value);
    }
...
/* Location in the source code. */
class ScriptPosition : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        LineSet = 1 << 0,
    ...
    private:
        ...
        Builder(PassRefPtr</*ScriptPosition*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | ColumnSet>& setColumn(int value)
        {
            ...
            m_result->setNumber("column", value);
            return castState<ColumnSet>();
        }

        operator RefPtr<ScriptPosition>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(ScriptPosition) == sizeof(JSONObject), "ScriptPosition should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<ScriptPosition>*>(&m_result);
        }

        PassRefPtr<ScriptPosition> release()
        {
            return RefPtr<ScriptPosition>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<ScriptPosition> result = ScriptPosition::create()
     *     .setLine(...)
     *     .setColumn(...);
     */
    static Builder<NoFieldsSet> create()
    ...
    {
        JSONObjectBase::getNumber("column", value);
    }
};
...
public:
    ...
    {
        this->setValue("location", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    public:
        ...
        Builder<STATE | FunctionSet>& setFunction(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
        {
            ...
            m_result->setValue("function", static_pointer_cast<JSONValue>(value));
...
public:
    ...
    public:
        ...
        Builder<STATE | LocationSet>& setLocation(PassRefPtr<TypeBuilder::Debugger::Location> value)
        {
            ...
            m_result->setValue("location", static_pointer_cast<JSONValue>(value));
        ...
        Builder<STATE | ThisSet>& setThis(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
        {
            ...
            m_result->setValue("this", static_pointer_cast<JSONValue>(value));
    ...
    {
        this->setValue("functionLocation", static_pointer_cast<JSONValue>(value));
    }

    void setReturnValue(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
    {
        this->setValue("returnValue", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    public:
        ...
        Builder<STATE | ObjectSet>& setObject(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
        {
            ...
            m_result->setValue("object", static_pointer_cast<JSONValue>(value));
...
public:
    ...
    {
        this->setValue("compileError", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    {
        this->setValue("callFrame", static_pointer_cast<JSONValue>(value));
    }
    ...
    {
        this->setValue("asyncCreationStack", static_pointer_cast<JSONValue>(value));
    }
    ...
    {
        this->setValue("asyncSettlementStack", static_pointer_cast<JSONValue>(value));
    }
};
...
struct DOMBreakpointType {
    enum Enum {
        Subtree_modified = 119,
        Attribute_modified = 120,
        Node_removed = 121,
    };
}; // struct DOMBreakpointType
...
public:
    ...
    {
        this->setValue("handler", static_pointer_cast<JSONValue>(value));
    }

    void setOriginalHandler(PassRefPtr<TypeBuilder::Runtime::RemoteObject> value)
    {
        this->setValue("originalHandler", static_pointer_cast<JSONValue>(value));
    }
};
...
public:
    ...
    public:
        ...
        Builder<STATE | HeadSet>& setHead(PassRefPtr<TypeBuilder::Profiler::CPUProfileNode> value)
        {
            ...
            m_result->setValue("head", static_pointer_cast<JSONValue>(value));
...
public:
    enum {
        ...
        ScopeURLSet = 1 << 1,
        IsDeletedSet = 1 << 2,
        AllFieldsSet = (RegistrationIdSet | ScopeURLSet | IsDeletedSet)
    };
    ...
    public:
        ...
        Builder<STATE | IsDeletedSet>& setIsDeleted(bool value)
        {
            static_assert(!(STATE & IsDeletedSet), "property isDeleted should not be set yet");
            m_result->setBoolean("isDeleted", value);
    ...
    {
        JSONObjectBase::getBoolean("isDeleted", value);
    }

    void setForceUpdateOnPageLoad(bool value)
    {
        this->setBoolean("forceUpdateOnPageLoad", value);
    }
};
...
public:
    ...
    struct Type {
        enum Enum {
            RepaintsOnScroll = 139,
            TouchEventHandler = 140,
            WheelEventHandler = 141,
        };
    }; // struct Type
    ...
    public:
        ...
        Builder<STATE | RectSet>& setRect(PassRefPtr<TypeBuilder::DOM::Rect> value)
        {
            ...
            m_result->setValue("rect", static_pointer_cast<JSONValue>(value));
...
struct OrientationType {
    enum Enum {
        PortraitPrimary = 142,
        PortraitSecondary = 143,
        LandscapePrimary = 144,
        LandscapeSecondary = 145,
    };
}; // struct OrientationType
...
public:
    ...
    public:
        ...
        {
            static_assert(!(STATE & SourceSet), "property source should not be set yet");
            m_result->setValue("source", static_pointer_cast<JSONValue>(value));
            return castState<SourceSet>();
        }
...
public:
    ...
    {
        this->setValue("keyframesRule", static_pointer_cast<JSONValue>(value));
    }
};
...
struct AXValueNativeSourceType {
    enum Enum {
        Figcaption = 168,
        Label = 169,
        Labelfor = 170,
...
class AXValueSource : public JSONObjectBase {
public:
    enum {
        NoFieldsSet = 0,
        TypeSet = 1 << 0,
    ...
    private:
        ...
        Builder(PassRefPtr</*AXValueSource*/JSONObject> ptr)
        {
            static_assert(STATE == NoFieldsSet, "builder should not be created in non-init state");
            m_result = ptr;
        }
    ...
    public:
        ...
        Builder<STATE | TypeSet>& setType(TypeBuilder::Accessibility::AXValueSourceType::Enum value)
        {
            static_assert(!(STATE & TypeSet), "property type should not be set yet");
            m_result->setString("type", TypeBuilder::getEnumConstantValue(value));
            return castState<TypeSet>();
        ...
        operator RefPtr<AXValueSource>& ()
        {
            static_assert(STATE == AllFieldsSet, "state should be AllFieldsSet");
            static_assert(sizeof(AXValueSource) == sizeof(JSONObject), "AXValueSource should be the same size as JSONObject");
            return *reinterpret_cast<RefPtr<AXValueSource>*>(&m_result);
        }

        PassRefPtr<AXValueSource> release()
        {
            return RefPtr<AXValueSource>(*this).release();
        }
    };

    /*
     * Synthetic constructor:
     * RefPtr<AXValueSource> result = AXValueSource::create()
     *     .setType(...);
     */
    static Builder<NoFieldsSet> create()
    {
    ...
    {
        this->setString("attribute", value);
    }

    void setAttributeValue(PassRefPtr<TypeBuilder::Accessibility::AXValue> value)
    {
        this->setValue("attributeValue", static_pointer_cast<JSONValue>(value));
    }

    void setSuperseded(bool value)
    {
        this->setBoolean("superseded", value);
    }

    void setNativeSource(TypeBuilder::Accessibility::AXValueNativeSourceType::Enum value)
    {
        this->setString("nativeSource", TypeBuilder::getEnumConstantValue(value));
    }

    void setNativeSourceValue(PassRefPtr<TypeBuilder::Accessibility::AXValue> value)
    {
        this->setValue("nativeSourceValue", static_pointer_cast<JSONValue>(value));
    }
...
public:
    ...
    void setRelatedNodes(PassRefPtr<TypeBuilder::Array<TypeBuilder::Accessibility::AXRelatedNode> > value)
    {
        this->setValue("relatedNodes", value);
    }

    void setSources(PassRefPtr<TypeBuilder::Array<TypeBuilder::Accessibility::AXValueSource> > value)
    {
...
public:
    ...
    {
        this->setValue("role", static_pointer_cast<JSONValue>(value));
    }

    void setName(PassRefPtr<TypeBuilder::Accessibility::AXValue> value)
    {
        this->setValue("name", static_pointer_cast<JSONValue>(value));
    }

    void setDescription(PassRefPtr<TypeBuilder::Accessibility::AXValue> value)
    {
        this->setValue("description", static_pointer_cast<JSONValue>(value));
    }
