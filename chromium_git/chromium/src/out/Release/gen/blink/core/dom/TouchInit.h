...
public:
    ...
    PassRefPtrWillBeRawPtr<EventTarget> target() const { return m_target; }
    void setTarget(PassRefPtrWillBeRawPtr<EventTarget> value) { m_target = value; }
