...
#endif
const WrapperTypeInfo V8Uint8Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Uint8Array::refObject, V8Uint8Array::derefObject, V8Uint8Array::trace, 0, 0, V8Uint8Array::preparePrototypeAndInterfaceObject, V8Uint8Array::installConditionallyEnabledProperties, "Uint8Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::RefCountedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
DOMUint8Array* V8Uint8Array::toImpl(v8::Local<v8::Object> object)
{
    ...
    RefPtr<DOMUint8Array> typedArray;
