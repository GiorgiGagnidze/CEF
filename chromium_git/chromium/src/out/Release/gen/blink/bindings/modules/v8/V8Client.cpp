...
#endif
const WrapperTypeInfo V8Client::wrapperTypeInfo = { gin::kEmbedderBlink, V8Client::domTemplate, V8Client::refObject, V8Client::derefObject, V8Client::trace, 0, 0, V8Client::preparePrototypeAndInterfaceObject, V8Client::installConditionallyEnabledProperties, "Client", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8ClientTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::serviceWorkerClientAttributesEnabled()) {
        ...
        {"frameType", ServiceWorkerClientV8Internal::frameTypeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorframeTypeConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessoridConfiguration = \
        {"id", ServiceWorkerClientV8Internal::idAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoridConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorurlConfiguration = \
        {"url", ServiceWorkerClientV8Internal::urlAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorurlConfiguration);
    }
}
