...
#endif
const WrapperTypeInfo V8SVGAnimatedLengthList::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedLengthList::domTemplate, V8SVGAnimatedLengthList::refObject, V8SVGAnimatedLengthList::derefObject, V8SVGAnimatedLengthList::trace, 0, V8SVGAnimatedLengthList::visitDOMWrapper, V8SVGAnimatedLengthList::preparePrototypeAndInterfaceObject, V8SVGAnimatedLengthList::installConditionallyEnabledProperties, "SVGAnimatedLengthList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedLengthListAccessors[] = {
    {"baseVal", SVGAnimatedLengthListV8Internal::baseValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedLengthListV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
