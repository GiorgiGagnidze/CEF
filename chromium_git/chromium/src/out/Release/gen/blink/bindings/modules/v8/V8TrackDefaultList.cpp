...
#endif
const WrapperTypeInfo V8TrackDefaultList::wrapperTypeInfo = { gin::kEmbedderBlink, V8TrackDefaultList::domTemplate, V8TrackDefaultList::refObject, V8TrackDefaultList::derefObject, V8TrackDefaultList::trace, 0, 0, V8TrackDefaultList::preparePrototypeAndInterfaceObject, V8TrackDefaultList::installConditionallyEnabledProperties, "TrackDefaultList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8TrackDefaultListAccessors[] = {
    {"length", TrackDefaultListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
