...
const V8DOMConfiguration::MethodConfiguration V8CHROMIUMSubscribeUniformMethods[] = {
    {"createValuebufferCHROMIUM", CHROMIUMSubscribeUniformV8Internal::createValuebufferCHROMIUMMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"deleteValuebufferCHROMIUM", CHROMIUMSubscribeUniformV8Internal::deleteValuebufferCHROMIUMMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"isValuebufferCHROMIUM", CHROMIUMSubscribeUniformV8Internal::isValuebufferCHROMIUMMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"bindValuebufferCHROMIUM", CHROMIUMSubscribeUniformV8Internal::bindValuebufferCHROMIUMMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"subscribeValueCHROMIUM", CHROMIUMSubscribeUniformV8Internal::subscribeValueCHROMIUMMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"populateSubscribedValuesCHROMIUM", CHROMIUMSubscribeUniformV8Internal::populateSubscribedValuesCHROMIUMMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"uniformValuebufferCHROMIUM", CHROMIUMSubscribeUniformV8Internal::uniformValuebufferCHROMIUMMethodCallback, 0, 3, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8CHROMIUMSubscribeUniformTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    const V8DOMConfiguration::ConstantConfiguration V8CHROMIUMSubscribeUniformConstants[] = {
        {"SUBSCRIBED_VALUES_BUFFER_CHROMIUM", 0x924B, 0, V8DOMConfiguration::ConstantTypeUnsignedLong},
        {"MOUSE_POSITION_CHROMIUM", 0x924C, 0, V8DOMConfiguration::ConstantTypeUnsignedLong},
    };
