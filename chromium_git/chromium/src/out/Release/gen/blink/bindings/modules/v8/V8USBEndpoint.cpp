...
#endif
const WrapperTypeInfo V8USBEndpoint::wrapperTypeInfo = { gin::kEmbedderBlink, V8USBEndpoint::domTemplate, V8USBEndpoint::refObject, V8USBEndpoint::derefObject, V8USBEndpoint::trace, 0, 0, V8USBEndpoint::preparePrototypeAndInterfaceObject, V8USBEndpoint::installConditionallyEnabledProperties, "USBEndpoint", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<USBEndpoint> impl = USBEndpoint::create(alternate, endpointNumber, direction, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8USBEndpointAccessors[] = {
    {"endpointNumber", USBEndpointV8Internal::endpointNumberAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"direction", USBEndpointV8Internal::directionAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", USBEndpointV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"packetSize", USBEndpointV8Internal::packetSizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8USBEndpointTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    if (!RuntimeEnabledFeatures::webUSBEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "USBEndpoint", v8::Local<v8::FunctionTemplate>(), V8USBEndpoint::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "USBEndpoint", v8::Local<v8::FunctionTemplate>(), V8USBEndpoint::internalFieldCount,
            0, 0,
            V8USBEndpointAccessors, WTF_ARRAY_LENGTH(V8USBEndpointAccessors),
            0, 0);
    functionTemplate->SetCallHandler(V8USBEndpoint::constructorCallback);
...
v8::Local<v8::FunctionTemplate> V8USBEndpoint::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8USBEndpointTemplate);
}
...
void V8USBEndpoint::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8USBEndpoint::derefObject(ScriptWrappable* scriptWrappable)
{
}
