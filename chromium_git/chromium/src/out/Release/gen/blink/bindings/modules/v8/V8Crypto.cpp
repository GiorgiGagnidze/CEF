...
#endif
const WrapperTypeInfo V8Crypto::wrapperTypeInfo = { gin::kEmbedderBlink, V8Crypto::domTemplate, V8Crypto::refObject, V8Crypto::derefObject, V8Crypto::trace, 0, 0, V8Crypto::preparePrototypeAndInterfaceObject, V8Crypto::installConditionallyEnabledProperties, "Crypto", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CryptoAccessors[] = {
    {"subtle", CryptoV8Internal::subtleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
