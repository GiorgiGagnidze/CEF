...
#endif
const WrapperTypeInfo V8PresentationRequest::wrapperTypeInfo = { gin::kEmbedderBlink, V8PresentationRequest::domTemplate, V8PresentationRequest::refObject, V8PresentationRequest::derefObject, V8PresentationRequest::trace, V8PresentationRequest::toActiveDOMObject, 0, V8PresentationRequest::preparePrototypeAndInterfaceObject, V8PresentationRequest::installConditionallyEnabledProperties, "PresentationRequest", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<PresentationRequest> impl = PresentationRequest::create(executionContext, url, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void installV8PresentationRequestTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    if (!RuntimeEnabledFeatures::presentationEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "PresentationRequest", V8EventTarget::domTemplate(isolate), V8PresentationRequest::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "PresentationRequest", V8EventTarget::domTemplate(isolate), V8PresentationRequest::internalFieldCount,
            0, 0,
            V8PresentationRequestAccessors, WTF_ARRAY_LENGTH(V8PresentationRequestAccessors),
            V8PresentationRequestMethods, WTF_ARRAY_LENGTH(V8PresentationRequestMethods));
    functionTemplate->SetCallHandler(V8PresentationRequest::constructorCallback);
...
v8::Local<v8::FunctionTemplate> V8PresentationRequest::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8PresentationRequestTemplate);
}
...
ActiveDOMObject* V8PresentationRequest::toActiveDOMObject(v8::Local<v8::Object> wrapper)
{
    return toImpl(wrapper);
}

void V8PresentationRequest::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8PresentationRequest::derefObject(ScriptWrappable* scriptWrappable)
{
}
