...
const V8DOMConfiguration::MethodConfiguration V8InternalsMethods[] = {
    ...
    {"setGeolocationClientMock", InternalsPartialV8Internal::setGeolocationClientMockMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setGeolocationPosition", InternalsPartialV8Internal::setGeolocationPositionMethodCallback, 0, 4, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setGeolocationPositionUnavailableError", InternalsPartialV8Internal::setGeolocationPositionUnavailableErrorMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setGeolocationPermission", InternalsPartialV8Internal::setGeolocationPermissionMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"numberOfPendingGeolocationPermissionRequests", InternalsPartialV8Internal::numberOfPendingGeolocationPermissionRequestsMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
...
void V8InternalsPartial::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    V8Internals::preparePrototypeAndInterfaceObject(context, prototypeObject, interfaceObject, interfaceTemplate);
}
