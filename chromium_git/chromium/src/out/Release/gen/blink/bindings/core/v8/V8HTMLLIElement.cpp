...
#endif
const WrapperTypeInfo V8HTMLLIElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLLIElement::domTemplate, V8HTMLLIElement::refObject, V8HTMLLIElement::derefObject, V8HTMLLIElement::trace, 0, 0, V8HTMLLIElement::preparePrototypeAndInterfaceObject, V8HTMLLIElement::installConditionallyEnabledProperties, "HTMLLIElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
