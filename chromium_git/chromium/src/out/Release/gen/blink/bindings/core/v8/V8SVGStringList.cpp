...
#endif
const WrapperTypeInfo V8SVGStringList::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGStringList::domTemplate, V8SVGStringList::refObject, V8SVGStringList::derefObject, V8SVGStringList::trace, 0, V8SVGStringList::visitDOMWrapper, V8SVGStringList::preparePrototypeAndInterfaceObject, V8SVGStringList::installConditionallyEnabledProperties, "SVGStringList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGStringListAccessors[] = {
    {"length", SVGStringListTearOffV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"numberOfItems", SVGStringListTearOffV8Internal::numberOfItemsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
