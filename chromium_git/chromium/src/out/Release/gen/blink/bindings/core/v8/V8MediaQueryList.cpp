...
#endif
const WrapperTypeInfo V8MediaQueryList::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaQueryList::domTemplate, V8MediaQueryList::refObject, V8MediaQueryList::derefObject, V8MediaQueryList::trace, V8MediaQueryList::toActiveDOMObject, 0, V8MediaQueryList::preparePrototypeAndInterfaceObject, V8MediaQueryList::installConditionallyEnabledProperties, "MediaQueryList", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MediaQueryListAccessors[] = {
    {"media", MediaQueryListV8Internal::mediaAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"matches", MediaQueryListV8Internal::matchesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
