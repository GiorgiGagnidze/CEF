...
#endif
const WrapperTypeInfo V8XMLSerializer::wrapperTypeInfo = { gin::kEmbedderBlink, V8XMLSerializer::domTemplate, V8XMLSerializer::refObject, V8XMLSerializer::derefObject, V8XMLSerializer::trace, 0, 0, V8XMLSerializer::preparePrototypeAndInterfaceObject, V8XMLSerializer::installConditionallyEnabledProperties, "XMLSerializer", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
