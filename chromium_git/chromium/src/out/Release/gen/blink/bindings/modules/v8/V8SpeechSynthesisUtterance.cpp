...
#endif
const WrapperTypeInfo V8SpeechSynthesisUtterance::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechSynthesisUtterance::domTemplate, V8SpeechSynthesisUtterance::refObject, V8SpeechSynthesisUtterance::derefObject, V8SpeechSynthesisUtterance::trace, 0, 0, V8SpeechSynthesisUtterance::preparePrototypeAndInterfaceObject, V8SpeechSynthesisUtterance::installConditionallyEnabledProperties, "SpeechSynthesisUtterance", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
