...
static void registerRegionMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    GeofencingRegion* region;
    {
        ...
        if (!region) {
            v8SetReturnValue(info, ScriptPromise::rejectRaw(ScriptState::current(info.GetIsolate()), V8ThrowException::createTypeError(info.GetIsolate(), ExceptionMessages::failedToExecute("registerRegion", "Geofencing", "parameter 1 is not of type 'GeofencingRegion'."))));
            return;
        }
    }
...
const V8DOMConfiguration::MethodConfiguration V8GeofencingMethods[] = {
    {"registerRegion", GeofencingV8Internal::registerRegionMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"unregisterRegion", GeofencingV8Internal::unregisterRegionMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getRegisteredRegions", GeofencingV8Internal::getRegisteredRegionsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
