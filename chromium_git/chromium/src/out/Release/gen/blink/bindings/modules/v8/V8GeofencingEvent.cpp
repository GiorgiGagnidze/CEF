...
#endif
const WrapperTypeInfo V8GeofencingEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8GeofencingEvent::domTemplate, V8GeofencingEvent::refObject, V8GeofencingEvent::derefObject, V8GeofencingEvent::trace, 0, 0, V8GeofencingEvent::preparePrototypeAndInterfaceObject, V8GeofencingEvent::installConditionallyEnabledProperties, "GeofencingEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void regionAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "region"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8GeofencingEventAccessors[] = {
    {"id", GeofencingEventV8Internal::idAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"region", GeofencingEventV8Internal::regionAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
