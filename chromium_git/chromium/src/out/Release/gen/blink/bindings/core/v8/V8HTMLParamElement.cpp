...
#endif
const WrapperTypeInfo V8HTMLParamElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLParamElement::domTemplate, V8HTMLParamElement::refObject, V8HTMLParamElement::derefObject, V8HTMLParamElement::trace, 0, 0, V8HTMLParamElement::preparePrototypeAndInterfaceObject, V8HTMLParamElement::installConditionallyEnabledProperties, "HTMLParamElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
