...
#endif
const WrapperTypeInfo V8WebGLSampler::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLSampler::domTemplate, V8WebGLSampler::refObject, V8WebGLSampler::derefObject, V8WebGLSampler::trace, 0, 0, V8WebGLSampler::preparePrototypeAndInterfaceObject, V8WebGLSampler::installConditionallyEnabledProperties, "WebGLSampler", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
