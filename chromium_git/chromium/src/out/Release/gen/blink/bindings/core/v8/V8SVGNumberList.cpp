...
#endif
const WrapperTypeInfo V8SVGNumberList::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGNumberList::domTemplate, V8SVGNumberList::refObject, V8SVGNumberList::derefObject, V8SVGNumberList::trace, 0, V8SVGNumberList::visitDOMWrapper, V8SVGNumberList::preparePrototypeAndInterfaceObject, V8SVGNumberList::installConditionallyEnabledProperties, "SVGNumberList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGNumberListAccessors[] = {
    {"length", SVGNumberListTearOffV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"numberOfItems", SVGNumberListTearOffV8Internal::numberOfItemsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
