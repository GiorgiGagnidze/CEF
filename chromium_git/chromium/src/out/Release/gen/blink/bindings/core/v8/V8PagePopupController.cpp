...
const V8DOMConfiguration::MethodConfiguration V8PagePopupControllerMethods[] = {
    ...
    {"histogramEnumeration", PagePopupControllerV8Internal::histogramEnumerationMethodCallback, 0, 3, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
