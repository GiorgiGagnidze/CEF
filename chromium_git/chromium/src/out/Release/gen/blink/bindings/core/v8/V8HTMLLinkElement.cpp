...
#endif
const WrapperTypeInfo V8HTMLLinkElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLLinkElement::domTemplate, V8HTMLLinkElement::refObject, V8HTMLLinkElement::derefObject, V8HTMLLinkElement::trace, 0, 0, V8HTMLLinkElement::preparePrototypeAndInterfaceObject, V8HTMLLinkElement::installConditionallyEnabledProperties, "HTMLLinkElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLLinkElementAccessors[] = {
    ...
    {"sheet", HTMLLinkElementV8Internal::sheetAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"import", HTMLLinkElementV8Internal::importAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
static void installV8HTMLLinkElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::linkPreloadEnabled()) {
        const V8DOMConfiguration::AccessorConfiguration accessorrelListConfiguration = \
        {"relList", HTMLLinkElementV8Internal::relListAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorrelListConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorasConfiguration = \
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorasConfiguration);
    }
}
