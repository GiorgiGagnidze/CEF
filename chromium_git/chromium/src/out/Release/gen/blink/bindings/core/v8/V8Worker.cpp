...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<Worker> impl = Worker::create(executionContext, scriptUrl, exceptionState);
