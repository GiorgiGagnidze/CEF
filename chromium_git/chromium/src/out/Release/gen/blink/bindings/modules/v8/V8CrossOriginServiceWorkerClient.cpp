...
const V8DOMConfiguration::AccessorConfiguration V8CrossOriginServiceWorkerClientAccessors[] = {
    {"origin", CrossOriginServiceWorkerClientV8Internal::originAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"targetUrl", CrossOriginServiceWorkerClientV8Internal::targetUrlAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CrossOriginServiceWorkerClientMethods[] = {
    {"postMessage", CrossOriginServiceWorkerClientV8Internal::postMessageMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
