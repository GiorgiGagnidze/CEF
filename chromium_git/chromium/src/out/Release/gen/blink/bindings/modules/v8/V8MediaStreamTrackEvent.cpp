...
#endif
const WrapperTypeInfo V8MediaStreamTrackEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaStreamTrackEvent::domTemplate, V8MediaStreamTrackEvent::refObject, V8MediaStreamTrackEvent::derefObject, V8MediaStreamTrackEvent::trace, 0, 0, V8MediaStreamTrackEvent::preparePrototypeAndInterfaceObject, V8MediaStreamTrackEvent::installConditionallyEnabledProperties, "MediaStreamTrackEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MediaStreamTrackEventAccessors[] = {
    {"track", MediaStreamTrackEventV8Internal::trackAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
