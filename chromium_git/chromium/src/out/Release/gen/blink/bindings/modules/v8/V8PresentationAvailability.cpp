...
const V8DOMConfiguration::AccessorConfiguration V8PresentationAvailabilityAccessors[] = {
    {"value", PresentationAvailabilityV8Internal::valueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
