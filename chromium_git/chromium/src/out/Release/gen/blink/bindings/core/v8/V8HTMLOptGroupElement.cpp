...
#endif
const WrapperTypeInfo V8HTMLOptGroupElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLOptGroupElement::domTemplate, V8HTMLOptGroupElement::refObject, V8HTMLOptGroupElement::derefObject, V8HTMLOptGroupElement::trace, 0, 0, V8HTMLOptGroupElement::preparePrototypeAndInterfaceObject, V8HTMLOptGroupElement::installConditionallyEnabledProperties, "HTMLOptGroupElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
