...
#endif
const WrapperTypeInfo V8SharedWorker::wrapperTypeInfo = { gin::kEmbedderBlink, V8SharedWorker::domTemplate, V8SharedWorker::refObject, V8SharedWorker::derefObject, V8SharedWorker::trace, V8SharedWorker::toActiveDOMObject, 0, V8SharedWorker::preparePrototypeAndInterfaceObject, V8SharedWorker::installConditionallyEnabledProperties, "SharedWorker", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    RawPtr<SharedWorker> impl = SharedWorker::create(executionContext, scriptURL, name, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8SharedWorkerAccessors[] = {
    {"port", SharedWorkerV8Internal::portAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"workerStart", SharedWorkerV8Internal::workerStartAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
