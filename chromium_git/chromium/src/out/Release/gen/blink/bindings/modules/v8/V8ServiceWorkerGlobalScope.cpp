...
#endif
const WrapperTypeInfo V8ServiceWorkerGlobalScope::wrapperTypeInfo = { gin::kEmbedderBlink, V8ServiceWorkerGlobalScope::domTemplate, V8ServiceWorkerGlobalScope::refObject, V8ServiceWorkerGlobalScope::derefObject, V8ServiceWorkerGlobalScope::trace, 0, 0, V8ServiceWorkerGlobalScope::preparePrototypeAndInterfaceObject, V8ServiceWorkerGlobalScope::installConditionallyEnabledProperties, "ServiceWorkerGlobalScope", &V8WorkerGlobalScope::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void onforeignfetchAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    ServiceWorkerGlobalScope* impl = V8ServiceWorkerGlobalScope::toImpl(holder);
    EventListener* cppValue(impl->onforeignfetch());
    v8SetReturnValue(info, cppValue ? v8::Local<v8::Value>(V8AbstractEventListener::cast(cppValue)->getListenerObject(impl->executionContext())) : v8::Local<v8::Value>(v8::Null(info.GetIsolate())));
}
...
static void cachesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    ServiceWorkerGlobalScope* impl = V8ServiceWorkerGlobalScope::toImpl(holder);
    ExceptionState exceptionState(ExceptionState::GetterContext, "caches", "ServiceWorkerGlobalScope", holder, info.GetIsolate());
...
static void cachesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ServiceWorkerGlobalScopeV8Internal::cachesAttributeGetter(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
const V8DOMConfiguration::AttributeConfiguration V8ServiceWorkerGlobalScopeAttributes[] = {
    ...
    {"ImageBitmap", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8ImageBitmap::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
    ...
    {"URLSearchParams", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8URLSearchParams::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
...
const V8DOMConfiguration::AccessorConfiguration V8ServiceWorkerGlobalScopeAccessors[] = {
    {"clients", ServiceWorkerGlobalScopeV8Internal::clientsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
    {"registration", ServiceWorkerGlobalScopeV8Internal::registrationAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
...
const V8DOMConfiguration::MethodConfiguration V8ServiceWorkerGlobalScopeMethods[] = {
    ...
    {"close", ServiceWorkerGlobalScopeV8Internal::closeMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance},
...
static void installV8ServiceWorkerGlobalScopeTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::backgroundSyncEnabled()) {
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeSyncEventConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoronsyncConfiguration);
    }
    if (RuntimeEnabledFeatures::durableStorageEnabled()) {
        ...
        {"StorageManager", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8StorageManager::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
    ...
    if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
        ...
        {"OffScreenCanvas", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8OffScreenCanvas::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
    ...
    if (RuntimeEnabledFeatures::foreignFetchEnabled()) {
        ...
        {"InstallEvent", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8InstallEvent::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeInstallEventConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoronforeignfetchConfiguration);
    }
    if (RuntimeEnabledFeatures::geofencingEnabled()) {
        ...
        const V8DOMConfiguration::AttributeConfiguration attributeGeofencingEventConfiguration = \
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeGeofencingEventConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorongeofenceenterConfiguration = \
        {"ongeofenceenter", ServiceWorkerGlobalScopeV8Internal::ongeofenceenterAttributeGetterCallback, ServiceWorkerGlobalScopeV8Internal::ongeofenceenterAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorongeofenceenterConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorongeofenceleaveConfiguration = \
        {"ongeofenceleave", ServiceWorkerGlobalScopeV8Internal::ongeofenceleaveAttributeGetterCallback, ServiceWorkerGlobalScopeV8Internal::ongeofenceleaveAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorongeofenceleaveConfiguration);
    }
    if (RuntimeEnabledFeatures::globalCacheStorageEnabled()) {
        ...
        {"caches", ServiceWorkerGlobalScopeV8Internal::cachesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorcachesConfiguration);
    }
    if (RuntimeEnabledFeatures::navigatorConnectEnabled()) {
        const V8DOMConfiguration::AttributeConfiguration attributeCrossOriginServiceWorkerClientConfiguration = \
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeCrossOriginServiceWorkerClientConfiguration);
        ...
        const V8DOMConfiguration::AttributeConfiguration attributeServicePortConnectEventConfiguration = \
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeServicePortConnectEventConfiguration);
        ...
        const V8DOMConfiguration::AccessorConfiguration accessoroncrossoriginmessageConfiguration = \
        {"oncrossoriginmessage", ServiceWorkerGlobalScopeV8Internal::oncrossoriginmessageAttributeGetterCallback, ServiceWorkerGlobalScopeV8Internal::oncrossoriginmessageAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoroncrossoriginmessageConfiguration);
    }
    ...
    if (RuntimeEnabledFeatures::notificationsEnabled()) {
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeNotificationEventConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoronnotificationclickConfiguration);
    }
    if (RuntimeEnabledFeatures::performanceObserverEnabled()) {
        ...
        {"PerformanceObserverEntryList", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8PerformanceObserverEntryList::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
    ...
    if (RuntimeEnabledFeatures::pushMessagingDataEnabled()) {
        const V8DOMConfiguration::AttributeConfiguration attributePushMessageDataConfiguration = \
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributePushMessageDataConfiguration);
    }
    if (RuntimeEnabledFeatures::pushMessagingEnabled()) {
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributePushEventConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoronpushConfiguration);
    }
    if (RuntimeEnabledFeatures::serviceWorkerClientAttributesEnabled()) {
        ...
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeWindowClientConfiguration);
    }
    if (RuntimeEnabledFeatures::serviceWorkerExtendableMessageEventEnabled()) {
        const V8DOMConfiguration::AttributeConfiguration attributeExtendableMessageEventConfiguration = \
        {"ExtendableMessageEvent", v8ConstructorAttributeGetter, ServiceWorkerGlobalScopeV8Internal::ServiceWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8ExtendableMessageEvent::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, attributeExtendableMessageEventConfiguration);
    }
