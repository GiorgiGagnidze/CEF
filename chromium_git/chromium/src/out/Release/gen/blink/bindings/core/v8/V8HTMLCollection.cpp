...
#endif
const WrapperTypeInfo V8HTMLCollection::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLCollection::domTemplate, V8HTMLCollection::refObject, V8HTMLCollection::derefObject, V8HTMLCollection::trace, 0, V8HTMLCollection::visitDOMWrapper, V8HTMLCollection::preparePrototypeAndInterfaceObject, V8HTMLCollection::installConditionallyEnabledProperties, "HTMLCollection", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLCollectionAccessors[] = {
    {"length", HTMLCollectionV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
