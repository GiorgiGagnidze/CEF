...
#endif
const WrapperTypeInfo V8AudioParam::wrapperTypeInfo = { gin::kEmbedderBlink, V8AudioParam::domTemplate, V8AudioParam::refObject, V8AudioParam::derefObject, V8AudioParam::trace, 0, 0, V8AudioParam::preparePrototypeAndInterfaceObject, V8AudioParam::installConditionallyEnabledProperties, "AudioParam", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void setValueAtTimeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->setValueAtTime(value, time, exceptionState);
...
static void linearRampToValueAtTimeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->linearRampToValueAtTime(value, time, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void exponentialRampToValueAtTimeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->exponentialRampToValueAtTime(value, time, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void setTargetAtTimeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->setTargetAtTime(target, time, timeConstant, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void setValueCurveAtTimeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->setValueCurveAtTime(values, time, duration, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void cancelScheduledValuesMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioParam> result = impl->cancelScheduledValues(startTime, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
const V8DOMConfiguration::AccessorConfiguration V8AudioParamAccessors[] = {
    ...
    {"defaultValue", AudioParamV8Internal::defaultValueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
