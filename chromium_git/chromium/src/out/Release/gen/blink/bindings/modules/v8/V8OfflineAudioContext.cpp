...
#endif
const WrapperTypeInfo V8OfflineAudioContext::wrapperTypeInfo = { gin::kEmbedderBlink, V8OfflineAudioContext::domTemplate, V8OfflineAudioContext::refObject, V8OfflineAudioContext::derefObject, V8OfflineAudioContext::trace, V8OfflineAudioContext::toActiveDOMObject, 0, V8OfflineAudioContext::preparePrototypeAndInterfaceObject, V8OfflineAudioContext::installConditionallyEnabledProperties, "OfflineAudioContext", &V8AudioContext::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
