...
#endif
const WrapperTypeInfo V8Body::wrapperTypeInfo = { gin::kEmbedderBlink, V8Body::domTemplate, V8Body::refObject, V8Body::derefObject, V8Body::trace, V8Body::toActiveDOMObject, 0, V8Body::preparePrototypeAndInterfaceObject, V8Body::installConditionallyEnabledProperties, "Body", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8BodyAccessors[] = {
    {"bodyUsed", BodyV8Internal::bodyUsedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
