...
#include "V8CalcDictionary.h"

#include "bindings/core/v8/ExceptionState.h"

namespace blink {

void V8CalcDictionary::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, CalcDictionary& impl, ExceptionState& exceptionState)
{
...
v8::Local<v8::Value> toV8(const CalcDictionary& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8CalcDictionary(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}

bool toV8CalcDictionary(const CalcDictionary& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    if (impl.hasCh()) {
...
CalcDictionary NativeValueTraits<CalcDictionary>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    CalcDictionary impl;
    V8CalcDictionary::toImpl(isolate, value, impl, exceptionState);
    return impl;
}
