...
#endif
const WrapperTypeInfo V8MediaError::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaError::domTemplate, V8MediaError::refObject, V8MediaError::derefObject, V8MediaError::trace, 0, 0, V8MediaError::preparePrototypeAndInterfaceObject, V8MediaError::installConditionallyEnabledProperties, "MediaError", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MediaErrorAccessors[] = {
    {"code", MediaErrorV8Internal::codeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
