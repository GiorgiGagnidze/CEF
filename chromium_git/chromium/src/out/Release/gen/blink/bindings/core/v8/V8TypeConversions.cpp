...
#endif
const WrapperTypeInfo V8TypeConversions::wrapperTypeInfo = { gin::kEmbedderBlink, V8TypeConversions::domTemplate, V8TypeConversions::refObject, V8TypeConversions::derefObject, V8TypeConversions::trace, 0, 0, V8TypeConversions::preparePrototypeAndInterfaceObject, V8TypeConversions::installConditionallyEnabledProperties, "TypeConversions", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8TypeConversionsAccessors[] = {
    ...
    {"testByteStringTreatReturnedNullStringAsNullAttribute", TypeConversionsV8Internal::testByteStringTreatReturnedNullStringAsNullAttributeAttributeGetterCallback, TypeConversionsV8Internal::testByteStringTreatReturnedNullStringAsNullAttributeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"testByteStringTreatReturnedNullStringAsUndefinedAttribute", TypeConversionsV8Internal::testByteStringTreatReturnedNullStringAsUndefinedAttributeAttributeGetterCallback, TypeConversionsV8Internal::testByteStringTreatReturnedNullStringAsUndefinedAttributeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    ...
    {"testUSVStringTreatReturnedNullStringAsNullAttribute", TypeConversionsV8Internal::testUSVStringTreatReturnedNullStringAsNullAttributeAttributeGetterCallback, TypeConversionsV8Internal::testUSVStringTreatReturnedNullStringAsNullAttributeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
const V8DOMConfiguration::MethodConfiguration V8TypeConversionsMethods[] = {
    {"getTestByteStringTreatReturnedNullStringAsNullMethod", TypeConversionsV8Internal::getTestByteStringTreatReturnedNullStringAsNullMethodMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getTestByteStringTreatReturnedNullStringAsUndefinedMethod", TypeConversionsV8Internal::getTestByteStringTreatReturnedNullStringAsUndefinedMethodMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"getTestUSVStringTreatReturnedNullStringAsNullMethod", TypeConversionsV8Internal::getTestUSVStringTreatReturnedNullStringAsNullMethodMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getTestUSVStringTreatReturnedNullStringAsUndefinedMethod", TypeConversionsV8Internal::getTestUSVStringTreatReturnedNullStringAsUndefinedMethodMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
