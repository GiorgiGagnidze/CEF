...
#endif
const WrapperTypeInfo V8VTTRegion::wrapperTypeInfo = { gin::kEmbedderBlink, V8VTTRegion::domTemplate, V8VTTRegion::refObject, V8VTTRegion::derefObject, V8VTTRegion::trace, 0, 0, V8VTTRegion::preparePrototypeAndInterfaceObject, V8VTTRegion::installConditionallyEnabledProperties, "VTTRegion", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void trackAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    VTTRegion* impl = V8VTTRegion::toImpl(holder);
    RawPtr<TextTrack> cppValue(impl->track());
...
{
    RawPtr<VTTRegion> impl = VTTRegion::create();
...
const V8DOMConfiguration::AccessorConfiguration V8VTTRegionAccessors[] = {
    ...
    {"track", VTTRegionV8Internal::trackAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
