...
#endif
const WrapperTypeInfo V8DOMFileSystemSync::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMFileSystemSync::domTemplate, V8DOMFileSystemSync::refObject, V8DOMFileSystemSync::derefObject, V8DOMFileSystemSync::trace, 0, 0, V8DOMFileSystemSync::preparePrototypeAndInterfaceObject, V8DOMFileSystemSync::installConditionallyEnabledProperties, "DOMFileSystemSync", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8DOMFileSystemSyncAccessors[] = {
    {"name", DOMFileSystemSyncV8Internal::nameAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"root", DOMFileSystemSyncV8Internal::rootAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
