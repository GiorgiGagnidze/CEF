...
#endif
const WrapperTypeInfo V8DOMMatrix::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMMatrix::domTemplate, V8DOMMatrix::refObject, V8DOMMatrix::derefObject, V8DOMMatrix::trace, 0, 0, V8DOMMatrix::preparePrototypeAndInterfaceObject, V8DOMMatrix::installConditionallyEnabledProperties, "DOMMatrix", &V8DOMMatrixReadOnly::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
