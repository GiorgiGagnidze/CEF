...
#endif
const WrapperTypeInfo V8WebGLActiveInfo::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLActiveInfo::domTemplate, V8WebGLActiveInfo::refObject, V8WebGLActiveInfo::derefObject, V8WebGLActiveInfo::trace, 0, 0, V8WebGLActiveInfo::preparePrototypeAndInterfaceObject, V8WebGLActiveInfo::installConditionallyEnabledProperties, "WebGLActiveInfo", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8WebGLActiveInfoAccessors[] = {
    {"size", WebGLActiveInfoV8Internal::sizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", WebGLActiveInfoV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"name", WebGLActiveInfoV8Internal::nameAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
