...
#endif
const WrapperTypeInfo V8Int32Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Int32Array::refObject, V8Int32Array::derefObject, V8Int32Array::trace, 0, 0, V8Int32Array::preparePrototypeAndInterfaceObject, V8Int32Array::installConditionallyEnabledProperties, "Int32Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::RefCountedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
DOMInt32Array* V8Int32Array::toImpl(v8::Local<v8::Object> object)
{
    ...
    RefPtr<DOMInt32Array> typedArray;
