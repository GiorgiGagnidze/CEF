...
#endif
const WrapperTypeInfo V8MIDIInput::wrapperTypeInfo = { gin::kEmbedderBlink, V8MIDIInput::domTemplate, V8MIDIInput::refObject, V8MIDIInput::derefObject, V8MIDIInput::trace, V8MIDIInput::toActiveDOMObject, V8MIDIInput::visitDOMWrapper, V8MIDIInput::preparePrototypeAndInterfaceObject, V8MIDIInput::installConditionallyEnabledProperties, "MIDIInput", &V8MIDIPort::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
