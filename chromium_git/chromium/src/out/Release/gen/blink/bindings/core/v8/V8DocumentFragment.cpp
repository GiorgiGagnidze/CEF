...
#endif
const WrapperTypeInfo V8DocumentFragment::wrapperTypeInfo = { gin::kEmbedderBlink, V8DocumentFragment::domTemplate, V8DocumentFragment::refObject, V8DocumentFragment::derefObject, V8DocumentFragment::trace, 0, 0, V8DocumentFragment::preparePrototypeAndInterfaceObject, V8DocumentFragment::installConditionallyEnabledProperties, "DocumentFragment", &V8Node::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8DocumentFragmentAccessors[] = {
    {"children", DocumentFragmentV8Internal::childrenAttributeGetterCallback, 0, DocumentFragmentV8Internal::childrenAttributeGetterCallbackForMainWorld, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    ...
    {"childElementCount", DocumentFragmentV8Internal::childElementCountAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
