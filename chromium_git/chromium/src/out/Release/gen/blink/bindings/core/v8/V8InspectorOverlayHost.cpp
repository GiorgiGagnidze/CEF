...
#endif
const WrapperTypeInfo V8InspectorOverlayHost::wrapperTypeInfo = { gin::kEmbedderBlink, V8InspectorOverlayHost::domTemplate, V8InspectorOverlayHost::refObject, V8InspectorOverlayHost::derefObject, V8InspectorOverlayHost::trace, 0, 0, V8InspectorOverlayHost::preparePrototypeAndInterfaceObject, V8InspectorOverlayHost::installConditionallyEnabledProperties, "InspectorOverlayHost", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
