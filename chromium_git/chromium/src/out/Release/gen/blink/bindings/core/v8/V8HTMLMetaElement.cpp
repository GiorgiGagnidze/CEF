...
#endif
const WrapperTypeInfo V8HTMLMetaElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLMetaElement::domTemplate, V8HTMLMetaElement::refObject, V8HTMLMetaElement::derefObject, V8HTMLMetaElement::trace, 0, 0, V8HTMLMetaElement::preparePrototypeAndInterfaceObject, V8HTMLMetaElement::installConditionallyEnabledProperties, "HTMLMetaElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
