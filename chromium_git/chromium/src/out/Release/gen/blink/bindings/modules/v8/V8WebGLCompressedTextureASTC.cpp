...
#endif
const WrapperTypeInfo V8WebGLCompressedTextureASTC::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLCompressedTextureASTC::domTemplate, V8WebGLCompressedTextureASTC::refObject, V8WebGLCompressedTextureASTC::derefObject, V8WebGLCompressedTextureASTC::trace, 0, V8WebGLCompressedTextureASTC::visitDOMWrapper, V8WebGLCompressedTextureASTC::preparePrototypeAndInterfaceObject, V8WebGLCompressedTextureASTC::installConditionallyEnabledProperties, "WebGLCompressedTextureASTC", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8WebGLCompressedTextureASTCTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "WebGLCompressedTextureASTC", v8::Local<v8::FunctionTemplate>(), V8WebGLCompressedTextureASTC::internalFieldCount,
        0, 0,
        0, 0,
        0, 0);
    ...
    V8DOMConfiguration::installConstants(isolate, functionTemplate, prototypeTemplate, V8WebGLCompressedTextureASTCConstants, WTF_ARRAY_LENGTH(V8WebGLCompressedTextureASTCConstants));
}

v8::Local<v8::FunctionTemplate> V8WebGLCompressedTextureASTC::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8WebGLCompressedTextureASTCTemplate);
}
...
void V8WebGLCompressedTextureASTC::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8WebGLCompressedTextureASTC::derefObject(ScriptWrappable* scriptWrappable)
{
}
