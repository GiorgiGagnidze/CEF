...
const V8DOMConfiguration::AccessorConfiguration V8SVGPolylineElementAccessors[] = {
    {"points", SVGPolylineElementV8Internal::pointsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animatedPoints", SVGPolylineElementV8Internal::animatedPointsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGPolylineElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGPolylineElement", V8SVGGeometryElement::domTemplate(isolate), V8SVGPolylineElement::internalFieldCount,
        0, 0,
        V8SVGPolylineElementAccessors, WTF_ARRAY_LENGTH(V8SVGPolylineElementAccessors),
        0, 0);
