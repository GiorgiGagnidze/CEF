...
#endif
const WrapperTypeInfo V8CSSSupportsRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSSupportsRule::domTemplate, V8CSSSupportsRule::refObject, V8CSSSupportsRule::derefObject, V8CSSSupportsRule::trace, 0, 0, V8CSSSupportsRule::preparePrototypeAndInterfaceObject, V8CSSSupportsRule::installConditionallyEnabledProperties, "CSSSupportsRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CSSSupportsRuleAccessors[] = {
    {"conditionText", CSSSupportsRuleV8Internal::conditionTextAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"cssRules", CSSSupportsRuleV8Internal::cssRulesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
