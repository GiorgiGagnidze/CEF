...
#endif
const WrapperTypeInfo V8SVGPolygonElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGPolygonElement::domTemplate, V8SVGPolygonElement::refObject, V8SVGPolygonElement::derefObject, V8SVGPolygonElement::trace, 0, 0, V8SVGPolygonElement::preparePrototypeAndInterfaceObject, V8SVGPolygonElement::installConditionallyEnabledProperties, "SVGPolygonElement", &V8SVGGeometryElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGPolygonElementAccessors[] = {
    {"points", SVGPolygonElementV8Internal::pointsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animatedPoints", SVGPolygonElementV8Internal::animatedPointsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGPolygonElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGPolygonElement", V8SVGGeometryElement::domTemplate(isolate), V8SVGPolygonElement::internalFieldCount,
        0, 0,
        V8SVGPolygonElementAccessors, WTF_ARRAY_LENGTH(V8SVGPolygonElementAccessors),
        0, 0);
