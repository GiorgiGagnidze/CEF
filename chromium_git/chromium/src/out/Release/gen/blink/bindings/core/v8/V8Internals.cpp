...
#endif
WrapperTypeInfo V8Internals::wrapperTypeInfo = { gin::kEmbedderBlink, V8Internals::domTemplate, V8Internals::refObject, V8Internals::derefObject, V8Internals::trace, 0, 0, V8Internals::preparePrototypeAndInterfaceObject, V8Internals::installConditionallyEnabledProperties, "Internals", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "disableCompositedAnimation", "Internals", 1, info.Length()), info.GetIsolate());
        return;
    }
    Internals* impl = V8Internals::toImpl(info.Holder());
    Animation* animation;
...
static void startTrackingPaintInvalidationObjectsMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    Internals* impl = V8Internals::toImpl(info.Holder());
    impl->startTrackingPaintInvalidationObjects();
}

static void startTrackingPaintInvalidationObjectsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    InternalsV8Internal::startTrackingPaintInvalidationObjectsMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}

static void stopTrackingPaintInvalidationObjectsMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    Internals* impl = V8Internals::toImpl(info.Holder());
    impl->stopTrackingPaintInvalidationObjects();
}

static void stopTrackingPaintInvalidationObjectsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    InternalsV8Internal::stopTrackingPaintInvalidationObjectsMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}

static void trackedPaintInvalidationObjectsMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    Internals* impl = V8Internals::toImpl(info.Holder());
    v8SetReturnValue(info, toV8(impl->trackedPaintInvalidationObjects(), info.Holder(), info.GetIsolate()));
}

static void trackedPaintInvalidationObjectsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    InternalsV8Internal::trackedPaintInvalidationObjectsMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
static void serializeObjectMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    {
        obj = SerializedScriptValueFactory::instance().create(info.GetIsolate(), info[0], nullptr, nullptr, nullptr, exceptionState);
        if (exceptionState.throwIfNeeded())
            return;
    }
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "resetTypeAheadSession", "Internals", 1, info.Length()), info.GetIsolate());
        return;
    }
    Internals* impl = V8Internals::toImpl(info.Holder());
    HTMLSelectElement* select;
...
static void setNetworkConnectionInfoMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    double downlinkMaxMbps;
    {
        ...
        if (!type.prepare())
            return;
        downlinkMaxMbps = toRestrictedDouble(info.GetIsolate(), info[1], exceptionState);
        if (exceptionState.throwIfNeeded())
            return;
    }
    impl->setNetworkConnectionInfo(type, downlinkMaxMbps, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void setScrollChainMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    WillBeHeapVector<RefPtrWillBeMember<Element>> elements;
    {
        ...
        elements = (toRefPtrWillBeMemberNativeArray<Element, V8Element>(info[1], 2, info.GetIsolate(), exceptionState));
        if (exceptionState.throwIfNeeded())
            return;
    }
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "outlineRects", "Internals", 1, info.Length()), info.GetIsolate());
        return;
    }
    Internals* impl = V8Internals::toImpl(info.Holder());
    Element* element;
...
static void forceRestrictIFramePermissionsMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    Internals* impl = V8Internals::toImpl(info.Holder());
    impl->forceRestrictIFramePermissions();
}

static void forceRestrictIFramePermissionsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    InternalsV8Internal::forceRestrictIFramePermissionsMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "triggerAutoplayViewportCheck", "Internals", 1, info.Length()), info.GetIsolate());
        return;
    }
    Internals* impl = V8Internals::toImpl(info.Holder());
    HTMLMediaElement* mediaElement;
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getScrollAnimationState", "Internals", 1, info.Length()), info.GetIsolate());
        return;
    }
    Internals* impl = V8Internals::toImpl(info.Holder());
    Node* node;
    ...
    v8SetReturnValueInt(info, impl->getScrollAnimationState(node));
}
...
const V8DOMConfiguration::AccessorConfiguration V8InternalsAccessors[] = {
    {"pagePopupWindow", InternalsV8Internal::pagePopupWindowAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"settings", InternalsV8Internal::settingsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"runtimeFlags", InternalsV8Internal::runtimeFlagsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"workerThreadCount", InternalsV8Internal::workerThreadCountAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"cursorUpdatePending", InternalsV8Internal::cursorUpdatePendingAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"unscopeableAttribute", InternalsV8Internal::unscopeableAttributeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"frobulate", InternalsV8Internal::frobulateAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"frobulateNoEnabledCheck", InternalsV8Internal::frobulateNoEnabledCheckAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
const V8DOMConfiguration::MethodConfiguration V8InternalsMethods[] = {
    ...
    {"nextSiblingInComposedTree", InternalsV8Internal::nextSiblingInComposedTreeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"firstChildInComposedTree", InternalsV8Internal::firstChildInComposedTreeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"lastChildInComposedTree", InternalsV8Internal::lastChildInComposedTreeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"nextInComposedTree", InternalsV8Internal::nextInComposedTreeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"previousInComposedTree", InternalsV8Internal::previousInComposedTreeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"touchEventHandlerCount", InternalsV8Internal::touchEventHandlerCountMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"setContinuousSpellCheckingEnabled", InternalsV8Internal::setContinuousSpellCheckingEnabledMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"consoleMessageArgumentCounts", InternalsV8Internal::consoleMessageArgumentCountsMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"startTrackingPaintInvalidationObjects", InternalsV8Internal::startTrackingPaintInvalidationObjectsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"stopTrackingPaintInvalidationObjects", InternalsV8Internal::stopTrackingPaintInvalidationObjectsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"trackedPaintInvalidationObjects", InternalsV8Internal::trackedPaintInvalidationObjectsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"setNetworkStateNotifierTestOnly", InternalsV8Internal::setNetworkStateNotifierTestOnlyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setNetworkConnectionInfo", InternalsV8Internal::setNetworkConnectionInfoMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"forceRestrictIFramePermissions", InternalsV8Internal::forceRestrictIFramePermissionsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
...
void V8Internals::installV8InternalsTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    const V8DOMConfiguration::ConstantConfiguration V8InternalsConstants[] = {
        ...
        {"LAYER_TREE_INCLUDES_REPAINT_RECTS", 2, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        ...
        {"LAYER_TREE_INCLUDES_PAINT_INVALIDATION_OBJECTS", 32, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"LAYER_TREE_INCLUDES_COMPOSITING_REASONS", 64, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
    };
...
void V8Internals::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
