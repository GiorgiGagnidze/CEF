...
#endif
const WrapperTypeInfo V8IDBFactory::wrapperTypeInfo = { gin::kEmbedderBlink, V8IDBFactory::domTemplate, V8IDBFactory::refObject, V8IDBFactory::derefObject, V8IDBFactory::trace, 0, 0, V8IDBFactory::preparePrototypeAndInterfaceObject, V8IDBFactory::installConditionallyEnabledProperties, "IDBFactory", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
