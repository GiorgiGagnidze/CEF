...
static void assignOriginSafeMethodGetter(const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    v8::Local<v8::FunctionTemplate> domTemplate = data->domTemplate(&domTemplateKey, LocationV8Internal::assignMethodCallback, v8Undefined(), v8::Signature::New(info.GetIsolate(), V8Location::domTemplate(info.GetIsolate())), 1);
    ...
    v8::Local<v8::Value> hiddenValue = V8HiddenValue::getHiddenValue(ScriptState::current(info.GetIsolate()), v8::Local<v8::Object>::Cast(info.This()), v8AtomicString(info.GetIsolate(), "assign"));
...
static void replaceOriginSafeMethodGetter(const v8::PropertyCallbackInfo<v8::Value>& info)
{
    static int domTemplateKey; // This address is used for a key to look up the dom template.
    V8PerIsolateData* data = V8PerIsolateData::from(info.GetIsolate());
    v8::Local<v8::FunctionTemplate> domTemplate = data->domTemplate(&domTemplateKey, LocationV8Internal::replaceMethodCallback, v8Undefined(), v8::Signature::New(info.GetIsolate(), V8Location::domTemplate(info.GetIsolate())), 1);
    ...
    v8::Local<v8::Value> hiddenValue = V8HiddenValue::getHiddenValue(ScriptState::current(info.GetIsolate()), v8::Local<v8::Object>::Cast(info.This()), v8AtomicString(info.GetIsolate(), "replace"));
    if (!hiddenValue.IsEmpty()) {
        v8SetReturnValue(info, hiddenValue);
        return;
    }
...
static void installV8LocationTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "Location", v8::Local<v8::FunctionTemplate>(), V8Location::internalFieldCount,
        ...
        0, 0,
        V8LocationMethods, WTF_ARRAY_LENGTH(V8LocationMethods));
    ...
    V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, assignOriginSafeAttributeConfiguration);
    ...
    V8DOMConfiguration::installAttribute(isolate, instanceTemplate, prototypeTemplate, replaceOriginSafeAttributeConfiguration);
}
