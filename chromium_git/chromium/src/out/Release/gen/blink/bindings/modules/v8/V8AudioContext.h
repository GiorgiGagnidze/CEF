...
public:
    ...
    static AbstractAudioContext* toImpl(v8::Local<v8::Object> object)
    {
        return toScriptWrappable(object)->toImpl<AbstractAudioContext>();
    }
    MODULES_EXPORT static AbstractAudioContext* toImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
    ...
    {
        visitor->trace(scriptWrappable->toImpl<AbstractAudioContext>());
    }
...
template <>
struct V8TypeOf<AbstractAudioContext> {
