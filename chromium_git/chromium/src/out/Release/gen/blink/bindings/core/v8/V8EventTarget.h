...
public:
    ...
    static void addEventListenerMethodCustom(const v8::FunctionCallbackInfo<v8::Value>&);
    static void removeEventListenerMethodCustom(const v8::FunctionCallbackInfo<v8::Value>&);
