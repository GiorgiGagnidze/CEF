...
#endif
const WrapperTypeInfo V8SVGLineElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGLineElement::domTemplate, V8SVGLineElement::refObject, V8SVGLineElement::derefObject, V8SVGLineElement::trace, 0, 0, V8SVGLineElement::preparePrototypeAndInterfaceObject, V8SVGLineElement::installConditionallyEnabledProperties, "SVGLineElement", &V8SVGGeometryElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGLineElementAccessors[] = {
    {"x1", SVGLineElementV8Internal::x1AttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y1", SVGLineElementV8Internal::y1AttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"x2", SVGLineElementV8Internal::x2AttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y2", SVGLineElementV8Internal::y2AttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGLineElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGLineElement", V8SVGGeometryElement::domTemplate(isolate), V8SVGLineElement::internalFieldCount,
        0, 0,
        V8SVGLineElementAccessors, WTF_ARRAY_LENGTH(V8SVGLineElementAccessors),
        0, 0);
