...
#endif
const WrapperTypeInfo V8Animation::wrapperTypeInfo = { gin::kEmbedderBlink, V8Animation::domTemplate, V8Animation::refObject, V8Animation::derefObject, V8Animation::trace, V8Animation::toActiveDOMObject, 0, V8Animation::preparePrototypeAndInterfaceObject, V8Animation::installConditionallyEnabledProperties, "Animation", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8AnimationAccessors[] = {
    ...
    {"playState", AnimationV8Internal::playStateAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
static void installV8AnimationTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::webAnimationsAPIEnabled()) {
        ...
        {"finished", AnimationV8Internal::finishedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorfinishedConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorreadyConfiguration = \
        {"ready", AnimationV8Internal::readyAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorreadyConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessoreffectConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorendClipConfiguration = \
        {"endClip", AnimationV8Internal::endClipAttributeGetterCallback, AnimationV8Internal::endClipAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorendClipConfiguration);
        const V8DOMConfiguration::AccessorConfiguration accessorstartClipConfiguration = \
        {"startClip", AnimationV8Internal::startClipAttributeGetterCallback, AnimationV8Internal::startClipAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorstartClipConfiguration);
    }
}
