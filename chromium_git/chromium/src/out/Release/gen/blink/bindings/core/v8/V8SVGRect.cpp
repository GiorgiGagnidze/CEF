...
#endif
const WrapperTypeInfo V8SVGRect::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGRect::domTemplate, V8SVGRect::refObject, V8SVGRect::derefObject, V8SVGRect::trace, 0, V8SVGRect::visitDOMWrapper, V8SVGRect::preparePrototypeAndInterfaceObject, V8SVGRect::installConditionallyEnabledProperties, "SVGRect", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
