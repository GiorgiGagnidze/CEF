...
#endif
const WrapperTypeInfo V8Bluetooth::wrapperTypeInfo = { gin::kEmbedderBlink, V8Bluetooth::domTemplate, V8Bluetooth::refObject, V8Bluetooth::derefObject, V8Bluetooth::trace, 0, 0, V8Bluetooth::preparePrototypeAndInterfaceObject, V8Bluetooth::installConditionallyEnabledProperties, "Bluetooth", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
