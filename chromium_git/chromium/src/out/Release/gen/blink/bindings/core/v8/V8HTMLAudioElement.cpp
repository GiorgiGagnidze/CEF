...
#endif
const WrapperTypeInfo V8HTMLAudioElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLAudioElement::domTemplate, V8HTMLAudioElement::refObject, V8HTMLAudioElement::derefObject, V8HTMLAudioElement::trace, V8HTMLAudioElement::toActiveDOMObject, 0, V8HTMLAudioElement::preparePrototypeAndInterfaceObject, V8HTMLAudioElement::installConditionallyEnabledProperties, "HTMLAudioElement", &V8HTMLMediaElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
