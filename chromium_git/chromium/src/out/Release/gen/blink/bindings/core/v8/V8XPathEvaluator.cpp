...
#endif
const WrapperTypeInfo V8XPathEvaluator::wrapperTypeInfo = { gin::kEmbedderBlink, V8XPathEvaluator::domTemplate, V8XPathEvaluator::refObject, V8XPathEvaluator::derefObject, V8XPathEvaluator::trace, 0, 0, V8XPathEvaluator::preparePrototypeAndInterfaceObject, V8XPathEvaluator::installConditionallyEnabledProperties, "XPathEvaluator", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
