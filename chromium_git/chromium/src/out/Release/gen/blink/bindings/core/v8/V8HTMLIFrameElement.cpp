...
#endif
const WrapperTypeInfo V8HTMLIFrameElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLIFrameElement::domTemplate, V8HTMLIFrameElement::refObject, V8HTMLIFrameElement::derefObject, V8HTMLIFrameElement::trace, 0, 0, V8HTMLIFrameElement::preparePrototypeAndInterfaceObject, V8HTMLIFrameElement::installConditionallyEnabledProperties, "HTMLIFrameElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLIFrameElementAccessors[] = {
    ...
    {"contentDocument", HTMLIFrameElementV8Internal::contentDocumentAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"contentWindow", HTMLIFrameElementV8Internal::contentWindowAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
