...
#endif
const WrapperTypeInfo V8RTCIceCandidate::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCIceCandidate::domTemplate, V8RTCIceCandidate::refObject, V8RTCIceCandidate::derefObject, V8RTCIceCandidate::trace, 0, 0, V8RTCIceCandidate::preparePrototypeAndInterfaceObject, V8RTCIceCandidate::installConditionallyEnabledProperties, "RTCIceCandidate", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
