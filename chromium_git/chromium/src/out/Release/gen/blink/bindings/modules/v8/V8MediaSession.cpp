...
#endif
const WrapperTypeInfo V8MediaSession::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaSession::domTemplate, V8MediaSession::refObject, V8MediaSession::derefObject, V8MediaSession::trace, 0, 0, V8MediaSession::preparePrototypeAndInterfaceObject, V8MediaSession::installConditionallyEnabledProperties, "MediaSession", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void metadataAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    impl->setMetadata(WTF::getPtr(cppValue));
}
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<MediaSession> impl = MediaSession::create(executionContext, exceptionState);
...
static void installV8MediaSessionTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (!RuntimeEnabledFeatures::mediaSessionEnabled())
        ...
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "MediaSession", v8::Local<v8::FunctionTemplate>(), V8MediaSession::internalFieldCount,
            0, 0,
            V8MediaSessionAccessors, WTF_ARRAY_LENGTH(V8MediaSessionAccessors),
