...
#endif
const WrapperTypeInfo V8MemoryInfo::wrapperTypeInfo = { gin::kEmbedderBlink, V8MemoryInfo::domTemplate, V8MemoryInfo::refObject, V8MemoryInfo::derefObject, V8MemoryInfo::trace, 0, 0, V8MemoryInfo::preparePrototypeAndInterfaceObject, V8MemoryInfo::installConditionallyEnabledProperties, "MemoryInfo", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MemoryInfoAccessors[] = {
    {"totalJSHeapSize", MemoryInfoV8Internal::totalJSHeapSizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"usedJSHeapSize", MemoryInfoV8Internal::usedJSHeapSizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"jsHeapSizeLimit", MemoryInfoV8Internal::jsHeapSizeLimitAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
