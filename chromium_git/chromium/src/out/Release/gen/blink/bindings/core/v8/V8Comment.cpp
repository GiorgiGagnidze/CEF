...
#endif
const WrapperTypeInfo V8Comment::wrapperTypeInfo = { gin::kEmbedderBlink, V8Comment::domTemplate, V8Comment::refObject, V8Comment::derefObject, V8Comment::trace, 0, 0, V8Comment::preparePrototypeAndInterfaceObject, V8Comment::installConditionallyEnabledProperties, "Comment", &V8CharacterData::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
