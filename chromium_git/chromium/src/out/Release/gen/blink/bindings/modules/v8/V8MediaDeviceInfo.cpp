...
#endif
const WrapperTypeInfo V8MediaDeviceInfo::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaDeviceInfo::domTemplate, V8MediaDeviceInfo::refObject, V8MediaDeviceInfo::derefObject, V8MediaDeviceInfo::trace, 0, 0, V8MediaDeviceInfo::preparePrototypeAndInterfaceObject, V8MediaDeviceInfo::installConditionallyEnabledProperties, "MediaDeviceInfo", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MediaDeviceInfoAccessors[] = {
    {"deviceId", MediaDeviceInfoV8Internal::deviceIdAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"kind", MediaDeviceInfoV8Internal::kindAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"label", MediaDeviceInfoV8Internal::labelAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"groupId", MediaDeviceInfoV8Internal::groupIdAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8MediaDeviceInfoTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "MediaDeviceInfo", v8::Local<v8::FunctionTemplate>(), V8MediaDeviceInfo::internalFieldCount,
        ...
        V8MediaDeviceInfoMethods, WTF_ARRAY_LENGTH(V8MediaDeviceInfoMethods));
