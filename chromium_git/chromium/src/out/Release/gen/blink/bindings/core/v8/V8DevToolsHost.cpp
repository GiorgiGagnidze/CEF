...
static void convertLengthForEmbedderMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "convertLengthForEmbedder", "DevToolsHost", info.Holder(), info.GetIsolate());
    ...
    float length;
    {
        length = toRestrictedFloat(info.GetIsolate(), info[0], exceptionState);
        if (exceptionState.throwIfNeeded())
            return;
    }
    v8SetReturnValue(info, impl->convertLengthForEmbedder(length));
}

static void convertLengthForEmbedderMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    DevToolsHostV8Internal::convertLengthForEmbedderMethod(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
const V8DOMConfiguration::MethodConfiguration V8DevToolsHostMethods[] = {
    ...
    {"convertLengthForEmbedder", DevToolsHostV8Internal::convertLengthForEmbedderMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
