...
#endif
const WrapperTypeInfo V8VTTCue::wrapperTypeInfo = { gin::kEmbedderBlink, V8VTTCue::domTemplate, V8VTTCue::refObject, V8VTTCue::derefObject, V8VTTCue::trace, 0, V8VTTCue::visitDOMWrapper, V8VTTCue::preparePrototypeAndInterfaceObject, V8VTTCue::installConditionallyEnabledProperties, "VTTCue", &V8TextTrackCue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<VTTCue> impl = VTTCue::create(document, startTime, endTime, text);
...
static void installV8VTTCueTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::webVTTRegionsEnabled()) {
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorregionIdConfiguration);
    }
}
