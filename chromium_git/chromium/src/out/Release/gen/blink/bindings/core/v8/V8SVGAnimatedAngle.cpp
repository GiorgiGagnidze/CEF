...
#endif
const WrapperTypeInfo V8SVGAnimatedAngle::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedAngle::domTemplate, V8SVGAnimatedAngle::refObject, V8SVGAnimatedAngle::derefObject, V8SVGAnimatedAngle::trace, 0, V8SVGAnimatedAngle::visitDOMWrapper, V8SVGAnimatedAngle::preparePrototypeAndInterfaceObject, V8SVGAnimatedAngle::installConditionallyEnabledProperties, "SVGAnimatedAngle", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedAngleAccessors[] = {
    {"baseVal", SVGAnimatedAngleV8Internal::baseValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedAngleV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
