...
#endif
const WrapperTypeInfo V8ClientRectList::wrapperTypeInfo = { gin::kEmbedderBlink, V8ClientRectList::domTemplate, V8ClientRectList::refObject, V8ClientRectList::derefObject, V8ClientRectList::trace, 0, 0, V8ClientRectList::preparePrototypeAndInterfaceObject, V8ClientRectList::installConditionallyEnabledProperties, "ClientRectList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8ClientRectListAccessors[] = {
    {"length", ClientRectListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
