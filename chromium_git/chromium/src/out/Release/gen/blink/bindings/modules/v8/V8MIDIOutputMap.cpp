...
#endif
const WrapperTypeInfo V8MIDIOutputMap::wrapperTypeInfo = { gin::kEmbedderBlink, V8MIDIOutputMap::domTemplate, V8MIDIOutputMap::refObject, V8MIDIOutputMap::derefObject, V8MIDIOutputMap::trace, 0, 0, V8MIDIOutputMap::preparePrototypeAndInterfaceObject, V8MIDIOutputMap::installConditionallyEnabledProperties, "MIDIOutputMap", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MIDIOutputMapAccessors[] = {
    {"size", MIDIOutputMapV8Internal::sizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
