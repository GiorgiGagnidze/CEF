...
class SpeechRecognitionEvent : public ::google::protobuf::MessageLite {
 public:
  ...
  inline ::content::proto::SpeechRecognitionEvent_EndpointerEventType endpoint() const;
  inline void set_endpoint(::content::proto::SpeechRecognitionEvent_EndpointerEventType value);
...
class SpeechRecognitionAlternative : public ::google::protobuf::MessageLite {
 public:
  ...
  inline void set_allocated_transcript(::std::string* transcript);
