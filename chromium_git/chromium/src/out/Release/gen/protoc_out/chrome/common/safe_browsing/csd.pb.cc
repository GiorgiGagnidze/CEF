...
bool ClientMalwareRequest::IsInitialized() const {
  ...
  for (int i = 0; i < bad_ip_url_info_size(); i++) {
    if (!this->bad_ip_url_info(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientDownloadRequest_SignatureInfo::IsInitialized() const {
  ...
  for (int i = 0; i < xattr_size(); i++) {
    if (!this->xattr(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientDownloadRequest_MachOHeaders::IsInitialized() const {
  ...
  for (int i = 0; i < load_commands_size(); i++) {
    if (!this->load_commands(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientDownloadRequest_ImageHeaders::IsInitialized() const {
  ...
  for (int i = 0; i < mach_o_headers_size(); i++) {
    if (!this->mach_o_headers(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientDownloadRequest::IsInitialized() const {
  ...
  for (int i = 0; i < archived_binary_size(); i++) {
    if (!this->archived_binary(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientIncidentReport_IncidentData_BinaryIntegrityIncident::IsInitialized() const {
  ...
  for (int i = 0; i < contained_file_size(); i++) {
    if (!this->contained_file(i).IsInitialized()) return false;
  }
  return true;
}
...
const ClientIncidentReport_IncidentData_ResourceRequestIncident_Type ClientIncidentReport_IncidentData_ResourceRequestIncident::TYPE_SCRIPT;
const ClientIncidentReport_IncidentData_ResourceRequestIncident_Type ClientIncidentReport_IncidentData_ResourceRequestIncident::TYPE_DOMAIN;
...
bool ClientIncidentReport_EnvironmentData_Process::IsInitialized() const {
  ...
  for (int i = 0; i < dll_size(); i++) {
    if (!this->dll(i).IsInitialized()) return false;
  }
  return true;
}
...
bool ClientIncidentReport::IsInitialized() const {
  ...
  for (int i = 0; i < incident_size(); i++) {
    if (!this->incident(i).IsInitialized()) return false;
  }
  if (has_download()) {
    if (!this->download().IsInitialized()) return false;
  }
