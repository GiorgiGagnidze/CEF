...
class CC_PROTO_EXPORT MemoryAllocation : public ::google::protobuf::MessageLite {
 public:
  ...
  static const PriorityCutoff UNKNOWN = MemoryAllocation_PriorityCutoff_UNKNOWN;
  static const PriorityCutoff ALLOW_NOTHING = MemoryAllocation_PriorityCutoff_ALLOW_NOTHING;
  static const PriorityCutoff ALLOW_REQUIRED_ONLY = MemoryAllocation_PriorityCutoff_ALLOW_REQUIRED_ONLY;
  static const PriorityCutoff ALLOW_NICE_TO_HAVE = MemoryAllocation_PriorityCutoff_ALLOW_NICE_TO_HAVE;
  static const PriorityCutoff ALLOW_EVERYTHING = MemoryAllocation_PriorityCutoff_ALLOW_EVERYTHING;
