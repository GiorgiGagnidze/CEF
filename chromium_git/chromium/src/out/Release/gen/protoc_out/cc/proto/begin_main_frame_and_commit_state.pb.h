...
class CC_PROTO_EXPORT ScrollUpdateInfo : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(ScrollUpdateInfo* other);

  // implements Message ----------------------------------------------

  ScrollUpdateInfo* New() const;
  ...
  inline ::google::protobuf::int64 layer_id() const;
  inline void set_layer_id(::google::protobuf::int64 value);

  // optional .cc.proto.Vector2d scroll_delta = 2;
  inline bool has_scroll_delta() const;
  inline void clear_scroll_delta();
  static const int kScrollDeltaFieldNumber = 2;
  inline const ::cc::proto::Vector2d& scroll_delta() const;
  inline ::cc::proto::Vector2d* mutable_scroll_delta();
  inline ::cc::proto::Vector2d* release_scroll_delta();
  inline void set_allocated_scroll_delta(::cc::proto::Vector2d* scroll_delta);
...
class CC_PROTO_EXPORT ScrollAndScaleSet : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(ScrollAndScaleSet* other);

  // implements Message ----------------------------------------------

  ScrollAndScaleSet* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  ...
  inline int scrolls_size() const;
  inline void clear_scrolls();
  static const int kScrollsFieldNumber = 1;
  inline const ::cc::proto::ScrollUpdateInfo& scrolls(int index) const;
  inline ::cc::proto::ScrollUpdateInfo* mutable_scrolls(int index);
  inline ::cc::proto::ScrollUpdateInfo* add_scrolls();
  ...
  inline bool has_page_scale_delta() const;
  inline void clear_page_scale_delta();
  static const int kPageScaleDeltaFieldNumber = 2;
  inline float page_scale_delta() const;
  inline void set_page_scale_delta(float value);

  // optional .cc.proto.Vector2dF elastic_overscroll_delta = 3;
  inline bool has_elastic_overscroll_delta() const;
  inline void clear_elastic_overscroll_delta();
  static const int kElasticOverscrollDeltaFieldNumber = 3;
  inline const ::cc::proto::Vector2dF& elastic_overscroll_delta() const;
  inline ::cc::proto::Vector2dF* mutable_elastic_overscroll_delta();
  inline ::cc::proto::Vector2dF* release_elastic_overscroll_delta();
  inline void set_allocated_elastic_overscroll_delta(::cc::proto::Vector2dF* elastic_overscroll_delta);

  // optional float top_controls_delta = 4;
  inline bool has_top_controls_delta() const;
  inline void clear_top_controls_delta();
  static const int kTopControlsDeltaFieldNumber = 4;
  inline float top_controls_delta() const;
  inline void set_top_controls_delta(float value);
...
class CC_PROTO_EXPORT BeginFrameArgs : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(BeginFrameArgs* other);
  ...
  static const BeginFrameArgsType INVALID = BeginFrameArgs_BeginFrameArgsType_INVALID;
  static const BeginFrameArgsType NORMAL = BeginFrameArgs_BeginFrameArgsType_NORMAL;
  static const BeginFrameArgsType MISSED = BeginFrameArgs_BeginFrameArgsType_MISSED;
  static const BeginFrameArgsType BEGIN_FRAME_ARGS_TYPE_MAX = BeginFrameArgs_BeginFrameArgsType_BEGIN_FRAME_ARGS_TYPE_MAX;
  ...
  inline bool has_frame_time() const;
  inline void clear_frame_time();
  static const int kFrameTimeFieldNumber = 1;
  inline ::google::protobuf::int64 frame_time() const;
  inline void set_frame_time(::google::protobuf::int64 value);
  ...
  inline ::google::protobuf::int64 interval() const;
  inline void set_interval(::google::protobuf::int64 value);

  // optional .cc.proto.BeginFrameArgs.BeginFrameArgsType type = 4;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 4;
  inline ::cc::proto::BeginFrameArgs_BeginFrameArgsType type() const;
  inline void set_type(::cc::proto::BeginFrameArgs_BeginFrameArgsType value);

  // optional bool on_critical_path = 5;
  inline bool has_on_critical_path() const;
  inline void clear_on_critical_path();
  static const int kOnCriticalPathFieldNumber = 5;
  inline bool on_critical_path() const;
  inline void set_on_critical_path(bool value);
...
class CC_PROTO_EXPORT BeginMainFrameAndCommitState : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(BeginMainFrameAndCommitState* other);

  // implements Message ----------------------------------------------

  BeginMainFrameAndCommitState* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
  ...
  inline bool has_begin_frame_id() const;
  inline void clear_begin_frame_id();
  static const int kBeginFrameIdFieldNumber = 1;
  inline ::google::protobuf::int64 begin_frame_id() const;
  inline void set_begin_frame_id(::google::protobuf::int64 value);

  // optional .cc.proto.BeginFrameArgs begin_frame_args = 2;
  inline bool has_begin_frame_args() const;
  inline void clear_begin_frame_args();
  static const int kBeginFrameArgsFieldNumber = 2;
  inline const ::cc::proto::BeginFrameArgs& begin_frame_args() const;
  inline ::cc::proto::BeginFrameArgs* mutable_begin_frame_args();
  inline ::cc::proto::BeginFrameArgs* release_begin_frame_args();
  inline void set_allocated_begin_frame_args(::cc::proto::BeginFrameArgs* begin_frame_args);

  // optional .cc.proto.ScrollAndScaleSet scroll_info = 3;
  inline bool has_scroll_info() const;
  inline void clear_scroll_info();
  static const int kScrollInfoFieldNumber = 3;
  inline const ::cc::proto::ScrollAndScaleSet& scroll_info() const;
  inline ::cc::proto::ScrollAndScaleSet* mutable_scroll_info();
  inline ::cc::proto::ScrollAndScaleSet* release_scroll_info();
  inline void set_allocated_scroll_info(::cc::proto::ScrollAndScaleSet* scroll_info);

  // optional int64 memory_allocation_limit_bytes = 4;
  inline bool has_memory_allocation_limit_bytes() const;
  inline void clear_memory_allocation_limit_bytes();
  static const int kMemoryAllocationLimitBytesFieldNumber = 4;
  inline ::google::protobuf::int64 memory_allocation_limit_bytes() const;
  inline void set_memory_allocation_limit_bytes(::google::protobuf::int64 value);

  // optional bool evicted_ui_resources = 5;
  inline bool has_evicted_ui_resources() const;
  inline void clear_evicted_ui_resources();
  static const int kEvictedUiResourcesFieldNumber = 5;
  inline bool evicted_ui_resources() const;
  inline void set_evicted_ui_resources(bool value);
...
inline ::cc::proto::Vector2d* ScrollUpdateInfo::mutable_scroll_delta() {
  ...
  if (scroll_delta_ == NULL) scroll_delta_ = new ::cc::proto::Vector2d;
...
inline ::cc::proto::Vector2dF* ScrollAndScaleSet::mutable_elastic_overscroll_delta() {
  ...
  if (elastic_overscroll_delta_ == NULL) elastic_overscroll_delta_ = new ::cc::proto::Vector2dF;
...
inline ::cc::proto::BeginFrameArgs* BeginMainFrameAndCommitState::mutable_begin_frame_args() {
  ...
  if (begin_frame_args_ == NULL) begin_frame_args_ = new ::cc::proto::BeginFrameArgs;
...
inline ::cc::proto::ScrollAndScaleSet* BeginMainFrameAndCommitState::mutable_scroll_info() {
  set_has_scroll_info();
  if (scroll_info_ == NULL) scroll_info_ = new ::cc::proto::ScrollAndScaleSet;
  return scroll_info_;
}
