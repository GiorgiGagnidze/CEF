...
class CC_PROTO_EXPORT CompositorMessage : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(CompositorMessage* other);

  // implements Message ----------------------------------------------

  CompositorMessage* New() const;
  ...
  inline bool has_to_main() const;
  inline void clear_to_main();
  static const int kToMainFieldNumber = 1;
  inline const ::cc::proto::CompositorMessageToMain& to_main() const;
  inline ::cc::proto::CompositorMessageToMain* mutable_to_main();
  inline ::cc::proto::CompositorMessageToMain* release_to_main();
  inline void set_allocated_to_main(::cc::proto::CompositorMessageToMain* to_main);

  // optional .cc.proto.CompositorMessageToImpl to_impl = 2;
  inline bool has_to_impl() const;
  inline void clear_to_impl();
  static const int kToImplFieldNumber = 2;
  inline const ::cc::proto::CompositorMessageToImpl& to_impl() const;
  inline ::cc::proto::CompositorMessageToImpl* mutable_to_impl();
  inline ::cc::proto::CompositorMessageToImpl* release_to_impl();
  inline void set_allocated_to_impl(::cc::proto::CompositorMessageToImpl* to_impl);
...
inline ::cc::proto::CompositorMessageToMain* CompositorMessage::mutable_to_main() {
  set_has_to_main();
  if (to_main_ == NULL) to_main_ = new ::cc::proto::CompositorMessageToMain;
  return to_main_;
}
...
inline ::cc::proto::CompositorMessageToImpl* CompositorMessage::mutable_to_impl() {
  set_has_to_impl();
  if (to_impl_ == NULL) to_impl_ = new ::cc::proto::CompositorMessageToImpl;
  return to_impl_;
}
