...
void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_2eproto();
...
SYNC_PROTO_EXPORT bool GarbageCollectionDirective_Type_IsValid(int value);
...
SYNC_PROTO_EXPORT bool ClientToServerMessage_Contents_IsValid(int value);
...
SYNC_PROTO_EXPORT bool CommitResponse_ResponseType_IsValid(int value);
...
class SYNC_PROTO_EXPORT ProfilingData : public ::google::protobuf::MessageLite {
 public:
  ProfilingData();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT EntitySpecifics : public ::google::protobuf::MessageLite {
 public:
  EntitySpecifics();
  ...
  inline bool has_managed_user_whitelist() const;
  inline void clear_managed_user_whitelist();
  static const int kManagedUserWhitelistFieldNumber = 306060;
  inline const ::sync_pb::ManagedUserWhitelistSpecifics& managed_user_whitelist() const;
  inline ::sync_pb::ManagedUserWhitelistSpecifics* mutable_managed_user_whitelist();
  inline ::sync_pb::ManagedUserWhitelistSpecifics* release_managed_user_whitelist();
  inline void set_allocated_managed_user_whitelist(::sync_pb::ManagedUserWhitelistSpecifics* managed_user_whitelist);
  ...
  inline bool has_wifi_credential() const;
  inline void clear_wifi_credential();
  static const int kWifiCredentialFieldNumber = 218175;
  inline const ::sync_pb::WifiCredentialSpecifics& wifi_credential() const;
  inline ::sync_pb::WifiCredentialSpecifics* mutable_wifi_credential();
  inline ::sync_pb::WifiCredentialSpecifics* release_wifi_credential();
  inline void set_allocated_wifi_credential(::sync_pb::WifiCredentialSpecifics* wifi_credential);

  // optional .sync_pb.AutofillWalletSpecifics autofill_wallet = 306270;
  inline bool has_autofill_wallet() const;
  inline void clear_autofill_wallet();
  static const int kAutofillWalletFieldNumber = 306270;
  inline const ::sync_pb::AutofillWalletSpecifics& autofill_wallet() const;
  inline ::sync_pb::AutofillWalletSpecifics* mutable_autofill_wallet();
  inline ::sync_pb::AutofillWalletSpecifics* release_autofill_wallet();
  inline void set_allocated_autofill_wallet(::sync_pb::AutofillWalletSpecifics* autofill_wallet);

  // optional .sync_pb.WalletMetadataSpecifics wallet_metadata = 330441;
  inline bool has_wallet_metadata() const;
  inline void clear_wallet_metadata();
  static const int kWalletMetadataFieldNumber = 330441;
  inline const ::sync_pb::WalletMetadataSpecifics& wallet_metadata() const;
  inline ::sync_pb::WalletMetadataSpecifics* mutable_wallet_metadata();
  inline ::sync_pb::WalletMetadataSpecifics* release_wallet_metadata();
  inline void set_allocated_wallet_metadata(::sync_pb::WalletMetadataSpecifics* wallet_metadata);
...
class SYNC_PROTO_EXPORT SyncEntity_BookmarkData : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT SyncEntity : public ::google::protobuf::MessageLite {
 public:
  SyncEntity();
  virtual ~SyncEntity();
  ...
  inline int attachment_id_size() const;
  inline void clear_attachment_id();
  static const int kAttachmentIdFieldNumber = 26;
  inline const ::sync_pb::AttachmentIdProto& attachment_id(int index) const;
  inline ::sync_pb::AttachmentIdProto* mutable_attachment_id(int index);
  inline ::sync_pb::AttachmentIdProto* add_attachment_id();
...
class SYNC_PROTO_EXPORT ChromiumExtensionsActivity : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT ClientConfigParams : public ::google::protobuf::MessageLite {
 public:
  ClientConfigParams();
...
class SYNC_PROTO_EXPORT CommitMessage : public ::google::protobuf::MessageLite {
 public:
  CommitMessage();
  ...
  inline int client_contexts_size() const;
  inline void clear_client_contexts();
  static const int kClientContextsFieldNumber = 5;
  inline const ::sync_pb::DataTypeContext& client_contexts(int index) const;
  inline ::sync_pb::DataTypeContext* mutable_client_contexts(int index);
  inline ::sync_pb::DataTypeContext* add_client_contexts();
...
class SYNC_PROTO_EXPORT GetUpdateTriggers : public ::google::protobuf::MessageLite {
 public:
  GetUpdateTriggers();
  ...
  inline bool has_initial_sync_in_progress() const;
  inline void clear_initial_sync_in_progress();
  static const int kInitialSyncInProgressFieldNumber = 7;
  inline bool initial_sync_in_progress() const;
  inline void set_initial_sync_in_progress(bool value);

  // optional bool sync_for_resolve_conflict_in_progress = 8;
  inline bool has_sync_for_resolve_conflict_in_progress() const;
  inline void clear_sync_for_resolve_conflict_in_progress();
  static const int kSyncForResolveConflictInProgressFieldNumber = 8;
  inline bool sync_for_resolve_conflict_in_progress() const;
  inline void set_sync_for_resolve_conflict_in_progress(bool value);
...
class SYNC_PROTO_EXPORT GarbageCollectionDirective : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT DataTypeProgressMarker : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT GetUpdatesMessage : public ::google::protobuf::MessageLite {
 public:
  GetUpdatesMessage();
...
class SYNC_PROTO_EXPORT AuthenticateMessage : public ::google::protobuf::MessageLite {
 public:
  AuthenticateMessage();
...
class SYNC_PROTO_EXPORT ClearServerDataMessage : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(ClearServerDataMessage* other);

  // implements Message ----------------------------------------------

  ClearServerDataMessage* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT ClearServerDataResponse : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(ClearServerDataResponse* other);

  // implements Message ----------------------------------------------

  ClearServerDataResponse* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT DeprecatedMessage1 : public ::google::protobuf::MessageLite {
 public:
  DeprecatedMessage1();
  ...
  void Swap(DeprecatedMessage1* other);

  // implements Message ----------------------------------------------

  DeprecatedMessage1* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT DeprecatedMessage2 : public ::google::protobuf::MessageLite {
 public:
  DeprecatedMessage2();
  ...
  void Swap(DeprecatedMessage2* other);

  // implements Message ----------------------------------------------

  DeprecatedMessage2* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT ChipBag : public ::google::protobuf::MessageLite {
 public:
  ChipBag();
  virtual ~ChipBag();
...
class SYNC_PROTO_EXPORT ClientStatus : public ::google::protobuf::MessageLite {
 public:
  ClientStatus();
...
class SYNC_PROTO_EXPORT DataTypeContext : public ::google::protobuf::MessageLite {
 public:
  DataTypeContext();
  ...
  void Swap(DataTypeContext* other);

  // implements Message ----------------------------------------------

  DataTypeContext* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT ClientToServerMessage : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_deprecated_field_9() const PROTOBUF_DEPRECATED;
  inline void clear_deprecated_field_9() PROTOBUF_DEPRECATED;
  static const int kDeprecatedField9FieldNumber = 9;
  inline const ::sync_pb::DeprecatedMessage1& deprecated_field_9() const PROTOBUF_DEPRECATED;
  inline ::sync_pb::DeprecatedMessage1* mutable_deprecated_field_9() PROTOBUF_DEPRECATED;
  inline ::sync_pb::DeprecatedMessage1* release_deprecated_field_9() PROTOBUF_DEPRECATED;
  inline void set_allocated_deprecated_field_9(::sync_pb::DeprecatedMessage1* deprecated_field_9) PROTOBUF_DEPRECATED;
  ...
  inline bool has_clear_server_data() const;
  inline void clear_clear_server_data();
  static const int kClearServerDataFieldNumber = 15;
  inline const ::sync_pb::ClearServerDataMessage& clear_server_data() const;
  inline ::sync_pb::ClearServerDataMessage* mutable_clear_server_data();
  inline ::sync_pb::ClearServerDataMessage* release_clear_server_data();
  inline void set_allocated_clear_server_data(::sync_pb::ClearServerDataMessage* clear_server_data);
...
class SYNC_PROTO_EXPORT GetCrashInfoRequest : public ::google::protobuf::MessageLite {
 public:
  GetCrashInfoRequest();
...
class SYNC_PROTO_EXPORT GetCrashInfoResponse : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT CommitResponse_EntryResponse : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT CommitResponse : public ::google::protobuf::MessageLite {
 public:
  CommitResponse();
...
class SYNC_PROTO_EXPORT GetUpdatesResponse : public ::google::protobuf::MessageLite {
 public:
  GetUpdatesResponse();
  ...
  inline int context_mutations_size() const;
  inline void clear_context_mutations();
  static const int kContextMutationsFieldNumber = 7;
  inline const ::sync_pb::DataTypeContext& context_mutations(int index) const;
  inline ::sync_pb::DataTypeContext* mutable_context_mutations(int index);
  inline ::sync_pb::DataTypeContext* add_context_mutations();
  inline const ::google::protobuf::RepeatedPtrField< ::sync_pb::DataTypeContext >&
...
class SYNC_PROTO_EXPORT GetUpdatesMetadataResponse : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT GetUpdatesStreamingResponse : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT UserIdentification : public ::google::protobuf::MessageLite {
 public:
  UserIdentification();
...
class SYNC_PROTO_EXPORT AuthenticateResponse : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT ThrottleParameters : public ::google::protobuf::MessageLite {
 public:
  ThrottleParameters();
...
class SYNC_PROTO_EXPORT ClientToServerResponse_Error : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT ClientToServerResponse : public ::google::protobuf::MessageLite {
 public:
  ...
  inline void clear_deprecated_field_9() PROTOBUF_DEPRECATED;
  static const int kDeprecatedField9FieldNumber = 9;
  inline const ::sync_pb::DeprecatedMessage2& deprecated_field_9() const PROTOBUF_DEPRECATED;
  inline ::sync_pb::DeprecatedMessage2* mutable_deprecated_field_9() PROTOBUF_DEPRECATED;
  inline ::sync_pb::DeprecatedMessage2* release_deprecated_field_9() PROTOBUF_DEPRECATED;
  inline void set_allocated_deprecated_field_9(::sync_pb::DeprecatedMessage2* deprecated_field_9) PROTOBUF_DEPRECATED;
  ...
  inline void clear_clear_server_data();
  static const int kClearServerDataFieldNumber = 15;
  inline const ::sync_pb::ClearServerDataResponse& clear_server_data() const;
  inline ::sync_pb::ClearServerDataResponse* mutable_clear_server_data();
  inline ::sync_pb::ClearServerDataResponse* release_clear_server_data();
  inline void set_allocated_clear_server_data(::sync_pb::ClearServerDataResponse* clear_server_data);
...
class SYNC_PROTO_EXPORT EventRequest : public ::google::protobuf::MessageLite {
 public:
  EventRequest();
  ...
  inline bool has_sync_disabled() const;
  inline void clear_sync_disabled();
  static const int kSyncDisabledFieldNumber = 1;
  inline const ::sync_pb::SyncDisabledEvent& sync_disabled() const;
  inline ::sync_pb::SyncDisabledEvent* mutable_sync_disabled();
  inline ::sync_pb::SyncDisabledEvent* release_sync_disabled();
  inline void set_allocated_sync_disabled(::sync_pb::SyncDisabledEvent* sync_disabled);
...
class SYNC_PROTO_EXPORT EventResponse : public ::google::protobuf::MessageLite {
 public:
  EventResponse();
...
class SYNC_PROTO_EXPORT SyncDisabledEvent : public ::google::protobuf::MessageLite {
 public:
  SyncDisabledEvent();
  ...
  void Swap(SyncDisabledEvent* other);

  // implements Message ----------------------------------------------

  SyncDisabledEvent* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
inline ::sync_pb::ManagedUserWhitelistSpecifics* EntitySpecifics::mutable_managed_user_whitelist() {
  ...
  if (managed_user_whitelist_ == NULL) managed_user_whitelist_ = new ::sync_pb::ManagedUserWhitelistSpecifics;
...
inline ::sync_pb::WifiCredentialSpecifics* EntitySpecifics::mutable_wifi_credential() {
  ...
  if (wifi_credential_ == NULL) wifi_credential_ = new ::sync_pb::WifiCredentialSpecifics;
...
inline ::sync_pb::AutofillWalletSpecifics* EntitySpecifics::mutable_autofill_wallet() {
  ...
  if (autofill_wallet_ == NULL) autofill_wallet_ = new ::sync_pb::AutofillWalletSpecifics;
...
inline ::sync_pb::WalletMetadataSpecifics* EntitySpecifics::mutable_wallet_metadata() {
  ...
  if (wallet_metadata_ == NULL) wallet_metadata_ = new ::sync_pb::WalletMetadataSpecifics;
...
inline void DataTypeContext::clear_context() {
  if (context_ != &::google::protobuf::internal::GetEmptyString()) {
    context_->clear();
  }
  clear_has_context();
}
...
inline ::std::string* DataTypeContext::release_context() {
  ...
  if (context_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    context_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
...
inline ::sync_pb::DeprecatedMessage1* ClientToServerMessage::mutable_deprecated_field_9() {
  ...
  if (deprecated_field_9_ == NULL) deprecated_field_9_ = new ::sync_pb::DeprecatedMessage1;
...
inline ::sync_pb::ClearServerDataMessage* ClientToServerMessage::mutable_clear_server_data() {
  ...
  if (clear_server_data_ == NULL) clear_server_data_ = new ::sync_pb::ClearServerDataMessage;
...
inline ::sync_pb::DeprecatedMessage2* ClientToServerResponse::mutable_deprecated_field_9() {
  set_has_deprecated_field_9();
  if (deprecated_field_9_ == NULL) deprecated_field_9_ = new ::sync_pb::DeprecatedMessage2;
  return deprecated_field_9_;
}
...
inline ::sync_pb::ClearServerDataResponse* ClientToServerResponse::mutable_clear_server_data() {
  set_has_clear_server_data();
  if (clear_server_data_ == NULL) clear_server_data_ = new ::sync_pb::ClearServerDataResponse;
  return clear_server_data_;
}
...
inline ::sync_pb::SyncDisabledEvent* EventRequest::mutable_sync_disabled() {
  ...
  if (sync_disabled_ == NULL) sync_disabled_ = new ::sync_pb::SyncDisabledEvent;
