...
void SYNC_PROTO_EXPORT protobuf_AddDesc_dictionary_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT DictionarySpecifics : public ::google::protobuf::MessageLite {
 public:
  DictionarySpecifics();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_dictionary_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_dictionary_5fspecifics_2eproto();
  #endif
