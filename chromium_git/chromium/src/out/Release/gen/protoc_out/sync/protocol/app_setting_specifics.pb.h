...
void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fsetting_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT AppSettingSpecifics : public ::google::protobuf::MessageLite {
 public:
  AppSettingSpecifics();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fsetting_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fsetting_5fspecifics_2eproto();
  #endif
