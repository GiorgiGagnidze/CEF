...
void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5flist_5fspecifics_2eproto();
...
SYNC_PROTO_EXPORT bool AppListSpecifics_AppListItemType_IsValid(int value);
...
class SYNC_PROTO_EXPORT AppListSpecifics : public ::google::protobuf::MessageLite {
 public:
  AppListSpecifics();
  ...
  inline bool has_obsolete_page_ordinal() const PROTOBUF_DEPRECATED;
  inline void clear_obsolete_page_ordinal() PROTOBUF_DEPRECATED;
  static const int kOBSOLETEPageOrdinalFieldNumber = 5;
  inline const ::std::string& obsolete_page_ordinal() const PROTOBUF_DEPRECATED;
  inline void set_obsolete_page_ordinal(const ::std::string& value) PROTOBUF_DEPRECATED;
  inline void set_obsolete_page_ordinal(const char* value) PROTOBUF_DEPRECATED;
  inline void set_obsolete_page_ordinal(const char* value, size_t size) PROTOBUF_DEPRECATED;
  inline ::std::string* mutable_obsolete_page_ordinal() PROTOBUF_DEPRECATED;
  inline ::std::string* release_obsolete_page_ordinal() PROTOBUF_DEPRECATED;
  inline void set_allocated_obsolete_page_ordinal(::std::string* obsolete_page_ordinal) PROTOBUF_DEPRECATED;
 ...
 private:
  ...
  ::std::string* obsolete_page_ordinal_;
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5flist_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5flist_5fspecifics_2eproto();
  #endif
...
inline void AppListSpecifics::set_obsolete_page_ordinal(const char* value, size_t size) {
  ...
  obsolete_page_ordinal_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* AppListSpecifics::release_obsolete_page_ordinal() {
  ...
  if (obsolete_page_ordinal_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    ::std::string* temp = obsolete_page_ordinal_;
    obsolete_page_ordinal_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
inline void AppListSpecifics::set_allocated_obsolete_page_ordinal(::std::string* obsolete_page_ordinal) {
  if (obsolete_page_ordinal_ != &::google::protobuf::internal::GetEmptyString()) {
    delete obsolete_page_ordinal_;
  }
  if (obsolete_page_ordinal) {
    set_has_obsolete_page_ordinal();
    obsolete_page_ordinal_ = obsolete_page_ordinal;
  } else {
    clear_has_obsolete_page_ordinal();
    obsolete_page_ordinal_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  }
