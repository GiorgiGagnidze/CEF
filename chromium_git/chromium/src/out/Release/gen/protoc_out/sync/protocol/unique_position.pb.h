...
void SYNC_PROTO_EXPORT protobuf_AddDesc_unique_5fposition_2eproto();
...
class SYNC_PROTO_EXPORT UniquePosition : public ::google::protobuf::MessageLite {
 public:
  UniquePosition();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_unique_5fposition_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_unique_5fposition_2eproto();
  #endif
