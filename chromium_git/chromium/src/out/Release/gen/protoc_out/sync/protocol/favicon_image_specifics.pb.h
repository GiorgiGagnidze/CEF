...
void SYNC_PROTO_EXPORT protobuf_AddDesc_favicon_5fimage_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT FaviconData : public ::google::protobuf::MessageLite {
 public:
  FaviconData();
  virtual ~FaviconData();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_favicon_5fimage_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_favicon_5fimage_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT FaviconImageSpecifics : public ::google::protobuf::MessageLite {
 public:
