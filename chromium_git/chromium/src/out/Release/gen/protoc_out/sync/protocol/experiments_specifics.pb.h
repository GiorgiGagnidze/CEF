...
void SYNC_PROTO_EXPORT protobuf_AddDesc_experiments_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT KeystoreEncryptionFlags : public ::google::protobuf::MessageLite {
 public:
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_experiments_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_experiments_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT HistoryDeleteDirectives : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT AutofillCullingFlags : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT FaviconSyncFlags : public ::google::protobuf::MessageLite {
 public:
  FaviconSyncFlags();
...
class SYNC_PROTO_EXPORT PreCommitUpdateAvoidanceFlags : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT GcmChannelFlags : public ::google::protobuf::MessageLite {
 public:
  GcmChannelFlags();
...
class SYNC_PROTO_EXPORT EnhancedBookmarksFlags : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT GcmInvalidationsFlags : public ::google::protobuf::MessageLite {
 public:
...
class SYNC_PROTO_EXPORT WalletSyncFlags : public ::google::protobuf::MessageLite {
 public:
  WalletSyncFlags();
  ...
  void Swap(WalletSyncFlags* other);

  // implements Message ----------------------------------------------

  WalletSyncFlags* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT ExperimentsSpecifics : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_obsolete_enhanced_bookmarks() const;
  inline void clear_obsolete_enhanced_bookmarks();
  static const int kObsoleteEnhancedBookmarksFieldNumber = 7;
  inline const ::sync_pb::EnhancedBookmarksFlags& obsolete_enhanced_bookmarks() const;
  inline ::sync_pb::EnhancedBookmarksFlags* mutable_obsolete_enhanced_bookmarks();
  inline ::sync_pb::EnhancedBookmarksFlags* release_obsolete_enhanced_bookmarks();
  inline void set_allocated_obsolete_enhanced_bookmarks(::sync_pb::EnhancedBookmarksFlags* obsolete_enhanced_bookmarks);
  ...
  // optional .sync_pb.WalletSyncFlags wallet_sync = 9;
  inline bool has_wallet_sync() const;
  inline void clear_wallet_sync();
  static const int kWalletSyncFieldNumber = 9;
  inline const ::sync_pb::WalletSyncFlags& wallet_sync() const;
  inline ::sync_pb::WalletSyncFlags* mutable_wallet_sync();
  inline ::sync_pb::WalletSyncFlags* release_wallet_sync();
  inline void set_allocated_wallet_sync(::sync_pb::WalletSyncFlags* wallet_sync);
 ...
 private:
  ...
  inline void set_has_wallet_sync();
  inline void clear_has_wallet_sync();
  ...
  ::sync_pb::WalletSyncFlags* wallet_sync_;
...
inline ::sync_pb::EnhancedBookmarksFlags* ExperimentsSpecifics::mutable_obsolete_enhanced_bookmarks() {
  ...
  if (obsolete_enhanced_bookmarks_ == NULL) obsolete_enhanced_bookmarks_ = new ::sync_pb::EnhancedBookmarksFlags;
...
// optional .sync_pb.WalletSyncFlags wallet_sync = 9;
inline bool ExperimentsSpecifics::has_wallet_sync() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ExperimentsSpecifics::set_has_wallet_sync() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ExperimentsSpecifics::clear_has_wallet_sync() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ExperimentsSpecifics::clear_wallet_sync() {
  if (wallet_sync_ != NULL) wallet_sync_->::sync_pb::WalletSyncFlags::Clear();
  clear_has_wallet_sync();
}
inline const ::sync_pb::WalletSyncFlags& ExperimentsSpecifics::wallet_sync() const {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return wallet_sync_ != NULL ? *wallet_sync_ : *default_instance().wallet_sync_;
#else
  return wallet_sync_ != NULL ? *wallet_sync_ : *default_instance_->wallet_sync_;
#endif
}
inline ::sync_pb::WalletSyncFlags* ExperimentsSpecifics::mutable_wallet_sync() {
  set_has_wallet_sync();
  if (wallet_sync_ == NULL) wallet_sync_ = new ::sync_pb::WalletSyncFlags;
  return wallet_sync_;
}
inline ::sync_pb::WalletSyncFlags* ExperimentsSpecifics::release_wallet_sync() {
  clear_has_wallet_sync();
  ::sync_pb::WalletSyncFlags* temp = wallet_sync_;
  wallet_sync_ = NULL;
  return temp;
}
inline void ExperimentsSpecifics::set_allocated_wallet_sync(::sync_pb::WalletSyncFlags* wallet_sync) {
  delete wallet_sync_;
  wallet_sync_ = wallet_sync;
  if (wallet_sync) {
    set_has_wallet_sync();
  } else {
    clear_has_wallet_sync();
