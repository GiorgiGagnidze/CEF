...
void SYNC_PROTO_EXPORT protobuf_AddDesc_password_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT PasswordSpecificsData : public ::google::protobuf::MessageLite {
 public:
  ...
  inline bool has_times_used() const;
  inline void clear_times_used();
  static const int kTimesUsedFieldNumber = 14;
  inline ::google::protobuf::int32 times_used() const;
  inline void set_times_used(::google::protobuf::int32 value);
  ...
  inline bool has_federation_url() const;
  inline void clear_federation_url();
  static const int kFederationUrlFieldNumber = 17;
  inline const ::std::string& federation_url() const;
  inline void set_federation_url(const ::std::string& value);
  inline void set_federation_url(const char* value);
  inline void set_federation_url(const char* value, size_t size);
  inline ::std::string* mutable_federation_url();
  inline ::std::string* release_federation_url();
  inline void set_allocated_federation_url(::std::string* federation_url);
 ...
 private:
  ...
  ::std::string* federation_url_;

  mutable int _cached_size_;
  ::google::protobuf::uint32 _has_bits_[(17 + 31) / 32];

  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_password_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_password_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT PasswordSpecifics : public ::google::protobuf::MessageLite {
 public:
  PasswordSpecifics();
...
inline void PasswordSpecificsData::clear_avatar_url() {
  if (avatar_url_ != &::google::protobuf::internal::GetEmptyString()) {
    avatar_url_->clear();
  }
...
inline ::std::string* PasswordSpecificsData::release_avatar_url() {
  ...
  if (avatar_url_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    avatar_url_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
...
inline void PasswordSpecificsData::set_federation_url(const char* value, size_t size) {
  ...
  federation_url_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* PasswordSpecificsData::release_federation_url() {
  ...
  if (federation_url_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    ::std::string* temp = federation_url_;
    federation_url_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
    return temp;
  }
}
inline void PasswordSpecificsData::set_allocated_federation_url(::std::string* federation_url) {
  if (federation_url_ != &::google::protobuf::internal::GetEmptyString()) {
    delete federation_url_;
  }
  if (federation_url) {
    set_has_federation_url();
    federation_url_ = federation_url;
  } else {
    clear_has_federation_url();
    federation_url_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  }
