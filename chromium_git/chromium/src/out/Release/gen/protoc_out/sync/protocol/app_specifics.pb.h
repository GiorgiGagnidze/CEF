...
void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fspecifics_2eproto();
...
SYNC_PROTO_EXPORT bool AppSpecifics_LaunchType_IsValid(int value);
...
class SYNC_PROTO_EXPORT AppNotificationSettings : public ::google::protobuf::MessageLite {
 public:
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT LinkedAppIconInfo : public ::google::protobuf::MessageLite {
 public:
  LinkedAppIconInfo();
  ...
  void Swap(LinkedAppIconInfo* other);

  // implements Message ----------------------------------------------

  LinkedAppIconInfo* New() const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class SYNC_PROTO_EXPORT AppSpecifics : public ::google::protobuf::MessageLite {
 public:
  AppSpecifics();
  ...
  inline bool has_bookmark_app_url() const;
  inline void clear_bookmark_app_url();
  static const int kBookmarkAppUrlFieldNumber = 6;
  inline const ::std::string& bookmark_app_url() const;
  inline void set_bookmark_app_url(const ::std::string& value);
  inline void set_bookmark_app_url(const char* value);
  inline void set_bookmark_app_url(const char* value, size_t size);
  inline ::std::string* mutable_bookmark_app_url();
  inline ::std::string* release_bookmark_app_url();
  inline void set_allocated_bookmark_app_url(::std::string* bookmark_app_url);

  // optional string bookmark_app_description = 7;
  inline bool has_bookmark_app_description() const;
  inline void clear_bookmark_app_description();
  static const int kBookmarkAppDescriptionFieldNumber = 7;
  inline const ::std::string& bookmark_app_description() const;
  inline void set_bookmark_app_description(const ::std::string& value);
  inline void set_bookmark_app_description(const char* value);
  inline void set_bookmark_app_description(const char* value, size_t size);
  inline ::std::string* mutable_bookmark_app_description();
  inline ::std::string* release_bookmark_app_description();
  inline void set_allocated_bookmark_app_description(::std::string* bookmark_app_description);

  // optional string bookmark_app_icon_color = 8;
  inline bool has_bookmark_app_icon_color() const;
  inline void clear_bookmark_app_icon_color();
  static const int kBookmarkAppIconColorFieldNumber = 8;
  inline const ::std::string& bookmark_app_icon_color() const;
  inline void set_bookmark_app_icon_color(const ::std::string& value);
  inline void set_bookmark_app_icon_color(const char* value);
  inline void set_bookmark_app_icon_color(const char* value, size_t size);
  inline ::std::string* mutable_bookmark_app_icon_color();
  inline ::std::string* release_bookmark_app_icon_color();
  inline void set_allocated_bookmark_app_icon_color(::std::string* bookmark_app_icon_color);

  // repeated .sync_pb.LinkedAppIconInfo linked_app_icons = 9;
  inline int linked_app_icons_size() const;
  inline void clear_linked_app_icons();
  static const int kLinkedAppIconsFieldNumber = 9;
  inline const ::sync_pb::LinkedAppIconInfo& linked_app_icons(int index) const;
  inline ::sync_pb::LinkedAppIconInfo* mutable_linked_app_icons(int index);
  inline ::sync_pb::LinkedAppIconInfo* add_linked_app_icons();
...
inline void AppSpecifics::set_bookmark_app_url(const ::std::string& value) {
  ...
  if (bookmark_app_url_ == &::google::protobuf::internal::GetEmptyString()) {
    bookmark_app_url_ = new ::std::string;
  }
  bookmark_app_url_->assign(value);
}
...
inline void AppSpecifics::set_bookmark_app_url(const char* value, size_t size) {
  ...
  bookmark_app_url_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* AppSpecifics::release_bookmark_app_url() {
  ...
  if (bookmark_app_url_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    ::std::string* temp = bookmark_app_url_;
...
inline void AppSpecifics::set_allocated_bookmark_app_url(::std::string* bookmark_app_url) {
  ...
  if (bookmark_app_url) {
    set_has_bookmark_app_url();
    bookmark_app_url_ = bookmark_app_url;
  } else {
    clear_has_bookmark_app_url();
    bookmark_app_url_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  }
...
inline void AppSpecifics::set_bookmark_app_description(const ::std::string& value) {
  ...
  if (bookmark_app_description_ == &::google::protobuf::internal::GetEmptyString()) {
    bookmark_app_description_ = new ::std::string;
  }
  bookmark_app_description_->assign(value);
}
...
inline void AppSpecifics::set_bookmark_app_description(const char* value, size_t size) {
  ...
  bookmark_app_description_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* AppSpecifics::release_bookmark_app_description() {
  ...
  if (bookmark_app_description_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    ::std::string* temp = bookmark_app_description_;
...
inline void AppSpecifics::set_allocated_bookmark_app_description(::std::string* bookmark_app_description) {
  ...
  if (bookmark_app_description) {
    set_has_bookmark_app_description();
    bookmark_app_description_ = bookmark_app_description;
  } else {
    clear_has_bookmark_app_description();
    bookmark_app_description_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  }
...
inline void AppSpecifics::set_bookmark_app_icon_color(const ::std::string& value) {
  ...
  if (bookmark_app_icon_color_ == &::google::protobuf::internal::GetEmptyString()) {
    bookmark_app_icon_color_ = new ::std::string;
  }
  bookmark_app_icon_color_->assign(value);
}
...
inline void AppSpecifics::set_bookmark_app_icon_color(const char* value, size_t size) {
  ...
  bookmark_app_icon_color_->assign(reinterpret_cast<const char*>(value), size);
}
...
inline ::std::string* AppSpecifics::release_bookmark_app_icon_color() {
  ...
  if (bookmark_app_icon_color_ == &::google::protobuf::internal::GetEmptyString()) {
    ...
    ::std::string* temp = bookmark_app_icon_color_;
...
inline void AppSpecifics::set_allocated_bookmark_app_icon_color(::std::string* bookmark_app_icon_color) {
  ...
  if (bookmark_app_icon_color) {
    set_has_bookmark_app_icon_color();
    bookmark_app_icon_color_ = bookmark_app_icon_color;
  } else {
    clear_has_bookmark_app_icon_color();
    bookmark_app_icon_color_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyString());
  }
