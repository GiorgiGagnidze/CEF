...
define("mojo/services/network/public/interfaces/network_service.mojom", [
...
], function(bindings, codec, connection, core, validator, cookie_store$, http_server$, net_address$, network_error$, tcp_bound_socket$, tcp_connected_socket$, udp_socket$, web_socket$) {
  ...
  function NetworkService_GetMimeTypeFromFile_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkService_GetMimeTypeFromFile_Params.prototype.initDefaults_ = function() {
    this.file_path = null;
  };
  NetworkService_GetMimeTypeFromFile_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkService_GetMimeTypeFromFile_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, NetworkService_GetMimeTypeFromFile_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;

    
    // validate NetworkService_GetMimeTypeFromFile_Params.file_path
  ...
  NetworkService_GetMimeTypeFromFile_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkService_GetMimeTypeFromFile_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkService_GetMimeTypeFromFile_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.file_path = decoder.decodeStruct(codec.String);
    return val;
  };

  NetworkService_GetMimeTypeFromFile_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkService_GetMimeTypeFromFile_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.file_path);
  };
  function NetworkService_GetMimeTypeFromFile_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkService_GetMimeTypeFromFile_ResponseParams.prototype.initDefaults_ = function() {
    this.mime_type = null;
  };
  NetworkService_GetMimeTypeFromFile_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkService_GetMimeTypeFromFile_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, NetworkService_GetMimeTypeFromFile_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;

    
    // validate NetworkService_GetMimeTypeFromFile_ResponseParams.mime_type
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkService_GetMimeTypeFromFile_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;

  NetworkService_GetMimeTypeFromFile_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkService_GetMimeTypeFromFile_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  NetworkService_GetMimeTypeFromFile_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkService_GetMimeTypeFromFile_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.mime_type);
  };
  var kNetworkService_CreateTCPBoundSocket_Name = 0;
  var kNetworkService_CreateTCPConnectedSocket_Name = 1;
  var kNetworkService_CreateUDPSocket_Name = 2;
  var kNetworkService_CreateHttpServer_Name = 3;
  var kNetworkService_GetMimeTypeFromFile_Name = 4;
  ...
  NetworkServiceProxy.prototype.getMimeTypeFromFile = function(file_path) {
    var params = new NetworkService_GetMimeTypeFromFile_Params();
    params.file_path = file_path;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageWithRequestIDBuilder(
          kNetworkService_GetMimeTypeFromFile_Name,
          codec.align(NetworkService_GetMimeTypeFromFile_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkService_GetMimeTypeFromFile_Params, params);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkService_GetMimeTypeFromFile_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkServiceStub.prototype.getMimeTypeFromFile = function(file_path) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getMimeTypeFromFile && bindings.StubBindings(this).delegate.getMimeTypeFromFile(file_path);
  }
  ...
  NetworkServiceStub.prototype.acceptWithResponder =
    ...
    case kNetworkService_GetMimeTypeFromFile_Name:
      var params = reader.decodeStruct(NetworkService_GetMimeTypeFromFile_Params);
      return this.getMimeTypeFromFile(params.file_path).then(function(response) {
        var responseParams =
            new NetworkService_GetMimeTypeFromFile_ResponseParams();
        responseParams.mime_type = response.mime_type;
        var builder = new codec.MessageWithRequestIDBuilder(
            kNetworkService_GetMimeTypeFromFile_Name,
            codec.align(NetworkService_GetMimeTypeFromFile_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkService_GetMimeTypeFromFile_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateNetworkServiceRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkService_GetMimeTypeFromFile_Name:
        if (message.expectsResponse())
          paramsClass = NetworkService_GetMimeTypeFromFile_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateNetworkServiceResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kNetworkService_GetMimeTypeFromFile_Name:
        if (message.isResponse())
          paramsClass = NetworkService_GetMimeTypeFromFile_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
