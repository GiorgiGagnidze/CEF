...
#include "out/Debug/gen/library_loaders/libpci.h"

#include <dlfcn.h>

// Put these sanity checks here so that they fire at most once
// (to avoid cluttering the build output).
#if !defined(LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DLOPEN) && !defined(LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DT_NEEDED)
#error neither LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DLOPEN nor LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DT_NEEDED defined
#endif
#if defined(LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DLOPEN) && defined(LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DT_NEEDED)
#error both LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DLOPEN and LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DT_NEEDED defined
#endif
...
#endif
#if defined(LIBRARY_LOADER_OUT_DEBUG_GEN_LIBRARY_LOADERS_LIBPCI_H_DT_NEEDED)
  pci_alloc = &::pci_alloc;
#endif
  if (!pci_alloc) {
    CleanUp(true);
