...
#endif
const WrapperTypeInfo V8Cache::wrapperTypeInfo = { gin::kEmbedderBlink, V8Cache::domTemplate, V8Cache::refObject, V8Cache::derefObject, V8Cache::trace, 0, 0, V8Cache::preparePrototypeAndInterfaceObject, V8Cache::installConditionallyEnabledProperties, "Cache", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8CacheTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::cacheStorageMatchAllEnabled()) {
        const V8DOMConfiguration::MethodConfiguration matchAllMethodConfiguration = {"matchAll", CacheV8Internal::matchAllMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
        V8DOMConfiguration::installMethod(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, matchAllMethodConfiguration);
    }
}
