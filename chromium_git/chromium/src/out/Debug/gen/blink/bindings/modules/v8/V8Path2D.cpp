...
#endif
const WrapperTypeInfo V8Path2D::wrapperTypeInfo = { gin::kEmbedderBlink, V8Path2D::domTemplate, V8Path2D::refObject, V8Path2D::derefObject, V8Path2D::trace, 0, 0, V8Path2D::preparePrototypeAndInterfaceObject, V8Path2D::installConditionallyEnabledProperties, "Path2D", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8Path2DTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
        ...
        V8DOMConfiguration::installMethod(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, addPathMethodConfiguration);
    }
}
