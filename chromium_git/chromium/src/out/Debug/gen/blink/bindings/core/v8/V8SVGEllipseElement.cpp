...
#endif
const WrapperTypeInfo V8SVGEllipseElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGEllipseElement::domTemplate, V8SVGEllipseElement::refObject, V8SVGEllipseElement::derefObject, V8SVGEllipseElement::trace, 0, 0, V8SVGEllipseElement::preparePrototypeAndInterfaceObject, V8SVGEllipseElement::installConditionallyEnabledProperties, "SVGEllipseElement", &V8SVGGeometryElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGEllipseElementAccessors[] = {
    {"cx", SVGEllipseElementV8Internal::cxAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"cy", SVGEllipseElementV8Internal::cyAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rx", SVGEllipseElementV8Internal::rxAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"ry", SVGEllipseElementV8Internal::ryAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGEllipseElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGEllipseElement", V8SVGGeometryElement::domTemplate(isolate), V8SVGEllipseElement::internalFieldCount,
        0, 0,
        V8SVGEllipseElementAccessors, WTF_ARRAY_LENGTH(V8SVGEllipseElementAccessors),
        0, 0);
