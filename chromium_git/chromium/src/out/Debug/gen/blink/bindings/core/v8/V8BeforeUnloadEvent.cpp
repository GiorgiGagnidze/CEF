...
#endif
const WrapperTypeInfo V8BeforeUnloadEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8BeforeUnloadEvent::domTemplate, V8BeforeUnloadEvent::refObject, V8BeforeUnloadEvent::derefObject, V8BeforeUnloadEvent::trace, 0, 0, V8BeforeUnloadEvent::preparePrototypeAndInterfaceObject, V8BeforeUnloadEvent::installConditionallyEnabledProperties, "BeforeUnloadEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8BeforeUnloadEventTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::trustedEventsEnabled()) {
        ...
        {"isTrusted", BeforeUnloadEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
