...
{
    VTTRegionList* impl = V8VTTRegionList::toImpl(info.Holder());
    RawPtr<VTTRegion> result = impl->item(index);
    if (!result)
        return;
...
const V8DOMConfiguration::AccessorConfiguration V8VTTRegionListAccessors[] = {
    {"length", VTTRegionListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
