...
#endif
const WrapperTypeInfo V8Int8Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Int8Array::refObject, V8Int8Array::derefObject, V8Int8Array::trace, 0, 0, V8Int8Array::preparePrototypeAndInterfaceObject, V8Int8Array::installConditionallyEnabledProperties, "Int8Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::RefCountedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
DOMInt8Array* V8Int8Array::toImpl(v8::Local<v8::Object> object)
{
    ...
    RefPtr<DOMInt8Array> typedArray;
