...
#endif
const WrapperTypeInfo V8CHROMIUMValuebuffer::wrapperTypeInfo = { gin::kEmbedderBlink, V8CHROMIUMValuebuffer::domTemplate, V8CHROMIUMValuebuffer::refObject, V8CHROMIUMValuebuffer::derefObject, V8CHROMIUMValuebuffer::trace, 0, 0, V8CHROMIUMValuebuffer::preparePrototypeAndInterfaceObject, V8CHROMIUMValuebuffer::installConditionallyEnabledProperties, "CHROMIUMValuebuffer", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
