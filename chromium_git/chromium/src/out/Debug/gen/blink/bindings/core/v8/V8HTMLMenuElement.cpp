...
#endif
const WrapperTypeInfo V8HTMLMenuElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLMenuElement::domTemplate, V8HTMLMenuElement::refObject, V8HTMLMenuElement::derefObject, V8HTMLMenuElement::trace, 0, 0, V8HTMLMenuElement::preparePrototypeAndInterfaceObject, V8HTMLMenuElement::installConditionallyEnabledProperties, "HTMLMenuElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8HTMLMenuElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::contextMenuEnabled()) {
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorlabelConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessortypeConfiguration);
    }
}
