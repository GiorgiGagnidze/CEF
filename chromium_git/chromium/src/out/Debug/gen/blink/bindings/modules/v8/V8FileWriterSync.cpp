...
#endif
const WrapperTypeInfo V8FileWriterSync::wrapperTypeInfo = { gin::kEmbedderBlink, V8FileWriterSync::domTemplate, V8FileWriterSync::refObject, V8FileWriterSync::derefObject, V8FileWriterSync::trace, 0, 0, V8FileWriterSync::preparePrototypeAndInterfaceObject, V8FileWriterSync::installConditionallyEnabledProperties, "FileWriterSync", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8FileWriterSyncAccessors[] = {
    {"position", FileWriterSyncV8Internal::positionAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"length", FileWriterSyncV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
