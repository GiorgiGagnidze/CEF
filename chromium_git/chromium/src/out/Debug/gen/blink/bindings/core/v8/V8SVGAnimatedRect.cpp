...
#endif
const WrapperTypeInfo V8SVGAnimatedRect::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedRect::domTemplate, V8SVGAnimatedRect::refObject, V8SVGAnimatedRect::derefObject, V8SVGAnimatedRect::trace, 0, V8SVGAnimatedRect::visitDOMWrapper, V8SVGAnimatedRect::preparePrototypeAndInterfaceObject, V8SVGAnimatedRect::installConditionallyEnabledProperties, "SVGAnimatedRect", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedRectAccessors[] = {
    {"baseVal", SVGAnimatedRectV8Internal::baseValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedRectV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
