...
const V8DOMConfiguration::AccessorConfiguration V8SVGMPathElementAccessors[] = {
    {"href", SVGMPathElementV8Internal::hrefAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGMPathElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (!RuntimeEnabledFeatures::smilEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGMPathElement", V8SVGElement::domTemplate(isolate), V8SVGMPathElement::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGMPathElement", V8SVGElement::domTemplate(isolate), V8SVGMPathElement::internalFieldCount,
            0, 0,
            V8SVGMPathElementAccessors, WTF_ARRAY_LENGTH(V8SVGMPathElementAccessors),
            0, 0);
