...
#endif
const WrapperTypeInfo V8Int16Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Int16Array::refObject, V8Int16Array::derefObject, V8Int16Array::trace, 0, 0, V8Int16Array::preparePrototypeAndInterfaceObject, V8Int16Array::installConditionallyEnabledProperties, "Int16Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::RefCountedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
DOMInt16Array* V8Int16Array::toImpl(v8::Local<v8::Object> object)
{
    ...
    RefPtr<DOMInt16Array> typedArray;
