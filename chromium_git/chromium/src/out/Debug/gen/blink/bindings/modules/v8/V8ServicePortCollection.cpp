...
#endif
const WrapperTypeInfo V8ServicePortCollection::wrapperTypeInfo = { gin::kEmbedderBlink, V8ServicePortCollection::domTemplate, V8ServicePortCollection::refObject, V8ServicePortCollection::derefObject, V8ServicePortCollection::trace, 0, 0, V8ServicePortCollection::preparePrototypeAndInterfaceObject, V8ServicePortCollection::installConditionallyEnabledProperties, "ServicePortCollection", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8ServicePortCollectionAccessors[] = {
    {"onmessage", ServicePortCollectionV8Internal::onmessageAttributeGetterCallback, ServicePortCollectionV8Internal::onmessageAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onclose", ServicePortCollectionV8Internal::oncloseAttributeGetterCallback, ServicePortCollectionV8Internal::oncloseAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8ServicePortCollectionMethods[] = {
    {"connect", ServicePortCollectionV8Internal::connectMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"match", ServicePortCollectionV8Internal::matchMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"matchAll", ServicePortCollectionV8Internal::matchAllMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
void V8ServicePortCollection::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    v8::Isolate* isolate = context->GetIsolate();
    ExecutionContext* executionContext = toExecutionContext(context);
    v8::Local<v8::Signature> signature = v8::Signature::New(isolate, interfaceTemplate);
    if (executionContext && (executionContext->isServiceWorkerGlobalScope())) {
        const V8DOMConfiguration::AccessorConfiguration accessorConfiguration = {"onconnect", ServicePortCollectionV8Internal::onconnectAttributeGetterCallback, ServicePortCollectionV8Internal::onconnectAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
