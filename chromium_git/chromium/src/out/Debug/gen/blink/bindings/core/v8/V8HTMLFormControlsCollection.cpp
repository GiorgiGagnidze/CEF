...
#endif
const WrapperTypeInfo V8HTMLFormControlsCollection::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLFormControlsCollection::domTemplate, V8HTMLFormControlsCollection::refObject, V8HTMLFormControlsCollection::derefObject, V8HTMLFormControlsCollection::trace, 0, V8HTMLFormControlsCollection::visitDOMWrapper, V8HTMLFormControlsCollection::preparePrototypeAndInterfaceObject, V8HTMLFormControlsCollection::installConditionallyEnabledProperties, "HTMLFormControlsCollection", &V8HTMLCollection::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
