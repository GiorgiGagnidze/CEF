...
void V8ArrayBufferOrArrayBufferViewOrBlobOrDocumentOrStringOrFormData::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ArrayBufferOrArrayBufferViewOrBlobOrDocumentOrStringOrFormData& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    ...
    if (V8FormData::hasInstance(v8Value, isolate)) {
        RawPtr<FormData> cppValue = V8FormData::toImpl(v8::Local<v8::Object>::Cast(v8Value));
...
void V8ArrayBufferOrArrayBufferViewOrBlobOrString::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ArrayBufferOrArrayBufferViewOrBlobOrString& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
...
ArrayBufferOrArrayBufferViewOrBlobOrString NativeValueTraits<ArrayBufferOrArrayBufferViewOrBlobOrString>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    ...
    V8ArrayBufferOrArrayBufferViewOrBlobOrString::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
...
void V8BlobOrStringOrArrayBufferViewOrArrayBuffer::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, BlobOrStringOrArrayBufferViewOrArrayBuffer& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
...
BlobOrStringOrArrayBufferViewOrArrayBuffer NativeValueTraits<BlobOrStringOrArrayBufferViewOrArrayBuffer>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    ...
    V8BlobOrStringOrArrayBufferViewOrArrayBuffer::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
...
EffectModelOrDictionarySequenceOrDictionary::EffectModelOrDictionarySequenceOrDictionary()
    : m_type(SpecificTypeNone)
{
}

EffectModel* EffectModelOrDictionarySequenceOrDictionary::getAsEffectModel() const
{
    ASSERT(isEffectModel());
    return m_effectModel;
}

void EffectModelOrDictionarySequenceOrDictionary::setEffectModel(EffectModel* value)
{
    ASSERT(isNull());
    m_effectModel = value;
...
EffectModelOrDictionarySequenceOrDictionary EffectModelOrDictionarySequenceOrDictionary::fromEffectModel(EffectModel* value)
{
    EffectModelOrDictionarySequenceOrDictionary container;
    container.setEffectModel(value);
    return container;
}

const Vector<Dictionary>& EffectModelOrDictionarySequenceOrDictionary::getAsDictionarySequence() const
{
    ASSERT(isDictionarySequence());
    return m_dictionarySequence;
}

void EffectModelOrDictionarySequenceOrDictionary::setDictionarySequence(const Vector<Dictionary>& value)
{
    ASSERT(isNull());
...
EffectModelOrDictionarySequenceOrDictionary EffectModelOrDictionarySequenceOrDictionary::fromDictionarySequence(const Vector<Dictionary>& value)
{
    EffectModelOrDictionarySequenceOrDictionary container;
...
Dictionary EffectModelOrDictionarySequenceOrDictionary::getAsDictionary() const
{
    ASSERT(isDictionary());
    return m_dictionary;
}

void EffectModelOrDictionarySequenceOrDictionary::setDictionary(Dictionary value)
{
    ASSERT(isNull());
    m_dictionary = value;
...
EffectModelOrDictionarySequenceOrDictionary EffectModelOrDictionarySequenceOrDictionary::fromDictionary(Dictionary value)
{
    EffectModelOrDictionarySequenceOrDictionary container;
...
EffectModelOrDictionarySequenceOrDictionary::EffectModelOrDictionarySequenceOrDictionary(const EffectModelOrDictionarySequenceOrDictionary&) = default;
EffectModelOrDictionarySequenceOrDictionary::~EffectModelOrDictionarySequenceOrDictionary() = default;
EffectModelOrDictionarySequenceOrDictionary& EffectModelOrDictionarySequenceOrDictionary::operator=(const EffectModelOrDictionarySequenceOrDictionary&) = default;

DEFINE_TRACE(EffectModelOrDictionarySequenceOrDictionary)
{
    visitor->trace(m_effectModel);
}

void V8EffectModelOrDictionarySequenceOrDictionary::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, EffectModelOrDictionarySequenceOrDictionary& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
    ...
    if (V8EffectModel::hasInstance(v8Value, isolate)) {
        RawPtr<EffectModel> cppValue = V8EffectModel::toImpl(v8::Local<v8::Object>::Cast(v8Value));
    ...
    exceptionState.throwTypeError("The provided value is not of type '(EffectModel or sequence<Dictionary> or Dictionary)'");
}

v8::Local<v8::Value> toV8(const EffectModelOrDictionarySequenceOrDictionary& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    switch (impl.m_type) {
    case EffectModelOrDictionarySequenceOrDictionary::SpecificTypeNone:
        return v8::Null(isolate);
    case EffectModelOrDictionarySequenceOrDictionary::SpecificTypeEffectModel:
        return toV8(impl.getAsEffectModel(), creationContext, isolate);
    case EffectModelOrDictionarySequenceOrDictionary::SpecificTypeDictionarySequence:
        return toV8(impl.getAsDictionarySequence(), creationContext, isolate);
    case EffectModelOrDictionarySequenceOrDictionary::SpecificTypeDictionary:
...
EffectModelOrDictionarySequenceOrDictionary NativeValueTraits<EffectModelOrDictionarySequenceOrDictionary>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    EffectModelOrDictionarySequenceOrDictionary impl;
    V8EffectModelOrDictionarySequenceOrDictionary::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
...
PassRefPtrWillBeRawPtr<HTMLImageElement> HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::getAsHTMLImageElement() const
{
    ASSERT(isHTMLImageElement());
    return m_htmlImageElement;
}

void HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::setHTMLImageElement(PassRefPtrWillBeRawPtr<HTMLImageElement> value)
{
    ASSERT(isNull());
...
HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::fromHTMLImageElement(PassRefPtrWillBeRawPtr<HTMLImageElement> value)
{
...
PassRefPtrWillBeRawPtr<HTMLVideoElement> HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::getAsHTMLVideoElement() const
{
    ASSERT(isHTMLVideoElement());
    return m_htmlVideoElement;
}

void HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::setHTMLVideoElement(PassRefPtrWillBeRawPtr<HTMLVideoElement> value)
{
    ASSERT(isNull());
...
HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::fromHTMLVideoElement(PassRefPtrWillBeRawPtr<HTMLVideoElement> value)
{
    HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap container;
...
PassRefPtrWillBeRawPtr<HTMLCanvasElement> HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::getAsHTMLCanvasElement() const
{
    ASSERT(isHTMLCanvasElement());
    return m_htmlCanvasElement;
}

void HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::setHTMLCanvasElement(PassRefPtrWillBeRawPtr<HTMLCanvasElement> value)
{
    ASSERT(isNull());
...
HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::fromHTMLCanvasElement(PassRefPtrWillBeRawPtr<HTMLCanvasElement> value)
{
    HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap container;
...
PassRefPtrWillBeRawPtr<ImageBitmap> HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::getAsImageBitmap() const
{
    ASSERT(isImageBitmap());
    return m_imageBitmap;
}

void HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::setImageBitmap(PassRefPtrWillBeRawPtr<ImageBitmap> value)
{
    ASSERT(isNull());
    m_imageBitmap = value;
...
HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::fromImageBitmap(PassRefPtrWillBeRawPtr<ImageBitmap> value)
{
    HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap container;
...
void V8HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, HTMLImageElementOrHTMLVideoElementOrHTMLCanvasElementOrBlobOrImageDataOrImageBitmap& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    ...
    if (V8ImageData::hasInstance(v8Value, isolate)) {
        RawPtr<ImageData> cppValue = V8ImageData::toImpl(v8::Local<v8::Object>::Cast(v8Value));
...
StyleValueOrStyleValueSequence::StyleValueOrStyleValueSequence()
    : m_type(SpecificTypeNone)
{
}

StyleValue* StyleValueOrStyleValueSequence::getAsStyleValue() const
{
    ASSERT(isStyleValue());
    return m_styleValue;
}

void StyleValueOrStyleValueSequence::setStyleValue(StyleValue* value)
{
    ASSERT(isNull());
    m_styleValue = value;
    m_type = SpecificTypeStyleValue;
}

StyleValueOrStyleValueSequence StyleValueOrStyleValueSequence::fromStyleValue(StyleValue* value)
{
    StyleValueOrStyleValueSequence container;
    container.setStyleValue(value);
    return container;
}

const HeapVector<Member<StyleValue>>& StyleValueOrStyleValueSequence::getAsStyleValueSequence() const
{
    ASSERT(isStyleValueSequence());
    return m_styleValueSequence;
}

void StyleValueOrStyleValueSequence::setStyleValueSequence(const HeapVector<Member<StyleValue>>& value)
{
    ASSERT(isNull());
    m_styleValueSequence = value;
    m_type = SpecificTypeStyleValueSequence;
}

StyleValueOrStyleValueSequence StyleValueOrStyleValueSequence::fromStyleValueSequence(const HeapVector<Member<StyleValue>>& value)
{
    StyleValueOrStyleValueSequence container;
    container.setStyleValueSequence(value);
    return container;
}

StyleValueOrStyleValueSequence::StyleValueOrStyleValueSequence(const StyleValueOrStyleValueSequence&) = default;
StyleValueOrStyleValueSequence::~StyleValueOrStyleValueSequence() = default;
StyleValueOrStyleValueSequence& StyleValueOrStyleValueSequence::operator=(const StyleValueOrStyleValueSequence&) = default;

DEFINE_TRACE(StyleValueOrStyleValueSequence)
{
    visitor->trace(m_styleValue);
    visitor->trace(m_styleValueSequence);
}

void V8StyleValueOrStyleValueSequence::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, StyleValueOrStyleValueSequence& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
    ...
    if (V8StyleValue::hasInstance(v8Value, isolate)) {
        RawPtr<StyleValue> cppValue = V8StyleValue::toImpl(v8::Local<v8::Object>::Cast(v8Value));
        impl.setStyleValue(cppValue);
        return;
    }

    if (v8Value->IsArray()) {
        HeapVector<Member<StyleValue>> cppValue = (toMemberNativeArray<StyleValue, V8StyleValue>(v8Value, 0, isolate, exceptionState));
        if (exceptionState.hadException())
            return;
        impl.setStyleValueSequence(cppValue);
        return;
    }

    exceptionState.throwTypeError("The provided value is not of type '(StyleValue or sequence<StyleValue>)'");
}

v8::Local<v8::Value> toV8(const StyleValueOrStyleValueSequence& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    switch (impl.m_type) {
    case StyleValueOrStyleValueSequence::SpecificTypeNone:
        return v8::Null(isolate);
    case StyleValueOrStyleValueSequence::SpecificTypeStyleValue:
        return toV8(impl.getAsStyleValue(), creationContext, isolate);
    case StyleValueOrStyleValueSequence::SpecificTypeStyleValueSequence:
        return toV8(impl.getAsStyleValueSequence(), creationContext, isolate);
    default:
        ASSERT_NOT_REACHED();
    }
    return v8::Local<v8::Value>();
...
StyleValueOrStyleValueSequence NativeValueTraits<StyleValueOrStyleValueSequence>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    StyleValueOrStyleValueSequence impl;
    V8StyleValueOrStyleValueSequence::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}

StyleValueOrStyleValueSequenceOrString::StyleValueOrStyleValueSequenceOrString()
    : m_type(SpecificTypeNone)
{
}

StyleValue* StyleValueOrStyleValueSequenceOrString::getAsStyleValue() const
{
    ASSERT(isStyleValue());
    return m_styleValue;
}

void StyleValueOrStyleValueSequenceOrString::setStyleValue(StyleValue* value)
{
    ASSERT(isNull());
    m_styleValue = value;
    m_type = SpecificTypeStyleValue;
...
StyleValueOrStyleValueSequenceOrString StyleValueOrStyleValueSequenceOrString::fromStyleValue(StyleValue* value)
{
    StyleValueOrStyleValueSequenceOrString container;
    container.setStyleValue(value);
    return container;
}

const HeapVector<Member<StyleValue>>& StyleValueOrStyleValueSequenceOrString::getAsStyleValueSequence() const
{
    ASSERT(isStyleValueSequence());
    return m_styleValueSequence;
}

void StyleValueOrStyleValueSequenceOrString::setStyleValueSequence(const HeapVector<Member<StyleValue>>& value)
{
    ASSERT(isNull());
    m_styleValueSequence = value;
    m_type = SpecificTypeStyleValueSequence;
...
StyleValueOrStyleValueSequenceOrString StyleValueOrStyleValueSequenceOrString::fromStyleValueSequence(const HeapVector<Member<StyleValue>>& value)
{
    StyleValueOrStyleValueSequenceOrString container;
    container.setStyleValueSequence(value);
    return container;
...
String StyleValueOrStyleValueSequenceOrString::getAsString() const
{
    ASSERT(isString());
    return m_string;
}

void StyleValueOrStyleValueSequenceOrString::setString(String value)
{
    ASSERT(isNull());
    m_string = value;
    m_type = SpecificTypeString;
...
StyleValueOrStyleValueSequenceOrString StyleValueOrStyleValueSequenceOrString::fromString(String value)
{
    StyleValueOrStyleValueSequenceOrString container;
    container.setString(value);
    return container;
...
StyleValueOrStyleValueSequenceOrString::StyleValueOrStyleValueSequenceOrString(const StyleValueOrStyleValueSequenceOrString&) = default;
StyleValueOrStyleValueSequenceOrString::~StyleValueOrStyleValueSequenceOrString() = default;
StyleValueOrStyleValueSequenceOrString& StyleValueOrStyleValueSequenceOrString::operator=(const StyleValueOrStyleValueSequenceOrString&) = default;

DEFINE_TRACE(StyleValueOrStyleValueSequenceOrString)
{
    visitor->trace(m_styleValue);
    visitor->trace(m_styleValueSequence);
}

void V8StyleValueOrStyleValueSequenceOrString::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, StyleValueOrStyleValueSequenceOrString& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
...
v8::Local<v8::Value> toV8(const StyleValueOrStyleValueSequenceOrString& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    switch (impl.m_type) {
    case StyleValueOrStyleValueSequenceOrString::SpecificTypeNone:
        return v8::Null(isolate);
    case StyleValueOrStyleValueSequenceOrString::SpecificTypeStyleValue:
        return toV8(impl.getAsStyleValue(), creationContext, isolate);
    case StyleValueOrStyleValueSequenceOrString::SpecificTypeStyleValueSequence:
        return toV8(impl.getAsStyleValueSequence(), creationContext, isolate);
    case StyleValueOrStyleValueSequenceOrString::SpecificTypeString:
        return v8String(isolate, impl.getAsString());
    default:
        ASSERT_NOT_REACHED();
    }
...
StyleValueOrStyleValueSequenceOrString NativeValueTraits<StyleValueOrStyleValueSequenceOrString>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    StyleValueOrStyleValueSequenceOrString impl;
    V8StyleValueOrStyleValueSequenceOrString::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
...
void V8USVStringOrURLSearchParams::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, USVStringOrURLSearchParams& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    ...
    if (V8URLSearchParams::hasInstance(v8Value, isolate)) {
        RawPtr<URLSearchParams> cppValue = V8URLSearchParams::toImpl(v8::Local<v8::Object>::Cast(v8Value));
...
void V8VideoTrackOrAudioTrackOrTextTrack::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, VideoTrackOrAudioTrackOrTextTrack& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    ...
    if (V8VideoTrack::hasInstance(v8Value, isolate)) {
        RawPtr<VideoTrack> cppValue = V8VideoTrack::toImpl(v8::Local<v8::Object>::Cast(v8Value));
        impl.setVideoTrack(cppValue);
        return;
    }

    if (V8AudioTrack::hasInstance(v8Value, isolate)) {
        RawPtr<AudioTrack> cppValue = V8AudioTrack::toImpl(v8::Local<v8::Object>::Cast(v8Value));
        impl.setAudioTrack(cppValue);
        return;
    }

    if (V8TextTrack::hasInstance(v8Value, isolate)) {
        RawPtr<TextTrack> cppValue = V8TextTrack::toImpl(v8::Local<v8::Object>::Cast(v8Value));
