...
#endif
const WrapperTypeInfo V8FileList::wrapperTypeInfo = { gin::kEmbedderBlink, V8FileList::domTemplate, V8FileList::refObject, V8FileList::derefObject, V8FileList::trace, 0, 0, V8FileList::preparePrototypeAndInterfaceObject, V8FileList::installConditionallyEnabledProperties, "FileList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8FileListAccessors[] = {
    {"length", FileListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
