...
#endif
const WrapperTypeInfo V8SQLTransaction::wrapperTypeInfo = { gin::kEmbedderBlink, V8SQLTransaction::domTemplate, V8SQLTransaction::refObject, V8SQLTransaction::derefObject, V8SQLTransaction::trace, 0, 0, V8SQLTransaction::preparePrototypeAndInterfaceObject, V8SQLTransaction::installConditionallyEnabledProperties, "SQLTransaction", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
