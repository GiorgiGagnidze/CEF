...
#endif
const WrapperTypeInfo V8XPathExpression::wrapperTypeInfo = { gin::kEmbedderBlink, V8XPathExpression::domTemplate, V8XPathExpression::refObject, V8XPathExpression::derefObject, V8XPathExpression::trace, 0, 0, V8XPathExpression::preparePrototypeAndInterfaceObject, V8XPathExpression::installConditionallyEnabledProperties, "XPathExpression", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
