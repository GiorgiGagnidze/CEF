...
#endif
const WrapperTypeInfo V8AnalyserNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnalyserNode::domTemplate, V8AnalyserNode::refObject, V8AnalyserNode::derefObject, V8AnalyserNode::trace, 0, 0, V8AnalyserNode::preparePrototypeAndInterfaceObject, V8AnalyserNode::installConditionallyEnabledProperties, "AnalyserNode", &V8AudioNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8AnalyserNodeAccessors[] = {
    ...
    {"frequencyBinCount", AnalyserNodeV8Internal::frequencyBinCountAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
