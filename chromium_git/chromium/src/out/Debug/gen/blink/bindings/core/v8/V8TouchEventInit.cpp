...
void V8TouchEventInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, TouchEventInit& impl, ExceptionState& exceptionState)
{
    ...
    }
    {
        ...
        if (changedTouchesValue.IsEmpty() || changedTouchesValue->IsUndefined()) {
            ...
            WillBeHeapVector<RefPtrWillBeMember<Touch>> changedTouches = (toRefPtrWillBeMemberNativeArray<Touch, V8Touch>(changedTouchesValue, 0, isolate, exceptionState));
            if (exceptionState.hadException())
                return;
...

    {
        ...
        if (targetTouchesValue.IsEmpty() || targetTouchesValue->IsUndefined()) {
            ...
            WillBeHeapVector<RefPtrWillBeMember<Touch>> targetTouches = (toRefPtrWillBeMemberNativeArray<Touch, V8Touch>(targetTouchesValue, 0, isolate, exceptionState));
            if (exceptionState.hadException())
                return;
...

    {
        ...
        if (touchesValue.IsEmpty() || touchesValue->IsUndefined()) {
            ...
            WillBeHeapVector<RefPtrWillBeMember<Touch>> touches = (toRefPtrWillBeMemberNativeArray<Touch, V8Touch>(touchesValue, 0, isolate, exceptionState));
            if (exceptionState.hadException())
                return;
...
v8::Local<v8::Value> toV8(const TouchEventInit& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8EventModifierInit(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    if (!toV8TouchEventInit(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}
...
bool toV8TouchEventInit(const TouchEventInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    if (impl.hasChangedTouches()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "changedTouches"), toV8(WillBeHeapVector<RefPtrWillBeMember<Touch>>(), creationContext, isolate))))
            return false;
    }
    ...
    if (impl.hasTargetTouches()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "targetTouches"), toV8(WillBeHeapVector<RefPtrWillBeMember<Touch>>(), creationContext, isolate))))
            return false;
    }
    ...
    if (impl.hasTouches()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "touches"), toV8(WillBeHeapVector<RefPtrWillBeMember<Touch>>(), creationContext, isolate))))
            return false;
    }
