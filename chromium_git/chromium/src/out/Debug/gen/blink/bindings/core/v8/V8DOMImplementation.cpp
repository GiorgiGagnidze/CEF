...
#endif
const WrapperTypeInfo V8DOMImplementation::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMImplementation::domTemplate, V8DOMImplementation::refObject, V8DOMImplementation::derefObject, V8DOMImplementation::trace, 0, V8DOMImplementation::visitDOMWrapper, V8DOMImplementation::preparePrototypeAndInterfaceObject, V8DOMImplementation::installConditionallyEnabledProperties, "DOMImplementation", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
