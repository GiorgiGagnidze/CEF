...
#endif
const WrapperTypeInfo V8WebGLContextEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLContextEvent::domTemplate, V8WebGLContextEvent::refObject, V8WebGLContextEvent::derefObject, V8WebGLContextEvent::trace, 0, 0, V8WebGLContextEvent::preparePrototypeAndInterfaceObject, V8WebGLContextEvent::installConditionallyEnabledProperties, "WebGLContextEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8WebGLContextEventAccessors[] = {
    {"statusMessage", WebGLContextEventV8Internal::statusMessageAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
