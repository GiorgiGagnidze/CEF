...
const V8DOMConfiguration::AccessorConfiguration V8ReadableByteStreamReaderAccessors[] = {
    {"closed", ReadableByteStreamReaderV8Internal::closedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8ReadableByteStreamReaderMethods[] = {
    {"read", ReadableByteStreamReaderV8Internal::readMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"cancel", ReadableByteStreamReaderV8Internal::cancelMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"releaseLock", ReadableByteStreamReaderV8Internal::releaseLockMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
