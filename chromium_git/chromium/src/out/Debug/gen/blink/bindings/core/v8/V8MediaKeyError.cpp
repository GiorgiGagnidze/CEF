...
const V8DOMConfiguration::AccessorConfiguration V8MediaKeyErrorAccessors[] = {
    {"code", MediaKeyErrorV8Internal::codeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8MediaKeyErrorTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::encryptedMediaEnabled()) {
        const V8DOMConfiguration::AccessorConfiguration accessorsystemCodeConfiguration = \
        {"systemCode", MediaKeyErrorV8Internal::systemCodeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessorsystemCodeConfiguration);
    }
    const V8DOMConfiguration::ConstantConfiguration V8MediaKeyErrorConstants[] = {
        {"MEDIA_KEYERR_UNKNOWN", 1, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"MEDIA_KEYERR_CLIENT", 2, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"MEDIA_KEYERR_SERVICE", 3, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"MEDIA_KEYERR_OUTPUT", 4, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"MEDIA_KEYERR_HARDWARECHANGE", 5, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
        {"MEDIA_KEYERR_DOMAIN", 6, 0, V8DOMConfiguration::ConstantTypeUnsignedShort},
    };
