...
#endif
const WrapperTypeInfo V8WebGLLoseContext::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLLoseContext::domTemplate, V8WebGLLoseContext::refObject, V8WebGLLoseContext::derefObject, V8WebGLLoseContext::trace, 0, V8WebGLLoseContext::visitDOMWrapper, V8WebGLLoseContext::preparePrototypeAndInterfaceObject, V8WebGLLoseContext::installConditionallyEnabledProperties, "WebGLLoseContext", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
