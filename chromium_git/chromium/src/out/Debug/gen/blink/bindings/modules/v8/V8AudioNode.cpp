...
static void contextAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AbstractAudioContext> cppValue(impl->context());
...
static void connect1Method(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<AudioNode> result = impl->connect(destination, output, input, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8AudioNodeAccessors[] = {
    {"context", AudioNodeV8Internal::contextAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"numberOfInputs", AudioNodeV8Internal::numberOfInputsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"numberOfOutputs", AudioNodeV8Internal::numberOfOutputsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
