...
#endif
const WrapperTypeInfo V8MediaRecorder::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaRecorder::domTemplate, V8MediaRecorder::refObject, V8MediaRecorder::derefObject, V8MediaRecorder::trace, V8MediaRecorder::toActiveDOMObject, 0, V8MediaRecorder::preparePrototypeAndInterfaceObject, V8MediaRecorder::installConditionallyEnabledProperties, "MediaRecorder", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void onstopAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    MediaRecorder* impl = V8MediaRecorder::toImpl(holder);
    EventListener* cppValue(impl->onstop());
    v8SetReturnValue(info, cppValue ? v8::Local<v8::Value>(V8AbstractEventListener::cast(cppValue)->getListenerObject(impl->executionContext())) : v8::Local<v8::Value>(v8::Null(info.GetIsolate())));
}
...
static void ondataavailableAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    MediaRecorder* impl = V8MediaRecorder::toImpl(holder);
    EventListener* cppValue(impl->ondataavailable());
    v8SetReturnValue(info, cppValue ? v8::Local<v8::Value>(V8AbstractEventListener::cast(cppValue)->getListenerObject(impl->executionContext())) : v8::Local<v8::Value>(v8::Null(info.GetIsolate())));
}
...
static void isTypeSupportedMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(createMinimumArityTypeErrorForMethod(info.GetIsolate(), "isTypeSupported", "MediaRecorder", 1, info.Length()), info.GetIsolate());
        return;
    }
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<MediaRecorder> impl = MediaRecorder::create(executionContext, stream, options, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
const V8DOMConfiguration::AccessorConfiguration V8MediaRecorderAccessors[] = {
    {"stream", MediaRecorderV8Internal::streamAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"mimeType", MediaRecorderV8Internal::mimeTypeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"state", MediaRecorderV8Internal::stateAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
static void installV8MediaRecorderTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    if (!RuntimeEnabledFeatures::mediaRecorderEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "MediaRecorder", V8EventTarget::domTemplate(isolate), V8MediaRecorder::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "MediaRecorder", V8EventTarget::domTemplate(isolate), V8MediaRecorder::internalFieldCount,
            0, 0,
            V8MediaRecorderAccessors, WTF_ARRAY_LENGTH(V8MediaRecorderAccessors),
            V8MediaRecorderMethods, WTF_ARRAY_LENGTH(V8MediaRecorderMethods));
    functionTemplate->SetCallHandler(V8MediaRecorder::constructorCallback);
...
v8::Local<v8::FunctionTemplate> V8MediaRecorder::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8MediaRecorderTemplate);
}
...
ActiveDOMObject* V8MediaRecorder::toActiveDOMObject(v8::Local<v8::Object> wrapper)
{
    return toImpl(wrapper);
}

void V8MediaRecorder::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8MediaRecorder::derefObject(ScriptWrappable* scriptWrappable)
{
}
