...
#endif
const WrapperTypeInfo V8DelayNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8DelayNode::domTemplate, V8DelayNode::refObject, V8DelayNode::derefObject, V8DelayNode::trace, 0, 0, V8DelayNode::preparePrototypeAndInterfaceObject, V8DelayNode::installConditionallyEnabledProperties, "DelayNode", &V8AudioNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8DelayNodeAccessors[] = {
    {"delayTime", DelayNodeV8Internal::delayTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
