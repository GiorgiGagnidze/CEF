...
#endif
const WrapperTypeInfo V8WebGLTransformFeedback::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLTransformFeedback::domTemplate, V8WebGLTransformFeedback::refObject, V8WebGLTransformFeedback::derefObject, V8WebGLTransformFeedback::trace, 0, 0, V8WebGLTransformFeedback::preparePrototypeAndInterfaceObject, V8WebGLTransformFeedback::installConditionallyEnabledProperties, "WebGLTransformFeedback", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
