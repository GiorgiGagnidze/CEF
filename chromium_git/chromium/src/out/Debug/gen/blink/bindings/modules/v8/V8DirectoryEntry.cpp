...
#endif
const WrapperTypeInfo V8DirectoryEntry::wrapperTypeInfo = { gin::kEmbedderBlink, V8DirectoryEntry::domTemplate, V8DirectoryEntry::refObject, V8DirectoryEntry::derefObject, V8DirectoryEntry::trace, 0, 0, V8DirectoryEntry::preparePrototypeAndInterfaceObject, V8DirectoryEntry::installConditionallyEnabledProperties, "DirectoryEntry", &V8Entry::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
