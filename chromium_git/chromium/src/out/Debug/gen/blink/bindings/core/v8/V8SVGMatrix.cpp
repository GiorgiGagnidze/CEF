...
#endif
const WrapperTypeInfo V8SVGMatrix::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGMatrix::domTemplate, V8SVGMatrix::refObject, V8SVGMatrix::derefObject, V8SVGMatrix::trace, 0, V8SVGMatrix::visitDOMWrapper, V8SVGMatrix::preparePrototypeAndInterfaceObject, V8SVGMatrix::installConditionallyEnabledProperties, "SVGMatrix", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
