...
#endif
const WrapperTypeInfo V8RTCSessionDescription::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCSessionDescription::domTemplate, V8RTCSessionDescription::refObject, V8RTCSessionDescription::derefObject, V8RTCSessionDescription::trace, 0, 0, V8RTCSessionDescription::preparePrototypeAndInterfaceObject, V8RTCSessionDescription::installConditionallyEnabledProperties, "RTCSessionDescription", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
