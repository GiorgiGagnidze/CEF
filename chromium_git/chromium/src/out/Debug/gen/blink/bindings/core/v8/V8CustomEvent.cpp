...
#endif
const WrapperTypeInfo V8CustomEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8CustomEvent::domTemplate, V8CustomEvent::refObject, V8CustomEvent::derefObject, V8CustomEvent::trace, 0, 0, V8CustomEvent::preparePrototypeAndInterfaceObject, V8CustomEvent::installConditionallyEnabledProperties, "CustomEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CustomEventAccessors[] = {
    {"detail", CustomEventV8Internal::detailAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8CustomEventTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::trustedEventsEnabled()) {
        ...
        {"isTrusted", CustomEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
