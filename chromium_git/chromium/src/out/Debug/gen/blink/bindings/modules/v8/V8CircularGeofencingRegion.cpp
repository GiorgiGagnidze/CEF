...
#endif
const WrapperTypeInfo V8CircularGeofencingRegion::wrapperTypeInfo = { gin::kEmbedderBlink, V8CircularGeofencingRegion::domTemplate, V8CircularGeofencingRegion::refObject, V8CircularGeofencingRegion::derefObject, V8CircularGeofencingRegion::trace, 0, 0, V8CircularGeofencingRegion::preparePrototypeAndInterfaceObject, V8CircularGeofencingRegion::installConditionallyEnabledProperties, "CircularGeofencingRegion", &V8GeofencingRegion::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CircularGeofencingRegionAccessors[] = {
    {"latitude", CircularGeofencingRegionV8Internal::latitudeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"longitude", CircularGeofencingRegionV8Internal::longitudeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"radius", CircularGeofencingRegionV8Internal::radiusAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8CircularGeofencingRegionTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    const V8DOMConfiguration::ConstantConfiguration V8CircularGeofencingRegionConstants[] = {
        {"MIN_RADIUS", 0, 1.0, V8DOMConfiguration::ConstantTypeDouble},
        {"MAX_RADIUS", 0, 100.0, V8DOMConfiguration::ConstantTypeDouble},
    };
