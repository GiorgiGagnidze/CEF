...
#endif
const WrapperTypeInfo V8OESVertexArrayObject::wrapperTypeInfo = { gin::kEmbedderBlink, V8OESVertexArrayObject::domTemplate, V8OESVertexArrayObject::refObject, V8OESVertexArrayObject::derefObject, V8OESVertexArrayObject::trace, 0, V8OESVertexArrayObject::visitDOMWrapper, V8OESVertexArrayObject::preparePrototypeAndInterfaceObject, V8OESVertexArrayObject::installConditionallyEnabledProperties, "OESVertexArrayObject", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
