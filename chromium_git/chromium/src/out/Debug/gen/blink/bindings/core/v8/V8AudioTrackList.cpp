...
{
    AudioTrackList* impl = V8AudioTrackList::toImpl(info.Holder());
    RawPtr<AudioTrack> result = impl->anonymousIndexedGetter(index);
    if (!result)
        return;
...
const V8DOMConfiguration::AccessorConfiguration V8AudioTrackListAccessors[] = {
    {"length", AudioTrackListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
