...
#endif
const WrapperTypeInfo V8AnimationTimeline::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnimationTimeline::domTemplate, V8AnimationTimeline::refObject, V8AnimationTimeline::derefObject, V8AnimationTimeline::trace, 0, 0, V8AnimationTimeline::preparePrototypeAndInterfaceObject, V8AnimationTimeline::installConditionallyEnabledProperties, "AnimationTimeline", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void playMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    AnimationEffect* source;
    {
        ...
        if (!source) {
            V8ThrowException::throwTypeError(info.GetIsolate(), ExceptionMessages::failedToExecute("play", "AnimationTimeline", "parameter 1 is not of type 'AnimationEffectReadOnly'."));
            return;
        }
    }
...
const V8DOMConfiguration::AccessorConfiguration V8AnimationTimelineAccessors[] = {
    ...
    {"playbackRate", AnimationTimelineV8Internal::playbackRateAttributeGetterCallback, AnimationTimelineV8Internal::playbackRateAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8AnimationTimelineMethods[] = {
    {"play", AnimationTimelineV8Internal::playMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
