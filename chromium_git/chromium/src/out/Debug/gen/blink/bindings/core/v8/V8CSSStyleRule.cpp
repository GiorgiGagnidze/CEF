...
#endif
const WrapperTypeInfo V8CSSStyleRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSStyleRule::domTemplate, V8CSSStyleRule::refObject, V8CSSStyleRule::derefObject, V8CSSStyleRule::trace, 0, 0, V8CSSStyleRule::preparePrototypeAndInterfaceObject, V8CSSStyleRule::installConditionallyEnabledProperties, "CSSStyleRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
