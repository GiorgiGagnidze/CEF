...
static void bufferedAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<TimeRanges> cppValue(impl->buffered(exceptionState));
...
const V8DOMConfiguration::AccessorConfiguration V8SourceBufferAccessors[] = {
    {"updating", SourceBufferV8Internal::updatingAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"buffered", SourceBufferV8Internal::bufferedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
static void installV8SourceBufferTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::mediaSourceExperimentalEnabled()) {
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessormodeConfiguration);
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessortrackDefaultsConfiguration);
    }
    if (RuntimeEnabledFeatures::experimentalStreamEnabled()) {
        ...
        V8DOMConfiguration::installMethod(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, appendStreamMethodConfiguration);
    }
}
