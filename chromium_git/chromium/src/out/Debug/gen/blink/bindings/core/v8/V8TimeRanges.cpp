...
#endif
const WrapperTypeInfo V8TimeRanges::wrapperTypeInfo = { gin::kEmbedderBlink, V8TimeRanges::domTemplate, V8TimeRanges::refObject, V8TimeRanges::derefObject, V8TimeRanges::trace, 0, 0, V8TimeRanges::preparePrototypeAndInterfaceObject, V8TimeRanges::installConditionallyEnabledProperties, "TimeRanges", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8TimeRangesAccessors[] = {
    {"length", TimeRangesV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
