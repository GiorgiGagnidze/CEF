...
#endif
const WrapperTypeInfo V8Iterator::wrapperTypeInfo = { gin::kEmbedderBlink, V8Iterator::domTemplate, V8Iterator::refObject, V8Iterator::derefObject, V8Iterator::trace, 0, 0, V8Iterator::preparePrototypeAndInterfaceObject, V8Iterator::installConditionallyEnabledProperties, "Iterator", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
