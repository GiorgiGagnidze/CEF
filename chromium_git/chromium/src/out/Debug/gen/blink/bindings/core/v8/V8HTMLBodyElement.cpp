...
#endif
const WrapperTypeInfo V8HTMLBodyElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLBodyElement::domTemplate, V8HTMLBodyElement::refObject, V8HTMLBodyElement::derefObject, V8HTMLBodyElement::trace, 0, 0, V8HTMLBodyElement::preparePrototypeAndInterfaceObject, V8HTMLBodyElement::installConditionallyEnabledProperties, "HTMLBodyElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
