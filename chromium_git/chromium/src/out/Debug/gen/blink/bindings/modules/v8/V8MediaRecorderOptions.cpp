...
v8::Local<v8::Value> toV8(const MediaRecorderOptions& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8MediaRecorderOptions(impl, v8Object, creationContext, isolate))
...
bool toV8MediaRecorderOptions(const MediaRecorderOptions& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    if (impl.hasAudioBitsPerSecond()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "audioBitsPerSecond"), v8::Integer::NewFromUnsigned(isolate, 0u))))
            return false;
    }
    ...
    if (impl.hasBitsPerSecond()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "bitsPerSecond"), v8::Integer::NewFromUnsigned(isolate, 0u))))
            return false;
    }
    ...
    if (impl.hasVideoBitsPerSecond()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "videoBitsPerSecond"), v8::Integer::NewFromUnsigned(isolate, 0u))))
            return false;
    }
