...
#endif
const WrapperTypeInfo V8URLSearchParams::wrapperTypeInfo = { gin::kEmbedderBlink, V8URLSearchParams::domTemplate, V8URLSearchParams::refObject, V8URLSearchParams::derefObject, V8URLSearchParams::trace, 0, 0, V8URLSearchParams::preparePrototypeAndInterfaceObject, V8URLSearchParams::installConditionallyEnabledProperties, "URLSearchParams", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<URLSearchParams> impl = URLSearchParams::create(init);
