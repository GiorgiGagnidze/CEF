...
static void memoryAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8Console_Memory_AttributeGetter);
...
static void memoryAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8Console_Memory_AttributeSetter);
...
const V8DOMConfiguration::AccessorConfiguration V8ConsoleAccessors[] = {
    {"memory", ConsoleV8Internal::memoryAttributeGetterCallback, ConsoleV8Internal::memoryAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
