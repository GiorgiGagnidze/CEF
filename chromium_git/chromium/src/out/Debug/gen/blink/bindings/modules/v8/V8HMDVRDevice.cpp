...
#endif
const WrapperTypeInfo V8HMDVRDevice::wrapperTypeInfo = { gin::kEmbedderBlink, V8HMDVRDevice::domTemplate, V8HMDVRDevice::refObject, V8HMDVRDevice::derefObject, V8HMDVRDevice::trace, 0, 0, V8HMDVRDevice::preparePrototypeAndInterfaceObject, V8HMDVRDevice::installConditionallyEnabledProperties, "HMDVRDevice", &V8VRDevice::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::MethodConfiguration V8HMDVRDeviceMethods[] = {
    {"getEyeParameters", HMDVRDeviceV8Internal::getEyeParametersMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setFieldOfView", HMDVRDeviceV8Internal::setFieldOfViewMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
