...
const V8DOMConfiguration::MethodConfiguration V8ReadableByteStreamMethods[] = {
    {"getReader", ReadableByteStreamV8Internal::getReaderMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"cancel", ReadableByteStreamV8Internal::cancelMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
