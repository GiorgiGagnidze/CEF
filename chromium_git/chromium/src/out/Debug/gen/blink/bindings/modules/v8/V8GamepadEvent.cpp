...
#endif
const WrapperTypeInfo V8GamepadEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8GamepadEvent::domTemplate, V8GamepadEvent::refObject, V8GamepadEvent::derefObject, V8GamepadEvent::trace, 0, 0, V8GamepadEvent::preparePrototypeAndInterfaceObject, V8GamepadEvent::installConditionallyEnabledProperties, "GamepadEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8GamepadEventAccessors[] = {
    {"gamepad", GamepadEventV8Internal::gamepadAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
