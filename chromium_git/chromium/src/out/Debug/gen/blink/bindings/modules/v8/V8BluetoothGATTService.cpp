...
const V8DOMConfiguration::AccessorConfiguration V8BluetoothGATTServiceAccessors[] = {
    {"uuid", BluetoothGATTServiceV8Internal::uuidAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"isPrimary", BluetoothGATTServiceV8Internal::isPrimaryAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8BluetoothGATTServiceMethods[] = {
    {"getCharacteristic", BluetoothGATTServiceV8Internal::getCharacteristicMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
