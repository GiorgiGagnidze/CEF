...
#endif
const WrapperTypeInfo V8SpeechGrammar::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechGrammar::domTemplate, V8SpeechGrammar::refObject, V8SpeechGrammar::derefObject, V8SpeechGrammar::trace, 0, 0, V8SpeechGrammar::preparePrototypeAndInterfaceObject, V8SpeechGrammar::installConditionallyEnabledProperties, "SpeechGrammar", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
