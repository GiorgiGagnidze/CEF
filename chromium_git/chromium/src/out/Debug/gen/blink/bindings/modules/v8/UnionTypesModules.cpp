...
PassRefPtr<DOMArrayBuffer> ArrayBufferOrArrayBufferViewOrUSVString::getAsArrayBuffer() const
{
    ASSERT(isArrayBuffer());
    return m_arrayBuffer;
}

void ArrayBufferOrArrayBufferViewOrUSVString::setArrayBuffer(PassRefPtr<DOMArrayBuffer> value)
{
    ASSERT(isNull());
    m_arrayBuffer = value;
    m_type = SpecificTypeArrayBuffer;
...
ArrayBufferOrArrayBufferViewOrUSVString ArrayBufferOrArrayBufferViewOrUSVString::fromArrayBuffer(PassRefPtr<DOMArrayBuffer> value)
{
...
PassRefPtr<DOMArrayBufferView> ArrayBufferOrArrayBufferViewOrUSVString::getAsArrayBufferView() const
{
    ASSERT(isArrayBufferView());
    return m_arrayBufferView;
}

void ArrayBufferOrArrayBufferViewOrUSVString::setArrayBufferView(PassRefPtr<DOMArrayBufferView> value)
{
    ASSERT(isNull());
    m_arrayBufferView = value;
    m_type = SpecificTypeArrayBufferView;
...
ArrayBufferOrArrayBufferViewOrUSVString ArrayBufferOrArrayBufferViewOrUSVString::fromArrayBufferView(PassRefPtr<DOMArrayBufferView> value)
{
    ArrayBufferOrArrayBufferViewOrUSVString container;
    container.setArrayBufferView(value);
    return container;
...
BooleanOrMediaTrackConstraintSet::BooleanOrMediaTrackConstraintSet()
    : m_type(SpecificTypeNone)
{
}

bool BooleanOrMediaTrackConstraintSet::getAsBoolean() const
{
    ASSERT(isBoolean());
    return m_boolean;
}

void BooleanOrMediaTrackConstraintSet::setBoolean(bool value)
{
    ASSERT(isNull());
    m_boolean = value;
...
BooleanOrMediaTrackConstraintSet BooleanOrMediaTrackConstraintSet::fromBoolean(bool value)
{
    BooleanOrMediaTrackConstraintSet container;
    container.setBoolean(value);
    return container;
}

MediaTrackConstraintSet BooleanOrMediaTrackConstraintSet::getAsMediaTrackConstraintSet() const
{
    ASSERT(isMediaTrackConstraintSet());
    return m_mediaTrackConstraintSet;
}

void BooleanOrMediaTrackConstraintSet::setMediaTrackConstraintSet(MediaTrackConstraintSet value)
{
    ASSERT(isNull());
    m_mediaTrackConstraintSet = value;
    m_type = SpecificTypeMediaTrackConstraintSet;
}

BooleanOrMediaTrackConstraintSet BooleanOrMediaTrackConstraintSet::fromMediaTrackConstraintSet(MediaTrackConstraintSet value)
{
    BooleanOrMediaTrackConstraintSet container;
    container.setMediaTrackConstraintSet(value);
    return container;
}

BooleanOrMediaTrackConstraintSet::BooleanOrMediaTrackConstraintSet(const BooleanOrMediaTrackConstraintSet&) = default;
BooleanOrMediaTrackConstraintSet::~BooleanOrMediaTrackConstraintSet() = default;
BooleanOrMediaTrackConstraintSet& BooleanOrMediaTrackConstraintSet::operator=(const BooleanOrMediaTrackConstraintSet&) = default;

DEFINE_TRACE(BooleanOrMediaTrackConstraintSet)
{
    visitor->trace(m_mediaTrackConstraintSet);
}

void V8BooleanOrMediaTrackConstraintSet::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, BooleanOrMediaTrackConstraintSet& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
    ...
    if (isUndefinedOrNull(v8Value) || v8Value->IsObject()) {
        MediaTrackConstraintSet cppValue;
        V8MediaTrackConstraintSet::toImpl(isolate, v8Value, cppValue, exceptionState);
        if (exceptionState.hadException())
            return;
        impl.setMediaTrackConstraintSet(cppValue);
        return;
    }
...
v8::Local<v8::Value> toV8(const BooleanOrMediaTrackConstraintSet& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    switch (impl.m_type) {
    case BooleanOrMediaTrackConstraintSet::SpecificTypeNone:
        return v8::Null(isolate);
    case BooleanOrMediaTrackConstraintSet::SpecificTypeBoolean:
        return v8Boolean(impl.getAsBoolean(), isolate);
    case BooleanOrMediaTrackConstraintSet::SpecificTypeMediaTrackConstraintSet:
        return toV8(impl.getAsMediaTrackConstraintSet(), creationContext, isolate);
    default:
        ASSERT_NOT_REACHED();
    }
    return v8::Local<v8::Value>();
...
BooleanOrMediaTrackConstraintSet NativeValueTraits<BooleanOrMediaTrackConstraintSet>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    BooleanOrMediaTrackConstraintSet impl;
    V8BooleanOrMediaTrackConstraintSet::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
...
void V8ServiceWorkerOrMessagePort::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ServiceWorkerOrMessagePort& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    ...
    if (V8ServiceWorker::hasInstance(v8Value, isolate)) {
        RawPtr<ServiceWorker> cppValue = V8ServiceWorker::toImpl(v8::Local<v8::Object>::Cast(v8Value));
...
PassRefPtr<DOMArrayBuffer> StringOrArrayBufferOrNFCMessage::getAsArrayBuffer() const
{
    ASSERT(isArrayBuffer());
    return m_arrayBuffer;
}

void StringOrArrayBufferOrNFCMessage::setArrayBuffer(PassRefPtr<DOMArrayBuffer> value)
{
    ASSERT(isNull());
    m_arrayBuffer = value;
    m_type = SpecificTypeArrayBuffer;
...
StringOrArrayBufferOrNFCMessage StringOrArrayBufferOrNFCMessage::fromArrayBuffer(PassRefPtr<DOMArrayBuffer> value)
{
    StringOrArrayBufferOrNFCMessage container;
    container.setArrayBuffer(value);
    return container;
...
NFCMessage StringOrArrayBufferOrNFCMessage::getAsNFCMessage() const
{
    ASSERT(isNFCMessage());
    return m_nFCMessage;
}

void StringOrArrayBufferOrNFCMessage::setNFCMessage(NFCMessage value)
{
    ASSERT(isNull());
    m_nFCMessage = value;
...
StringOrArrayBufferOrNFCMessage StringOrArrayBufferOrNFCMessage::fromNFCMessage(NFCMessage value)
{
    StringOrArrayBufferOrNFCMessage container;
...
void V8UnsignedLongLongOrString::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, UnsignedLongLongOrString& impl, UnionTypeConversionMode conversionMode, ExceptionState& exceptionState)
{
    if (v8Value.IsEmpty())
        return;
...
UnsignedLongLongOrString NativeValueTraits<UnsignedLongLongOrString>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    ...
    V8UnsignedLongLongOrString::toImpl(isolate, value, impl, UnionTypeConversionMode::NotNullable, exceptionState);
    return impl;
}
