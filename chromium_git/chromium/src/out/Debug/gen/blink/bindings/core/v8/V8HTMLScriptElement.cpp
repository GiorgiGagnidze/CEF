...
#endif
const WrapperTypeInfo V8HTMLScriptElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLScriptElement::domTemplate, V8HTMLScriptElement::refObject, V8HTMLScriptElement::derefObject, V8HTMLScriptElement::trace, 0, 0, V8HTMLScriptElement::preparePrototypeAndInterfaceObject, V8HTMLScriptElement::installConditionallyEnabledProperties, "HTMLScriptElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8HTMLScriptElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::experimentalContentSecurityPolicyFeaturesEnabled()) {
        ...
        V8DOMConfiguration::installAccessor(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, accessornonceConfiguration);
    }
}
