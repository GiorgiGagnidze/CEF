...
#endif
const WrapperTypeInfo V8PluginArray::wrapperTypeInfo = { gin::kEmbedderBlink, V8PluginArray::domTemplate, V8PluginArray::refObject, V8PluginArray::derefObject, V8PluginArray::trace, 0, 0, V8PluginArray::preparePrototypeAndInterfaceObject, V8PluginArray::installConditionallyEnabledProperties, "PluginArray", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8PluginArrayAccessors[] = {
    {"length", DOMPluginArrayV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
