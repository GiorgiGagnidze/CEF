...
#endif
const WrapperTypeInfo V8SVGGeometryElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGGeometryElement::domTemplate, V8SVGGeometryElement::refObject, V8SVGGeometryElement::derefObject, V8SVGGeometryElement::trace, 0, 0, V8SVGGeometryElement::preparePrototypeAndInterfaceObject, V8SVGGeometryElement::installConditionallyEnabledProperties, "SVGGeometryElement", &V8SVGGraphicsElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
