...
#endif
const WrapperTypeInfo V8MediaList::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaList::domTemplate, V8MediaList::refObject, V8MediaList::derefObject, V8MediaList::trace, 0, 0, V8MediaList::preparePrototypeAndInterfaceObject, V8MediaList::installConditionallyEnabledProperties, "MediaList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MediaListAccessors[] = {
    ...
    {"length", MediaListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
