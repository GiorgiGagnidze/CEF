...
#endif
const WrapperTypeInfo V8HTMLDirectoryElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLDirectoryElement::domTemplate, V8HTMLDirectoryElement::refObject, V8HTMLDirectoryElement::derefObject, V8HTMLDirectoryElement::trace, 0, 0, V8HTMLDirectoryElement::preparePrototypeAndInterfaceObject, V8HTMLDirectoryElement::installConditionallyEnabledProperties, "HTMLDirectoryElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
