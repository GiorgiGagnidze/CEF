...
#endif
const WrapperTypeInfo V8SVGSwitchElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGSwitchElement::domTemplate, V8SVGSwitchElement::refObject, V8SVGSwitchElement::derefObject, V8SVGSwitchElement::trace, 0, 0, V8SVGSwitchElement::preparePrototypeAndInterfaceObject, V8SVGSwitchElement::installConditionallyEnabledProperties, "SVGSwitchElement", &V8SVGGraphicsElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
