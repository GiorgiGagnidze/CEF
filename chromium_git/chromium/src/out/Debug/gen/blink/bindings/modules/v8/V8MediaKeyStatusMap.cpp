...
#endif
const WrapperTypeInfo V8MediaKeyStatusMap::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaKeyStatusMap::domTemplate, V8MediaKeyStatusMap::refObject, V8MediaKeyStatusMap::derefObject, V8MediaKeyStatusMap::trace, 0, 0, V8MediaKeyStatusMap::preparePrototypeAndInterfaceObject, V8MediaKeyStatusMap::installConditionallyEnabledProperties, "MediaKeyStatusMap", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void hasMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    {
        V8ArrayBufferOrArrayBufferView::toImpl(info.GetIsolate(), info[0], key, UnionTypeConversionMode::NotNullable, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8MediaKeyStatusMapAccessors[] = {
    {"size", MediaKeyStatusMapV8Internal::sizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
