...
#endif
WrapperTypeInfo V8HTMLCanvasElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLCanvasElement::domTemplate, V8HTMLCanvasElement::refObject, V8HTMLCanvasElement::derefObject, V8HTMLCanvasElement::trace, 0, 0, V8HTMLCanvasElement::preparePrototypeAndInterfaceObject, V8HTMLCanvasElement::installConditionallyEnabledProperties, "HTMLCanvasElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void toBlobMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptValue arguments;
    {
        ...
        if (UNLIKELY(numArgsPassed <= 2)) {
            ScriptState* scriptState = ScriptState::current(info.GetIsolate());
            impl->toBlob(scriptState, callback, type, exceptionState);
            if (exceptionState.hadException()) {
                exceptionState.throwIfNeeded();
                return;
            }
    ...
    ScriptState* scriptState = ScriptState::current(info.GetIsolate());
    impl->toBlob(scriptState, callback, type, arguments, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
const V8DOMConfiguration::MethodConfiguration V8HTMLCanvasElementMethods[] = {
    {"getContext", HTMLCanvasElementV8Internal::getContextMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
...
void V8HTMLCanvasElement::installV8HTMLCanvasElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
...
{
    ASSERT(V8HTMLCanvasElement::installV8HTMLCanvasElementTemplateFunction != V8HTMLCanvasElement::installV8HTMLCanvasElementTemplate);
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), V8HTMLCanvasElement::installV8HTMLCanvasElementTemplateFunction);
}
