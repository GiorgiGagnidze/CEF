...
const V8DOMConfiguration::AccessorConfiguration V8SVGClipPathElementAccessors[] = {
    {"clipPathUnits", SVGClipPathElementV8Internal::clipPathUnitsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8SVGClipPathElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "SVGClipPathElement", V8SVGGraphicsElement::domTemplate(isolate), V8SVGClipPathElement::internalFieldCount,
        0, 0,
        V8SVGClipPathElementAccessors, WTF_ARRAY_LENGTH(V8SVGClipPathElementAccessors),
        0, 0);
