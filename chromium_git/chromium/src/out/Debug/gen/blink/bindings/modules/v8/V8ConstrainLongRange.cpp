...
v8::Local<v8::Value> toV8(const ConstrainLongRange& impl, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8LongRange(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    if (!toV8ConstrainLongRange(impl, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}
