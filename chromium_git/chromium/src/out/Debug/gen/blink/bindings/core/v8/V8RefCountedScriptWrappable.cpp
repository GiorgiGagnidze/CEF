...
#endif
const WrapperTypeInfo V8RefCountedScriptWrappable::wrapperTypeInfo = { gin::kEmbedderBlink, V8RefCountedScriptWrappable::domTemplate, V8RefCountedScriptWrappable::refObject, V8RefCountedScriptWrappable::derefObject, V8RefCountedScriptWrappable::trace, 0, 0, V8RefCountedScriptWrappable::preparePrototypeAndInterfaceObject, V8RefCountedScriptWrappable::installConditionallyEnabledProperties, "RefCountedScriptWrappable", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::RefCountedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::MethodConfiguration V8RefCountedScriptWrappableMethods[] = {
    {"toString", RefCountedScriptWrappableV8Internal::toStringMethodCallback, 0, 0, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8RefCountedScriptWrappableTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "RefCountedScriptWrappable", v8::Local<v8::FunctionTemplate>(), V8RefCountedScriptWrappable::internalFieldCount,
        0, 0,
        0, 0,
        V8RefCountedScriptWrappableMethods, WTF_ARRAY_LENGTH(V8RefCountedScriptWrappableMethods));
