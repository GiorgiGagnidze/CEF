...
#endif
const WrapperTypeInfo V8MimeTypeArray::wrapperTypeInfo = { gin::kEmbedderBlink, V8MimeTypeArray::domTemplate, V8MimeTypeArray::refObject, V8MimeTypeArray::derefObject, V8MimeTypeArray::trace, 0, 0, V8MimeTypeArray::preparePrototypeAndInterfaceObject, V8MimeTypeArray::installConditionallyEnabledProperties, "MimeTypeArray", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8MimeTypeArrayAccessors[] = {
    {"length", DOMMimeTypeArrayV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
