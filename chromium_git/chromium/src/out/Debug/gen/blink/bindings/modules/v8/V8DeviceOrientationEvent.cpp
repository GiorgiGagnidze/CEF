...
#endif
const WrapperTypeInfo V8DeviceOrientationEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8DeviceOrientationEvent::domTemplate, V8DeviceOrientationEvent::refObject, V8DeviceOrientationEvent::derefObject, V8DeviceOrientationEvent::trace, 0, 0, V8DeviceOrientationEvent::preparePrototypeAndInterfaceObject, V8DeviceOrientationEvent::installConditionallyEnabledProperties, "DeviceOrientationEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8DeviceOrientationEventAccessors[] = {
    {"alpha", DeviceOrientationEventV8Internal::alphaAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"beta", DeviceOrientationEventV8Internal::betaAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"gamma", DeviceOrientationEventV8Internal::gammaAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"absolute", DeviceOrientationEventV8Internal::absoluteAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
