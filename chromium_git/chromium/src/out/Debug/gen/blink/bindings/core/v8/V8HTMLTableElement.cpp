...
#endif
const WrapperTypeInfo V8HTMLTableElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLTableElement::domTemplate, V8HTMLTableElement::refObject, V8HTMLTableElement::derefObject, V8HTMLTableElement::trace, 0, 0, V8HTMLTableElement::preparePrototypeAndInterfaceObject, V8HTMLTableElement::installConditionallyEnabledProperties, "HTMLTableElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void insertRowMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RefPtrWillBeRawPtr<HTMLTableRowElement> result = impl->insertRow(index, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLTableElementAccessors[] = {
    ...
    {"tBodies", HTMLTableElementV8Internal::tBodiesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rows", HTMLTableElementV8Internal::rowsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
