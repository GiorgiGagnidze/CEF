...
const V8DOMConfiguration::MethodConfiguration V8InternalSettingsMethods[] = {
    ...
    {"setAuthorShadowDOMForAnyElementEnabled", InternalSettingsV8Internal::setAuthorShadowDOMForAnyElementEnabledMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"setImageColorProfilesEnabled", InternalSettingsV8Internal::setImageColorProfilesEnabledMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    ...
    {"setLinkHeaderEnabled", InternalSettingsV8Internal::setLinkHeaderEnabledMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
