...
#endif
const WrapperTypeInfo V8SubtleCrypto::wrapperTypeInfo = { gin::kEmbedderBlink, V8SubtleCrypto::domTemplate, V8SubtleCrypto::refObject, V8SubtleCrypto::derefObject, V8SubtleCrypto::trace, 0, 0, V8SubtleCrypto::preparePrototypeAndInterfaceObject, V8SubtleCrypto::installConditionallyEnabledProperties, "SubtleCrypto", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
