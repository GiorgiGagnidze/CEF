...
#endif
const WrapperTypeInfo V8HTMLFormElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLFormElement::domTemplate, V8HTMLFormElement::refObject, V8HTMLFormElement::derefObject, V8HTMLFormElement::trace, 0, 0, V8HTMLFormElement::preparePrototypeAndInterfaceObject, V8HTMLFormElement::installConditionallyEnabledProperties, "HTMLFormElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
{
    TRACE_EVENT_SET_SAMPLING_STATE("blink", "DOMMethod");
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::RequestAutocomplete);
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLFormElementAccessors[] = {
    ...
    {"elements", HTMLFormElementV8Internal::elementsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"length", HTMLFormElementV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8HTMLFormElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "HTMLFormElement", V8HTMLElement::domTemplate(isolate), V8HTMLFormElement::internalFieldCount,
        0, 0,
        V8HTMLFormElementAccessors, WTF_ARRAY_LENGTH(V8HTMLFormElementAccessors),
    ...
    if (RuntimeEnabledFeatures::requestAutocompleteEnabled()) {
        const V8DOMConfiguration::MethodConfiguration requestAutocompleteMethodConfiguration = {"requestAutocomplete", HTMLFormElementV8Internal::requestAutocompleteMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
        V8DOMConfiguration::installMethod(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, requestAutocompleteMethodConfiguration);
    }
}
