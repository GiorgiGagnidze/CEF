...
#endif
const WrapperTypeInfo V8SpeechRecognitionEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechRecognitionEvent::domTemplate, V8SpeechRecognitionEvent::refObject, V8SpeechRecognitionEvent::derefObject, V8SpeechRecognitionEvent::trace, 0, 0, V8SpeechRecognitionEvent::preparePrototypeAndInterfaceObject, V8SpeechRecognitionEvent::installConditionallyEnabledProperties, "SpeechRecognitionEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SpeechRecognitionEventAccessors[] = {
    {"resultIndex", SpeechRecognitionEventV8Internal::resultIndexAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"results", SpeechRecognitionEventV8Internal::resultsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"interpretation", SpeechRecognitionEventV8Internal::interpretationAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"emma", SpeechRecognitionEventV8Internal::emmaAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
