...
#endif
const WrapperTypeInfo V8FederatedCredential::wrapperTypeInfo = { gin::kEmbedderBlink, V8FederatedCredential::domTemplate, V8FederatedCredential::refObject, V8FederatedCredential::derefObject, V8FederatedCredential::trace, 0, 0, V8FederatedCredential::preparePrototypeAndInterfaceObject, V8FederatedCredential::installConditionallyEnabledProperties, "FederatedCredential", &V8Credential::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8FederatedCredentialAccessors[] = {
    {"provider", FederatedCredentialV8Internal::providerAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"protocol", FederatedCredentialV8Internal::protocolAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
