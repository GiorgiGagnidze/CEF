...
const V8DOMConfiguration::AccessorConfiguration V8HTMLAnchorElementAccessors[] = {
    ...
    {"origin", HTMLAnchorElementV8Internal::originAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
const V8DOMConfiguration::MethodConfiguration V8HTMLAnchorElementMethods[] = {
    {"toString", HTMLAnchorElementV8Internal::toStringMethodCallback, 0, 0, static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8HTMLAnchorElementTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "HTMLAnchorElement", V8HTMLElement::domTemplate(isolate), V8HTMLAnchorElement::internalFieldCount,
        ...
        V8HTMLAnchorElementMethods, WTF_ARRAY_LENGTH(V8HTMLAnchorElementMethods));
