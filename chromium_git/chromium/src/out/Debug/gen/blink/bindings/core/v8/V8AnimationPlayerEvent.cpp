...
#endif
const WrapperTypeInfo V8AnimationPlayerEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnimationPlayerEvent::domTemplate, V8AnimationPlayerEvent::refObject, V8AnimationPlayerEvent::derefObject, V8AnimationPlayerEvent::trace, 0, 0, V8AnimationPlayerEvent::preparePrototypeAndInterfaceObject, V8AnimationPlayerEvent::installConditionallyEnabledProperties, "AnimationPlayerEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8AnimationPlayerEventAccessors[] = {
    {"currentTime", AnimationPlayerEventV8Internal::currentTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"timelineTime", AnimationPlayerEventV8Internal::timelineTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8AnimationPlayerEventTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::trustedEventsEnabled()) {
        ...
        {"isTrusted", AnimationPlayerEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
