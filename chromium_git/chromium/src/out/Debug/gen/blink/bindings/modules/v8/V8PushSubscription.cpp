...
const V8DOMConfiguration::AccessorConfiguration V8PushSubscriptionAccessors[] = {
    {"endpoint", PushSubscriptionV8Internal::endpointAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8PushSubscriptionTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::pushMessagingDataEnabled()) {
        const V8DOMConfiguration::MethodConfiguration getKeyMethodConfiguration = {"getKey", PushSubscriptionV8Internal::getKeyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
        V8DOMConfiguration::installMethod(isolate, instanceTemplate, prototypeTemplate, functionTemplate, defaultSignature, getKeyMethodConfiguration);
    }
}
