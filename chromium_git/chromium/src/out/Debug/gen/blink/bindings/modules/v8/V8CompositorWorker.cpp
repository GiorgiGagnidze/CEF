...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RawPtr<CompositorWorker> impl = CompositorWorker::create(executionContext, scriptUrl, exceptionState);
