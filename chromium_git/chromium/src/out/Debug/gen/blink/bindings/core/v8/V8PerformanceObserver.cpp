...
#endif
const WrapperTypeInfo V8PerformanceObserver::wrapperTypeInfo = { gin::kEmbedderBlink, V8PerformanceObserver::domTemplate, V8PerformanceObserver::refObject, V8PerformanceObserver::derefObject, V8PerformanceObserver::trace, 0, 0, V8PerformanceObserver::preparePrototypeAndInterfaceObject, V8PerformanceObserver::installConditionallyEnabledProperties, "PerformanceObserver", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void installV8PerformanceObserverTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    functionTemplate->ReadOnlyPrototype();

    v8::Local<v8::Signature> defaultSignature;
    if (!RuntimeEnabledFeatures::performanceObserverEnabled())
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "PerformanceObserver", v8::Local<v8::FunctionTemplate>(), V8PerformanceObserver::internalFieldCount, 0, 0, 0, 0, 0, 0);
    else
        defaultSignature = V8DOMConfiguration::installDOMClassTemplate(isolate, functionTemplate, "PerformanceObserver", v8::Local<v8::FunctionTemplate>(), V8PerformanceObserver::internalFieldCount,
            0, 0,
            0, 0,
            V8PerformanceObserverMethods, WTF_ARRAY_LENGTH(V8PerformanceObserverMethods));
    functionTemplate->SetCallHandler(V8PerformanceObserver::constructorCallback);
...
v8::Local<v8::FunctionTemplate> V8PerformanceObserver::domTemplate(v8::Isolate* isolate)
{
    return V8DOMConfiguration::domClassTemplate(isolate, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8PerformanceObserverTemplate);
}
...
void V8PerformanceObserver::refObject(ScriptWrappable* scriptWrappable)
{
}

void V8PerformanceObserver::derefObject(ScriptWrappable* scriptWrappable)
{
}
