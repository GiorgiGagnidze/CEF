...
#endif
const WrapperTypeInfo V8GCObservation::wrapperTypeInfo = { gin::kEmbedderBlink, V8GCObservation::domTemplate, V8GCObservation::refObject, V8GCObservation::derefObject, V8GCObservation::trace, 0, 0, V8GCObservation::preparePrototypeAndInterfaceObject, V8GCObservation::installConditionallyEnabledProperties, "GCObservation", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8GCObservationAccessors[] = {
    {"wasCollected", GCObservationV8Internal::wasCollectedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
