...
#endif
const WrapperTypeInfo V8CSSStyleDeclaration::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSStyleDeclaration::domTemplate, V8CSSStyleDeclaration::refObject, V8CSSStyleDeclaration::derefObject, V8CSSStyleDeclaration::trace, 0, 0, V8CSSStyleDeclaration::preparePrototypeAndInterfaceObject, V8CSSStyleDeclaration::installConditionallyEnabledProperties, "CSSStyleDeclaration", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CSSStyleDeclarationAccessors[] = {
    ...
    {"length", CSSStyleDeclarationV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"parentRule", CSSStyleDeclarationV8Internal::parentRuleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
