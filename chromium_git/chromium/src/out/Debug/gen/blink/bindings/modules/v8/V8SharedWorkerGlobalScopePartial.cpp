...
static void cachesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExceptionState exceptionState(ExceptionState::GetterContext, "caches", "SharedWorkerGlobalScope", holder, info.GetIsolate());
...
static void cachesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    SharedWorkerGlobalScopePartialV8Internal::cachesAttributeGetter(info);
    TRACE_EVENT_SET_SAMPLING_STATE("v8", "V8Execution");
}
...
void V8SharedWorkerGlobalScopePartial::installV8SharedWorkerGlobalScopeTemplate(v8::Local<v8::FunctionTemplate> functionTemplate, v8::Isolate* isolate)
{
    ...
    if (RuntimeEnabledFeatures::durableStorageEnabled()) {
        ...
        {"StorageManager", v8ConstructorAttributeGetter, SharedWorkerGlobalScopePartialV8Internal::SharedWorkerGlobalScopeConstructorAttributeSetterCallback, 0, 0, const_cast<WrapperTypeInfo*>(&V8StorageManager::wrapperTypeInfo), static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::DontEnum), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
    ...
    if (RuntimeEnabledFeatures::globalCacheStorageEnabled()) {
        ...
        {"caches", SharedWorkerGlobalScopePartialV8Internal::cachesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder};
...
void V8SharedWorkerGlobalScopePartial::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    V8SharedWorkerGlobalScope::preparePrototypeAndInterfaceObject(context, prototypeObject, interfaceObject, interfaceTemplate);
}
