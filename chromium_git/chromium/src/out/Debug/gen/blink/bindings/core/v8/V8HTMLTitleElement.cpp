...
#endif
const WrapperTypeInfo V8HTMLTitleElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLTitleElement::domTemplate, V8HTMLTitleElement::refObject, V8HTMLTitleElement::derefObject, V8HTMLTitleElement::trace, 0, 0, V8HTMLTitleElement::preparePrototypeAndInterfaceObject, V8HTMLTitleElement::installConditionallyEnabledProperties, "HTMLTitleElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
