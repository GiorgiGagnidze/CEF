...
#endif
const WrapperTypeInfo V8SVGAnimatedLength::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedLength::domTemplate, V8SVGAnimatedLength::refObject, V8SVGAnimatedLength::derefObject, V8SVGAnimatedLength::trace, 0, V8SVGAnimatedLength::visitDOMWrapper, V8SVGAnimatedLength::preparePrototypeAndInterfaceObject, V8SVGAnimatedLength::installConditionallyEnabledProperties, "SVGAnimatedLength", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::WillBeGarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedLengthAccessors[] = {
    {"baseVal", SVGAnimatedLengthV8Internal::baseValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedLengthV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
