...
#endif
const WrapperTypeInfo V8MediaKeys::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaKeys::domTemplate, V8MediaKeys::refObject, V8MediaKeys::derefObject, V8MediaKeys::trace, V8MediaKeys::toActiveDOMObject, 0, V8MediaKeys::preparePrototypeAndInterfaceObject, V8MediaKeys::installConditionallyEnabledProperties, "MediaKeys", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent, WrapperTypeInfo::GarbageCollectedObject };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
