...
const QualifiedName& disableremoteplaybackAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[93];
const QualifiedName& downloadAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[94];
const QualifiedName& draggableAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[95];
const QualifiedName& enctypeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[96];
const QualifiedName& endAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[97];
const QualifiedName& eventAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[98];
const QualifiedName& faceAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[99];
const QualifiedName& forAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[100];
const QualifiedName& formAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[101];
const QualifiedName& formactionAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[102];
const QualifiedName& formenctypeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[103];
const QualifiedName& formmethodAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[104];
const QualifiedName& formnovalidateAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[105];
const QualifiedName& formtargetAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[106];
const QualifiedName& frameAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[107];
const QualifiedName& frameborderAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[108];
const QualifiedName& headersAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[109];
const QualifiedName& heightAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[110];
const QualifiedName& hiddenAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[111];
const QualifiedName& highAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[112];
const QualifiedName& hrefAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[113];
const QualifiedName& hreflangAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[114];
const QualifiedName& hspaceAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[115];
const QualifiedName& http_equivAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[116];
const QualifiedName& iconAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[117];
const QualifiedName& idAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[118];
const QualifiedName& incrementalAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[119];
const QualifiedName& inputmodeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[120];
const QualifiedName& integrityAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[121];
const QualifiedName& isAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[122];
const QualifiedName& ismapAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[123];
const QualifiedName& keytypeAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[124];
const QualifiedName& kindAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[125];
const QualifiedName& labelAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[126];
const QualifiedName& langAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[127];
const QualifiedName& languageAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[128];
const QualifiedName& leftmarginAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[129];
const QualifiedName& linkAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[130];
const QualifiedName& listAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[131];
const QualifiedName& longdescAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[132];
const QualifiedName& loopAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[133];
const QualifiedName& lowAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[134];
const QualifiedName& lowsrcAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[135];
const QualifiedName& manifestAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[136];
const QualifiedName& marginheightAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[137];
const QualifiedName& marginwidthAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[138];
const QualifiedName& maxAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[139];
const QualifiedName& maxlengthAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[140];
const QualifiedName& mayscriptAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[141];
const QualifiedName& mediaAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[142];
...
const QualifiedName& permissionsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[258];
const QualifiedName& pingAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[259];
const QualifiedName& placeholderAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[260];
const QualifiedName& posterAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[261];
const QualifiedName& preloadAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[262];
const QualifiedName& pseudoAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[263];
const QualifiedName& radiogroupAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[264];
const QualifiedName& readonlyAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[265];
const QualifiedName& referrerpolicyAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[266];
const QualifiedName& relAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[267];
const QualifiedName& requiredAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[268];
const QualifiedName& resultsAttr = reinterpret_cast<QualifiedName*>(&AttrStorage)[269];
