...
private:
    ...
    bool m_fetchDeferLateScripts;
    bool m_fetchIncreaseAsyncScriptPriority;
    bool m_fetchIncreaseFontPriority;
    bool m_fetchIncreasePriorities;
    ...
    bool m_mainResourceOnlyProgress;
