...
define("content/common/geolocation_service.mojom", [
...
], function(bindings, codec, connection, core, validator, mojo_geoposition$) {
  ...
  GeolocationService_QueryNextPosition_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, mojo_geoposition$.MojoGeoposition, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GeolocationService_QueryNextPosition_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.geoposition = decoder.decodeStructPointer(mojo_geoposition$.MojoGeoposition);
    return val;
  };
  ...
  GeolocationService_QueryNextPosition_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(mojo_geoposition$.MojoGeoposition, val.geoposition);
  };
  ...
  var GeolocationService = {
    name: 'content::GeolocationService',
