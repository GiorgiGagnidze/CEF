...
define("mojo/shell/public/interfaces/content_handler.mojom", [
...
], function(bindings, codec, connection, core, validator, application$, url_loader$) {
  ...
  ContentHandler_StartApplication_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, url_loader$.URLResponse, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ContentHandler_StartApplication_Params.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.response = decoder.decodeStructPointer(url_loader$.URLResponse);
    return val;
  };
  ...
  ContentHandler_StartApplication_Params.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(url_loader$.URLResponse, val.response);
  };
  function ContentHandler_StartApplication_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ContentHandler_StartApplication_ResponseParams.prototype.initDefaults_ = function() {
  };
  ContentHandler_StartApplication_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ContentHandler_StartApplication_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ContentHandler_StartApplication_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ContentHandler_StartApplication_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  ContentHandler_StartApplication_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new ContentHandler_StartApplication_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  ContentHandler_StartApplication_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ContentHandler_StartApplication_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  ContentHandlerProxy.prototype.startApplication = function(application, response) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        ...
        var responseParams =
            reader.decodeStruct(ContentHandler_StartApplication_ResponseParams);
  ...
  ContentHandlerStub.prototype.acceptWithResponder =
    ...
    case kContentHandler_StartApplication_Name:
      ...
      return this.startApplication(params.application, params.response).then(function(response) {
        var responseParams =
            new ContentHandler_StartApplication_ResponseParams();
        var builder = new codec.MessageWithRequestIDBuilder(
            kContentHandler_StartApplication_Name,
            codec.align(ContentHandler_StartApplication_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(ContentHandler_StartApplication_ResponseParams,
                             responseParams);
        var message = builder.finish();
   ...
   switch (message.getName()) {
      case kContentHandler_StartApplication_Name:
        if (message.isResponse())
          paramsClass = ContentHandler_StartApplication_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var ContentHandler = {
    ...
    validateResponse: validateContentHandlerResponse,
  };
  ContentHandlerStub.prototype.validator = validateContentHandlerRequest;
  ContentHandlerProxy.prototype.validator = validateContentHandlerResponse;
