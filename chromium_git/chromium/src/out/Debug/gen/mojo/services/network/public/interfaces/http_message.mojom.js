...
define("mojo/services/network/public/interfaces/http_message.mojom", [
  ...
  HttpRequest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 16, 8, new codec.PointerTo(HttpHeader), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  HttpResponse.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 8, new codec.PointerTo(HttpHeader), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
