...
class CC_PROTO_EXPORT ManagedMemoryPolicy : public ::google::protobuf::MessageLite {
 public:
  ...
  void Swap(ManagedMemoryPolicy* other);

  // implements Message ----------------------------------------------

  ManagedMemoryPolicy* New() const;
  ...
  inline bool has_bytes_limit_when_visible() const;
  inline void clear_bytes_limit_when_visible();
  static const int kBytesLimitWhenVisibleFieldNumber = 1;
  inline ::google::protobuf::uint32 bytes_limit_when_visible() const;
  inline void set_bytes_limit_when_visible(::google::protobuf::uint32 value);

  // optional .cc.proto.MemoryAllocation.PriorityCutoff priority_cutoff_when_visible = 2;
  inline bool has_priority_cutoff_when_visible() const;
  inline void clear_priority_cutoff_when_visible();
  static const int kPriorityCutoffWhenVisibleFieldNumber = 2;
  inline ::cc::proto::MemoryAllocation_PriorityCutoff priority_cutoff_when_visible() const;
  inline void set_priority_cutoff_when_visible(::cc::proto::MemoryAllocation_PriorityCutoff value);

  // optional uint32 num_resources_limit = 3;
  inline bool has_num_resources_limit() const;
  inline void clear_num_resources_limit();
  static const int kNumResourcesLimitFieldNumber = 3;
  inline ::google::protobuf::uint32 num_resources_limit() const;
  inline void set_num_resources_limit(::google::protobuf::uint32 value);
