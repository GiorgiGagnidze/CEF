...
WalletSyncFlags* WalletSyncFlags::New() const {
  return new WalletSyncFlags;
}
...
const int ExperimentsSpecifics::kWalletSyncFieldNumber;
#endif  // !_MSC_VER
...
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  wallet_sync_ = const_cast< ::sync_pb::WalletSyncFlags*>(
      ::sync_pb::WalletSyncFlags::internal_default_instance());
#else
  wallet_sync_ = const_cast< ::sync_pb::WalletSyncFlags*>(&::sync_pb::WalletSyncFlags::default_instance());
#endif
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_wallet_sync;
        break;
      }
...
void ExperimentsSpecifics::SerializeWithCachedSizes(
  ...
  if (has_obsolete_enhanced_bookmarks()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessage(
      7, this->obsolete_enhanced_bookmarks(), output);
  }
...
int ExperimentsSpecifics::ByteSize() const {
  ...
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (has_obsolete_enhanced_bookmarks()) {
      total_size += 1 +
        ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
          this->obsolete_enhanced_bookmarks());
    }
...
void ExperimentsSpecifics::MergeFrom(const ExperimentsSpecifics& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    if (from.has_wallet_sync()) {
      mutable_wallet_sync()->::sync_pb::WalletSyncFlags::MergeFrom(from.wallet_sync());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ExperimentsSpecifics::Swap(ExperimentsSpecifics* other) {
  if (other != this) {
    ...
    std::swap(wallet_sync_, other->wallet_sync_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
