...
void SYNC_PROTO_EXPORT protobuf_AddDesc_get_5fupdates_5fcaller_5finfo_2eproto();
...
SYNC_PROTO_EXPORT bool GetUpdatesCallerInfo_GetUpdatesSource_IsValid(int value);
...
class SYNC_PROTO_EXPORT GetUpdatesCallerInfo : public ::google::protobuf::MessageLite {
 public:
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_get_5fupdates_5fcaller_5finfo_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_get_5fupdates_5fcaller_5finfo_2eproto();
  #endif
