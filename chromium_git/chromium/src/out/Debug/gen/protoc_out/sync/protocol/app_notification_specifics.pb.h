...
void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fnotification_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT AppNotification : public ::google::protobuf::MessageLite {
 public:
  AppNotification();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fnotification_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_app_5fnotification_5fspecifics_2eproto();
  #endif
