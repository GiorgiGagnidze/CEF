...
void TabNavigation::MergeFrom(const TabNavigation& from) {
  ...
  if (from._has_bits_[17 / 32] & (0xffu << (17 % 32))) {
    ...
    if (from.has_last_navigation_redirect_url()) {
      set_last_navigation_redirect_url(from.last_navigation_redirect_url());
    }
...
void TabNavigation::Swap(TabNavigation* other) {
  if (other != this) {
    ...
    navigation_redirect_.Swap(&other->navigation_redirect_);
    std::swap(last_navigation_redirect_url_, other->last_navigation_redirect_url_);
...
NavigationRedirect* NavigationRedirect::New() const {
