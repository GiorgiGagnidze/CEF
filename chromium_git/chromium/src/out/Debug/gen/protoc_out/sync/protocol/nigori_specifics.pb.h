...
void SYNC_PROTO_EXPORT protobuf_AddDesc_nigori_5fspecifics_2eproto();
...
SYNC_PROTO_EXPORT bool NigoriSpecifics_PassphraseType_IsValid(int value);
...
class SYNC_PROTO_EXPORT NigoriKey : public ::google::protobuf::MessageLite {
 public:
  NigoriKey();
  virtual ~NigoriKey();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_nigori_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_nigori_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT NigoriKeyBag : public ::google::protobuf::MessageLite {
 public:
  NigoriKeyBag();
...
class SYNC_PROTO_EXPORT NigoriSpecifics : public ::google::protobuf::MessageLite {
 public:
  NigoriSpecifics();
  ...
  inline bool has_encrypt_autofill_wallet_metadata() const;
  inline void clear_encrypt_autofill_wallet_metadata();
  static const int kEncryptAutofillWalletMetadataFieldNumber = 39;
  inline bool encrypt_autofill_wallet_metadata() const;
  inline void set_encrypt_autofill_wallet_metadata(bool value);

  // optional bool server_only_was_missing_keystore_migration_time = 40;
  inline bool has_server_only_was_missing_keystore_migration_time() const;
  inline void clear_server_only_was_missing_keystore_migration_time();
  static const int kServerOnlyWasMissingKeystoreMigrationTimeFieldNumber = 40;
  inline bool server_only_was_missing_keystore_migration_time() const;
  inline void set_server_only_was_missing_keystore_migration_time(bool value);
