...
void SYNC_PROTO_EXPORT protobuf_AddDesc_typed_5furl_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT TypedUrlSpecifics : public ::google::protobuf::MessageLite {
 public:
  TypedUrlSpecifics();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_typed_5furl_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_typed_5furl_5fspecifics_2eproto();
  #endif
