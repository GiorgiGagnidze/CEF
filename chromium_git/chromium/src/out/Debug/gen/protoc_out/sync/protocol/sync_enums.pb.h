...
void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_5fenums_2eproto();
...
SYNC_PROTO_EXPORT bool SyncEnums_SingletonDebugEventType_IsValid(int value);
...
SYNC_PROTO_EXPORT bool SyncEnums_PageTransition_IsValid(int value);
...
SYNC_PROTO_EXPORT bool SyncEnums_PageTransitionRedirectType_IsValid(int value);
...
SYNC_PROTO_EXPORT bool SyncEnums_Action_IsValid(int value);
...
SYNC_PROTO_EXPORT bool SyncEnums_DeviceType_IsValid(int value);
...
SYNC_PROTO_EXPORT bool SyncEnums_GetUpdatesOrigin_IsValid(int value);
...
class SYNC_PROTO_EXPORT SyncEnums : public ::google::protobuf::MessageLite {
 public:
  SyncEnums();
  virtual ~SyncEnums();
  ...
  static const ErrorType USER_ROLLBACK = SyncEnums_ErrorType_USER_ROLLBACK;
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_5fenums_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_sync_5fenums_2eproto();
  #endif
