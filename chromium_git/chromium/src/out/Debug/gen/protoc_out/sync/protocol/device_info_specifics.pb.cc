...
const int DeviceInfoSpecifics::kBackupTimestampFieldNumber;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_backup_timestamp;
        break;
      }
...
void DeviceInfoSpecifics::SerializeWithCachedSizes(
  ...
  // optional int64 backup_timestamp = 6;
  if (has_backup_timestamp()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(6, this->backup_timestamp(), output);
  }
...
void DeviceInfoSpecifics::MergeFrom(const DeviceInfoSpecifics& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_backup_timestamp()) {
      set_backup_timestamp(from.backup_timestamp());
    }
    if (from.has_signin_scoped_device_id()) {
      set_signin_scoped_device_id(from.signin_scoped_device_id());
    }
  }
...
void DeviceInfoSpecifics::Swap(DeviceInfoSpecifics* other) {
  if (other != this) {
    ...
    std::swap(backup_timestamp_, other->backup_timestamp_);
    std::swap(signin_scoped_device_id_, other->signin_scoped_device_id_);
