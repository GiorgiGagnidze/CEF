...
void SYNC_PROTO_EXPORT protobuf_AddDesc_encryption_2eproto();
...
class SYNC_PROTO_EXPORT EncryptedData : public ::google::protobuf::MessageLite {
 public:
  EncryptedData();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_encryption_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_encryption_2eproto();
  #endif
