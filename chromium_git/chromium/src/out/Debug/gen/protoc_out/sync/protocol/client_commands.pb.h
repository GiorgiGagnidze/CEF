...
void SYNC_PROTO_EXPORT protobuf_AddDesc_client_5fcommands_2eproto();
...
class SYNC_PROTO_EXPORT CustomNudgeDelay : public ::google::protobuf::MessageLite {
 public:
  CustomNudgeDelay();
  ...
  void Swap(CustomNudgeDelay* other);

  // implements Message ----------------------------------------------

  CustomNudgeDelay* New() const;
  ...
  inline bool has_datatype_id() const;
  inline void clear_datatype_id();
  static const int kDatatypeIdFieldNumber = 1;
  inline ::google::protobuf::int32 datatype_id() const;
  inline void set_datatype_id(::google::protobuf::int32 value);

  // optional int32 delay_ms = 2;
  inline bool has_delay_ms() const;
  inline void clear_delay_ms();
  static const int kDelayMsFieldNumber = 2;
  inline ::google::protobuf::int32 delay_ms() const;
  inline void set_delay_ms(::google::protobuf::int32 value);
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_client_5fcommands_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_client_5fcommands_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT ClientCommand : public ::google::protobuf::MessageLite {
 public:
  ClientCommand();
  ...
  inline int custom_nudge_delays_size() const;
  inline void clear_custom_nudge_delays();
  static const int kCustomNudgeDelaysFieldNumber = 8;
  inline const ::sync_pb::CustomNudgeDelay& custom_nudge_delays(int index) const;
  inline ::sync_pb::CustomNudgeDelay* mutable_custom_nudge_delays(int index);
  inline ::sync_pb::CustomNudgeDelay* add_custom_nudge_delays();
