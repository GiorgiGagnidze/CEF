...
void SYNC_PROTO_EXPORT protobuf_AddDesc_bookmark_5fspecifics_2eproto();
...
class SYNC_PROTO_EXPORT MetaInfo : public ::google::protobuf::MessageLite {
 public:
  MetaInfo();
  virtual ~MetaInfo();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_bookmark_5fspecifics_2eproto_impl();
  #else
  friend void SYNC_PROTO_EXPORT protobuf_AddDesc_bookmark_5fspecifics_2eproto();
  #endif
...
class SYNC_PROTO_EXPORT BookmarkSpecifics : public ::google::protobuf::MessageLite {
 public:
  BookmarkSpecifics();
