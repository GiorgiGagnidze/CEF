...
std::string ToString(StorageUnitType as_enum);
...
struct StorageUnitInfo {
  ...
  static scoped_ptr<StorageUnitInfo> FromValue(const base::Value& value);
...
struct StorageAvailableCapacityInfo {
  ...
  // on failure.
  static scoped_ptr<StorageAvailableCapacityInfo> FromValue(const base::Value& value);
...
std::string ToString(EjectDeviceResultCode as_enum);
...
scoped_ptr<base::ListValue> Create(const std::vector<linked_ptr<StorageUnitInfo> >& info);
}  // namespace Results
...
scoped_ptr<base::ListValue> Create(const EjectDeviceResultCode& result);
}  // namespace Results
...
scoped_ptr<base::ListValue> Create(const StorageAvailableCapacityInfo& info);
}  // namespace Results
