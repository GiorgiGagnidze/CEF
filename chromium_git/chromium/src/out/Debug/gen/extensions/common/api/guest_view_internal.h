...
struct Size {
  ...
  static scoped_ptr<Size> FromValue(const base::Value& value);
...
struct SizeParams {
  ...
  static scoped_ptr<SizeParams> FromValue(const base::Value& value);
...
scoped_ptr<base::ListValue> Create(const ReturnParams& return_params);
}  // namespace Results
