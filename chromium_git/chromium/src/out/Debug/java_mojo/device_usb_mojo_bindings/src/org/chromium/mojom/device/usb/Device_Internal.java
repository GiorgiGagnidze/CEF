...
class Device_Internal {
    ...
    private static final int GET_CONFIGURATION_ORDINAL = 1;

    private static final int OPEN_ORDINAL = 2;

    private static final int CLOSE_ORDINAL = 3;

    private static final int SET_CONFIGURATION_ORDINAL = 4;

    private static final int CLAIM_INTERFACE_ORDINAL = 5;

    private static final int RELEASE_INTERFACE_ORDINAL = 6;

    private static final int SET_INTERFACE_ALTERNATE_SETTING_ORDINAL = 7;

    private static final int RESET_ORDINAL = 8;

    private static final int CLEAR_HALT_ORDINAL = 9;

    private static final int CONTROL_TRANSFER_IN_ORDINAL = 10;

    private static final int CONTROL_TRANSFER_OUT_ORDINAL = 11;

    private static final int GENERIC_TRANSFER_IN_ORDINAL = 12;

    private static final int GENERIC_TRANSFER_OUT_ORDINAL = 13;

    private static final int ISOCHRONOUS_TRANSFER_IN_ORDINAL = 14;

    private static final int ISOCHRONOUS_TRANSFER_OUT_ORDINAL = 15;
...
GetConfigurationResponse callback) {
            ...
            DeviceGetConfigurationParams _message = new DeviceGetConfigurationParams();
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(
                    _message.serializeWithHeader(
                            getProxyHandler().getCore(),
                            new org.chromium.mojo.bindings.MessageHeader(
                                    GET_CONFIGURATION_ORDINAL,
                                    org.chromium.mojo.bindings.MessageHeader.MESSAGE_EXPECTS_RESPONSE_FLAG,
                                    0)),
                    new DeviceGetConfigurationResponseParamsForwardToCallback(callback));
...
IsochronousTransferOutResponse callback) {
        ...
        public boolean acceptWithResponder(org.chromium.mojo.bindings.Message message, org.chromium.mojo.bindings.MessageReceiver receiver) {
            try {
                ...
                switch(header.getType()) {
                    ...
                    case GET_CONFIGURATION_ORDINAL: {
            
                        DeviceGetConfigurationParams.deserialize(messageWithHeader.getPayload());
            
                        getImpl().getConfiguration(new DeviceGetConfigurationResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    }
    ...
    static final class DeviceGetConfigurationParams extends org.chromium.mojo.bindings.Struct {
        ...
        private DeviceGetConfigurationParams(int version) {
            super(STRUCT_SIZE, version);
    
        }
    
        public DeviceGetConfigurationParams() {
            this(0);
        }
    
        public static DeviceGetConfigurationParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
    
        @SuppressWarnings("unchecked")
        public static DeviceGetConfigurationParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            DeviceGetConfigurationParams result = new DeviceGetConfigurationParams(mainDataHeader.elementsOrVersion);
    ...
    static final class DeviceGetConfigurationResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private DeviceGetConfigurationResponseParams(int version) {
            super(STRUCT_SIZE, version);
        ...
        public DeviceGetConfigurationResponseParams() {
            this(0);
        }
    
        public static DeviceGetConfigurationResponseParams deserialize(org.chromium.mojo.bindings.Message message) {
            return decode(new org.chromium.mojo.bindings.Decoder(message));
        }
    
        @SuppressWarnings("unchecked")
        public static DeviceGetConfigurationResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            DeviceGetConfigurationResponseParams result = new DeviceGetConfigurationResponseParams(mainDataHeader.elementsOrVersion);
        ...
        public boolean equals(Object object) {
            ...
            DeviceGetConfigurationResponseParams other = (DeviceGetConfigurationResponseParams) object;
    ...
    static class DeviceGetConfigurationResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
            implements org.chromium.mojo.bindings.MessageReceiver {
        private final Device.GetConfigurationResponse mCallback;

        DeviceGetConfigurationResponseParamsForwardToCallback(Device.GetConfigurationResponse callback) {
            this.mCallback = callback;
        }
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                org.chromium.mojo.bindings.ServiceMessage messageWithHeader =
                        message.asServiceMessage();
                org.chromium.mojo.bindings.MessageHeader header = messageWithHeader.getHeader();
                if (!header.validateHeader(GET_CONFIGURATION_ORDINAL,
                                           org.chromium.mojo.bindings.MessageHeader.MESSAGE_IS_RESPONSE_FLAG)) {
                    return false;
                }

                DeviceGetConfigurationResponseParams response = DeviceGetConfigurationResponseParams.deserialize(messageWithHeader.getPayload());
    ...
    static class DeviceGetConfigurationResponseParamsProxyToResponder implements Device.GetConfigurationResponse {

        private final org.chromium.mojo.system.Core mCore;
        private final org.chromium.mojo.bindings.MessageReceiver mMessageReceiver;
        private final long mRequestId;

        DeviceGetConfigurationResponseParamsProxyToResponder(
                org.chromium.mojo.system.Core core,
                org.chromium.mojo.bindings.MessageReceiver messageReceiver,
                long requestId) {
            mCore = core;
        ...
        public void call(Byte value) {
            DeviceGetConfigurationResponseParams _response = new DeviceGetConfigurationResponseParams();
