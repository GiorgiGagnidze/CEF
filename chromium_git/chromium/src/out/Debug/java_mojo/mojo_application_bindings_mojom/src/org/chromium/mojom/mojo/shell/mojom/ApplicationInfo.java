...
public final class ApplicationInfo extends org.chromium.mojo.bindings.Struct {
    ...
    private ApplicationInfo(int version) {
    ...
    public static ApplicationInfo deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message));
    }

    @SuppressWarnings("unchecked")
    public static ApplicationInfo decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
        ApplicationInfo result = new ApplicationInfo(mainDataHeader.elementsOrVersion);
