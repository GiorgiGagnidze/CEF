...
void ClientHandlerOsr::OnAfterCreated(CefRefPtr<CefBrowser> browser) {
  ...
  // printf("%s\n", "sheiqmna");
  // browser->GetMainFrame()->LoadString("<!DOCTYPE html> <html> <head><title>Page Title</title></head><body><h1>This is a Heading</h1><p>This is a paragraph.</p></body></html>", "about:blank");
}
